  ...
  begin
    ...
    begin
      if (Self.Parent as jVisualControl).LayoutParamWidth = lpMatchParent then
        ...
        jSeekBar_SetLParamWidth(FjEnv, FjObject, GetLayoutParamsByParent(Self.Parent, FLParamWidth, sdW))
    end;
  end;
end;
  ...
  begin
    ...
    begin
      if (Self.Parent as jVisualControl).LayoutParamHeight = lpMatchParent then
        ...
        jSeekBar_SetLParamHeight(FjEnv, FjObject, GetLayoutParamsByParent(Self.Parent, FLParamHeight, sdH))
    end;
  end;
end;
