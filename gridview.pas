  ...
  begin
    ...
    begin
      if (Self.Parent as jVisualControl).LayoutParamWidth = lpWrapContent then
          ...
          jGridView_setLParamWidth(FjEnv,FjObject,GetLayoutParamsByParent((Self.Parent as jVisualControl), FLParamWidth, sdW));
    end;
  end;
end;
  ...
  begin
    ...
    begin
      if (Self.Parent as jVisualControl).LayoutParamHeight = lpWrapContent then
         ...
         jGridView_setLParamHeight(FjEnv,FjObject,GetLayoutParamsByParent((Self.Parent as jVisualControl), FLParamHeight, sdH));
    end;
  end;
end;
