...
Procedure jCanvasES1.SetParent(Value: jObject);
begin
  FjPRLayout := Value;
...
begin
  ...
  begin
     ...
     begin
       Texture_Load(Textures[i], FImageList.Images.Strings[i]{FImageList.GetImageByIndex(i)}, lang);
       Inc(TexturesCount);
     end;
  end;
end;
...
procedure jCanvasES1.SetParamWidth(Value: TLayoutParams);
var
   side: TSide;
begin
