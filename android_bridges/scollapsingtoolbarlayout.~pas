...
uses
   ...
   sdrawerlayout, scardview, sappbarlayout,
...
procedure jsCollapsingToolbarLayout.TryNewParent(refApp: jApp);
begin
...
begin
  ...
  begin
    ...
    begin
      ...
      jsCollapsingToolbarLayout_SetLParamWidth(FjEnv, FjObject, GetLayoutParams(gApp, FLParamWidth, side));
    end
    else
    begin
...
begin
  ...
  begin
    ...
    begin
      ...
      jsCollapsingToolbarLayout_SetLParamHeight(FjEnv, FjObject, GetLayoutParams(gApp, FLParamHeight, side));
    end
    else
    begin
...
procedure jsCollapsingToolbarLayout.ClearLayoutAll();
begin
  //in designing component state: set value here...
  if FInitialized then
     jsCollapsingToolbarLayout_ClearLayoutAll(FjEnv, FjObject);
