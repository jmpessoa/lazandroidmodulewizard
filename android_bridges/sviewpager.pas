...
uses
  ...
  stoolbar, stablayout, snestedscrollview, framelayout;
...
procedure jsViewPager.TryNewParent(refApp: jApp);
begin
...
procedure jsViewPager.UpdateLParamWidth;
var
  side: TSide;
begin
  if FInitialized then
  begin
    ...
    begin
      ...
      jsViewPager_SetLParamWidth(FjEnv, FjObject, GetLayoutParams(gApp, FLParamWidth, side));
    end
    else
    begin
      if (Self.Parent as jVisualControl).LayoutParamWidth = lpWrapContent then
        jsViewPager_setLParamWidth(FjEnv, FjObject , GetLayoutParams(gApp, FLParamWidth, sdW))
      else //lpMatchParent or others
        jsViewPager_setLParamWidth(FjEnv,FjObject,GetLayoutParamsByParent((Self.Parent as jVisualControl), FLParamWidth, sdW));
    end;
  end;
end;

procedure jsViewPager.UpdateLParamHeight;
var
  side: TSide;
begin
  if FInitialized then
  begin
    ...
    begin
      ...
      jsViewPager_SetLParamHeight(FjEnv, FjObject, GetLayoutParams(gApp, FLParamHeight, side));
    end
    else
    begin
      if (Self.Parent as jVisualControl).LayoutParamHeight = lpWrapContent then
        jsViewPager_setLParamHeight(FjEnv, FjObject , GetLayoutParams(gApp, FLParamHeight, sdH))
      else //lpMatchParent and others
        jsViewPager_setLParamHeight(FjEnv,FjObject,GetLayoutParamsByParent((Self.Parent as jVisualControl), FLParamHeight, sdH));
    end;
  end;
end;
...
procedure jsViewPager.ClearLayoutAll();
begin
  //in designing component state: set value here...
  if FInitialized then
     jsViewPager_ClearLayoutAll(FjEnv, FjObject);
