...
begin
  ...
  begin
    ...
    begin
      ...
      jsEditTextFloatingLabel_SetLParamWidth(FjEnv, FjObject, GetLayoutParams(gApp, FLParamWidth, side));
    end
    else
    begin
...
begin
  ...
  begin
    ...
    begin
      ...
      jsEditTextFloatingLabel_SetLParamHeight(FjEnv, FjObject, GetLayoutParams(gApp, FLParamHeight, side));
    end
    else
    begin
