...
procedure jSMSWidgetProvider.Init;
begin
...
begin
   Result:= jSMSWidgetProvider_jCreate(gApp.jni.jEnv, int64(Self), gApp.jni.jThis);
end;
...
begin
  ...
  if FInitialized then
     jSMSWidgetProvider_jFree(gApp.jni.jEnv, FjObject);
end;
