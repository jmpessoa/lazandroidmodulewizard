...
public class jsFloatingActionButton extends FloatingActionButton /*dummy*/ { //please, fix what GUI object will be extended!
   ...
   public jsFloatingActionButton(Controls _ctrls, long _Self) { //Add more others news "_xxx" params if needed!
