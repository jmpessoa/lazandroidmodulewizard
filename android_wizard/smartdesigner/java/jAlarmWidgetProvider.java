package org.lamw.appalarmwidgetproviderdemo1;
...
/*Draft java code by "Lazarus Android Module Wizard" [08/07/2017 22:47:10]*/
/*https://github.com/jmpessoa/lazandroidmodulewizard*/
/*jControl LAMW template*/

//http://stacktips.com/tutorials/android/app-widgets-example-in-android

public class jAlarmWidgetProvider extends AppWidgetProvider  {
   ...
   public jAlarmWidgetProvider() { //Add more others news "_xxx" params if needed!
	   
   }
               //, String _actionfilter
   public jAlarmWidgetProvider(Controls _ctrls, long _Self) { //Add more others news "_xxx" params if needed!
   ...
   //This is called when an instance of AppWidgetProvider is created.
    ...
    public void onReceive(final Context ctx, Intent intent) {
      ...
      if (intent.getAction().equals("android.provider.Telephony.SMS_RECEIVED")) {       	  
           ...
           if (bundle != null) {
			...
			RemoteViews remoteViews = new RemoteViews(ctx.getPackageName(), R.layout.alarmwigetlayout); //layoutId
			remoteViews.setTextViewText(R.id.alarmwidgettextview, smsBody);
			remoteViews.setOnClickPendingIntent(R.id.alarmwidgetbackgroundlayout, builActivityPendingIntent(ctx, smsBody, "App"));
      ...
      if (intent.getAction().equals(ctx.getPackageName()+".WIDGET_NOTIFY")) {       	  
		 ...
		 RemoteViews remoteViews = new RemoteViews(ctx.getPackageName(), R.layout.alarmwigetlayout); 
		 remoteViews.setTextViewText(R.id.alarmwidgettextview, smsBody);
		 remoteViews.setOnClickPendingIntent(R.id.alarmwidgetbackgroundlayout, builActivityPendingIntent(ctx, smsBody, "App"));
		 pushWidgetUpdate(ctx, remoteViews);								
     }
	...
	public static void pushWidgetUpdate(Context ctx, RemoteViews remoteViews) {
		ComponentName myWidget = new ComponentName(ctx, jAlarmWidgetProvider.class);
