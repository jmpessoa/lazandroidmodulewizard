...
public class jHorizontalScrollView extends HorizontalScrollView {
	...
	private int magicNumber = 80669;

	//Constructor
	public  jHorizontalScrollView(Controls ctrls,long pasobj, int innerLayout) {
		...
		if (innerLayout == 0) {
			...
			((LinearLayout) scrollview).setOrientation(LinearLayout.HORIZONTAL);
			activeInnerLayout = 1;
		}
	...
	public void AddImage(Bitmap _bitmap, int _itemId) {
		AddImage( _bitmap, _itemId, 6);
	}

	public void AddImage(Bitmap _bitmap) {
		AddImage( _bitmap, 0, 6);
	}
	...
	public void AddImage(Bitmap _bitmap, int _itemId, int _scaleType) {
		...
		imageView.setOnClickListener(new View.OnClickListener() {
			public void onClick(View v) {
				controls.pOnHorScrollViewInnerItemClick(PasObj, ((ImageView)v).getId() - magicNumber);
			}
		});
		...
		imageView.setOnLongClickListener(new OnLongClickListener() {
			...
			public boolean onLongClick(View v) {
				...
				controls.pOnHorScrollViewInnerItemLongClick(PasObj, index, id - magicNumber);
				return true;
			}
		});
