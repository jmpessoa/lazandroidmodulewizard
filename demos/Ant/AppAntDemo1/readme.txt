...
2. If Android Virtual Device[AVD]/Emulator is running then:
   ...
   2.2 look for you Apk AppAntDemo1 on the Emulator and click it!
...
3. If AVD/Emulator target Api[17] is NOT running:
   ...
   3.3 look for the Apk AppAntDemo1 on  the Emulator and click it!
...
6. Look for the Android AppAntDemo1-debug.apk in \bin folder!
 
7. Android Asset Packaging Tool: to know which files were packed in AppAntDemo1-debug.apk
