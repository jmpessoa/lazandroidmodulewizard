{hint: save all files to location: C:\adt32\ant\workspace\AppAntDemo2\jni }
library controls;
...
{ Class:     org_jmpessoa_appantdemo2_Controls
...
begin
  curClassPathName:= 'org/jmpessoa/appantdemo2/Controls';
...
exports
  ...
  pAppOnScreenStyle name 'Java_org_jmpessoa_appantdemo2_Controls_pAppOnScreenStyle',
  pAppOnCreate name 'Java_org_jmpessoa_appantdemo2_Controls_pAppOnCreate',
  pAppOnNewIntent name 'Java_org_jmpessoa_appantdemo2_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_jmpessoa_appantdemo2_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_jmpessoa_appantdemo2_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_jmpessoa_appantdemo2_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_jmpessoa_appantdemo2_Controls_pAppOnResume',
  pAppOnActive name 'Java_org_jmpessoa_appantdemo2_Controls_pAppOnActive',
  pAppOnStop name 'Java_org_jmpessoa_appantdemo2_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_jmpessoa_appantdemo2_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_jmpessoa_appantdemo2_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_jmpessoa_appantdemo2_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_jmpessoa_appantdemo2_Controls_pAppOnActivityResult',
  pOnClick name 'Java_org_jmpessoa_appantdemo2_Controls_pOnClick',
  pOnChange name 'Java_org_jmpessoa_appantdemo2_Controls_pOnChange',
  pOnEnter name 'Java_org_jmpessoa_appantdemo2_Controls_pOnEnter',
  pOnTimer name 'Java_org_jmpessoa_appantdemo2_Controls_pOnTimer',
  pOnDraw name 'Java_org_jmpessoa_appantdemo2_Controls_pOnDraw',
  pOnTouch name 'Java_org_jmpessoa_appantdemo2_Controls_pOnTouch',
  pOnGLRenderer name 'Java_org_jmpessoa_appantdemo2_Controls_pOnGLRenderer',
  pOnClose name 'Java_org_jmpessoa_appantdemo2_Controls_pOnClose',
  pOnWebViewStatus name 'Java_org_jmpessoa_appantdemo2_Controls_pOnWebViewStatus',
  pOnAsyncEvent name 'Java_org_jmpessoa_appantdemo2_Controls_pOnAsyncEvent';
 
begin
  App:= jApp.Create(nil);{Laz_And_Controls}
  App.Title:= 'My Android GUI Library';
  gjAppName:= 'org.jmpessoa.appantdemo2';{And_jni_Bridge}
  gjClassName:= 'org/jmpessoa/appantdemo2/Controls';{And_jni_Bridge}
