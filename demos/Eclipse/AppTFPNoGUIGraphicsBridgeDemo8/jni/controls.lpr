...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 5/14/2016 0:31:07]
...
{ Class:     com_example_apptfpnoguigraphicsbridgedemo8_Controls
...
begin
  ...
  begin
      curEnv:= PJNIEnv(PEnv);
      RegisterNativeMethods(curEnv, 'com/example/apptfpnoguigraphicsbridgedemo8'
        +'/Controls');
  end;
...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pAppOnScreenStyle',
  pAppOnCreate name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls_'
    +'pAppOnCreate',
  pAppOnNewIntent name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls'
    +'_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls'
    +'_pAppOnRestart',
  pAppOnResume name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo8_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o8_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo8_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo8_Controls_pAppOnClickContextMenuItem',
  pOnClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls_'
    +'pOnClick',
  pOnChange name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls_'
    +'pOnEnter',
  pOnTimer name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls_'
    +'pOnTimer',
  pOnDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls_'
    +'pOnDraw',
  pOnTouch name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls_'
    +'pOnTouch',
  pOnGLRenderer name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls'
    +'_pOnGLRenderer',
  pOnClose name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls_'
    +'pOnClose',
  pOnWebViewStatus name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnWebViewStatus',
  pOnAsyncEventDoInBackground name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo8_Controls_pOnAsyncEventDoInBackground',
  pOnAsyncEventProgressUpdate name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo8_Controls_pOnAsyncEventProgressUpdate',
  pOnAsyncEventPreExecute name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pOnAsyncEventPreExecute',
  pOnAsyncEventPostExecute name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pOnAsyncEventPostExecute',
  pOnClickWidgetItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_com_example_apptfpnoguigraphicsbri'
    +'dgedemo8_Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_com_example_apptfpnoguigraphicsbri'
    +'dgedemo8_Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o8_Controls_pOnListViewDrawItemBitmap',
  pOnBluetoothEnabled name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnBluetoothEnabled',
  pOnBluetoothDisabled name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnBluetoothDisabled',
  pOnBluetoothDeviceFound name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pOnBluetoothDeviceFound',
  pOnBluetoothDiscoveryStarted name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo8_Controls_pOnBluetoothDiscoveryStarted',
  pOnBluetoothDiscoveryFinished name 'Java_com_example_apptfpnoguigraphicsbridg'
    +'edemo8_Controls_pOnBluetoothDiscoveryFinished',
  pOnBluetoothDeviceBondStateChanged name 'Java_com_example_apptfpnoguigraphics'
    +'bridgedemo8_Controls_pOnBluetoothDeviceBondStateChanged',
  pOnBluetoothClientSocketConnected name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo8_Controls_pOnBluetoothClientSocketConnected',
  pOnBluetoothClientSocketIncomingData name 'Java_com_example_'
    +'apptfpnoguigraphicsbridgedemo8_Controls_'
  ...
  pOnBluetoothServerSocketConnected name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo8_Controls_pOnBluetoothServerSocketConnected',
  ...
  pOnBluetoothServerSocketListen name 'Java_com_example_apptfpnoguigraphicsbrid'
    +'gedemo8_Controls_pOnBluetoothServerSocketListen',
  ...
  pOnSpinnerItemSeleceted name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pOnSpinnerItemSeleceted',
  pOnLocationChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnLocationChanged',
  pOnLocationStatusChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pOnLocationStatusChanged',
  pOnLocationProviderEnabled name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo8_Controls_pOnLocationProviderEnabled',
  pOnLocationProviderDisabled name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo8_Controls_pOnLocationProviderDisabled',
  pAppOnViewClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pAppOnListItemClick',
  pOnActionBarTabSelected name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pOnActionBarTabSelected',
  pOnActionBarTabUnSelected name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o8_Controls_pOnActionBarTabUnSelected',
  pOnCustomDialogShow name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnCustomDialogShow',
  pOnCustomDialogBackKeyPressed name 'Java_com_example_apptfpnoguigraphicsbridg'
    +'edemo8_Controls_pOnCustomDialogBackKeyPressed',
  pOnClickToggleButton name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnClickToggleButton',
  pOnChangeSwitchButton name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnChangeSwitchButton',
  pOnClickGridItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnClickGridItem',
  pOnLongClickGridItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnLongClickGridItem',
  pOnGridDrawItemCaptionColor name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo8_Controls_pOnGridDrawItemCaptionColor',
  pOnGridDrawItemBitmap name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnGridDrawItemBitmap',
  pOnChangedSensor name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnChangedSensor',
  pOnListeningSensor name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnListeningSensor',
  pOnUnregisterListeningSensor name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo8_Controls_pOnUnregisterListeningSensor',
  pOnBroadcastReceiver name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnBroadcastReceiver',
  pOnTimePicker name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls'
    +'_pOnTimePicker',
  pOnDatePicker name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_Controls'
    +'_pOnDatePicker',
  pOnFlingGestureDetected name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo8_Controls_pOnPinchZoomGestureDetected',
  pOnShellCommandExecuted name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pOnShellCommandExecuted',
  pOnTCPSocketClientMessageReceived name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo8_Controls_pOnTCPSocketClientMessageReceived',
  pOnTCPSocketClientConnected name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo8_Controls_pOnTCPSocketClientConnected',
  pOnHttpClientContentResult name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo8_Controls_pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pOnHttpClientCodeResult',
  pOnSurfaceViewCreated name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnSurfaceViewCreated',
  pOnSurfaceViewDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnSurfaceViewDraw',
  pOnSurfaceViewChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnSurfaceViewChanged',
  pOnMediaPlayerPrepared name 'Java_com_example_apptfpnoguigraphicsbridgedemo8'
    +'_Controls_pOnMediaPlayerPrepared',
  pOnMediaPlayerVideoSizeChanged name 'Java_com_example_apptfpnoguigraphicsbrid'
    +'gedemo8_Controls_pOnMediaPlayerVideoSizeChanged',
  pOnMediaPlayerCompletion name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pOnMediaPlayerCompletion',
  pOnMediaPlayerTimedText name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pOnMediaPlayerTimedText',
  pOnSurfaceViewTouch name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnSurfaceViewTouch',
  pOnSurfaceViewDrawingInBackground name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo8_Controls_pOnSurfaceViewDrawingInBackground',
  pOnSurfaceViewDrawingPostExecute name 'Java_com_example_apptfpnoguigraphicsbr'
    +'idgedemo8_Controls_pOnSurfaceViewDrawingPostExecute',
  pOnContactManagerContactsExecuted name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo8_Controls_pOnContactManagerContactsExecuted',
  pOnContactManagerContactsProgress name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo8_Controls_pOnContactManagerContactsProgress',
  pOnSeekBarProgressChanged name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o8_Controls_pOnSeekBarProgressChanged',
  pOnSeekBarStartTrackingTouch name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo8_Controls_pOnSeekBarStartTrackingTouch',
  pOnSeekBarStopTrackingTouch name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo8_Controls_pOnSeekBarStopTrackingTouch',
  pOnRatingBarChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnRatingBarChanged',
  pRadioGroupCheckedChanged name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o8_Controls_pRadioGroupCheckedChanged',
  pOnClickAutoDropDownItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'8_Controls_pOnClickAutoDropDownItem',
  pOnClickGeneric name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
    +'Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_apptfpnoguigraphicsbridgedemo8_'
...
begin
  ...
  gjAppName:= 'com.example.apptfpnoguigraphicsbridgedemo8';
  gjClassName:= 'com/example/apptfpnoguigraphicsbridgedemo8/Controls';
