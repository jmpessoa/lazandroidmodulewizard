...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 11/14/2015 17:34:59]
...
{ Class:     com_example_apppascallibexceptionhandlerdemo1_Controls
...
begin
  ...
  begin
      curEnv:= PJNIEnv(PEnv);
      RegisterNativeMethods(curEnv, 'com/example/apppascallibexceptionhandlerdem'
        +'o1/Controls');
  end;
...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pAppOnScreenStyle',
  pAppOnCreate name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pAppOnCreate',
  pAppOnNewIntent name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_apppascallibexceptionhandlerdemo1_Controls'
    +'_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_apppascallibexceptionhandle'
    +'rdemo1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apppascallibexceptionhandlerdemo'
    +'1_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apppascallibexceptionhandlerde'
    +'mo1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apppascallibexceptionhandler'
    +'demo1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_apppascallibexceptionhandlerd'
    +'emo1_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_apppascallibexceptionhand'
    +'lerdemo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_apppascallibexceptionhandlerde'
    +'mo1_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_apppascallibexceptionhandle'
    +'rdemo1_Controls_pAppOnClickContextMenuItem',
  pOnClick name 'Java_com_example_apppascallibexceptionhandlerdemo1_Controls_'
    +'pOnClick',
  pOnChange name 'Java_com_example_apppascallibexceptionhandlerdemo1_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_com_example_apppascallibexceptionhandlerdemo1_Controls'
    +'_pOnChanged',
  pOnEnter name 'Java_com_example_apppascallibexceptionhandlerdemo1_Controls_'
    +'pOnEnter',
  pOnTimer name 'Java_com_example_apppascallibexceptionhandlerdemo1_Controls_'
    +'pOnTimer',
  pOnDraw name 'Java_com_example_apppascallibexceptionhandlerdemo1_Controls_'
    +'pOnDraw',
  pOnTouch name 'Java_com_example_apppascallibexceptionhandlerdemo1_Controls_'
    +'pOnTouch',
  pOnGLRenderer name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pOnGLRenderer',
  pOnClose name 'Java_com_example_apppascallibexceptionhandlerdemo1_Controls_'
    +'pOnClose',
  pOnWebViewStatus name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pOnWebViewStatus',
  pOnAsyncEventDoInBackground name 'Java_com_example_apppascallibexceptionhandl'
    +'erdemo1_Controls_pOnAsyncEventDoInBackground',
  pOnAsyncEventProgressUpdate name 'Java_com_example_apppascallibexceptionhandl'
    +'erdemo1_Controls_pOnAsyncEventProgressUpdate',
  pOnAsyncEventPreExecute name 'Java_com_example_apppascallibexceptionhandlerde'
    +'mo1_Controls_pOnAsyncEventPreExecute',
  pOnAsyncEventPostExecute name 'Java_com_example_apppascallibexceptionhandlerd'
    +'emo1_Controls_pOnAsyncEventPostExecute',
  pOnClickWidgetItem name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_com_example_apppascallibexceptionhandlerdemo1'
    +'_Controls_pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_com_example_apppascallibexceptionh'
    +'andlerdemo1_Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_com_example_apppascallibexceptionh'
    +'andlerdemo1_Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_com_example_apppascallibexceptionhandler'
    +'demo1_Controls_pOnListViewDrawItemBitmap',
  pOnBluetoothEnabled name 'Java_com_example_apppascallibexceptionhandlerdemo1'
    +'_Controls_pOnBluetoothEnabled',
  pOnBluetoothDisabled name 'Java_com_example_apppascallibexceptionhandlerdemo'
    +'1_Controls_pOnBluetoothDisabled',
  pOnBluetoothDeviceFound name 'Java_com_example_apppascallibexceptionhandlerde'
    +'mo1_Controls_pOnBluetoothDeviceFound',
  pOnBluetoothDiscoveryStarted name 'Java_com_example_apppascallibexceptionhand'
    +'lerdemo1_Controls_pOnBluetoothDiscoveryStarted',
  pOnBluetoothDiscoveryFinished name 'Java_com_example_apppascallibexceptionhan'
    +'dlerdemo1_Controls_pOnBluetoothDiscoveryFinished',
  pOnBluetoothDeviceBondStateChanged name 'Java_com_example_apppascallibexcepti'
    +'onhandlerdemo1_Controls_pOnBluetoothDeviceBondStateChanged',
  pOnBluetoothClientSocketConnected name 'Java_com_example_apppascallibexceptio'
    +'nhandlerdemo1_Controls_pOnBluetoothClientSocketConnected',
  pOnBluetoothClientSocketIncomingData name 'Java_com_example_'
    +'apppascallibexceptionhandlerdemo1_Controls_'
  ...
  pOnBluetoothServerSocketConnected name 'Java_com_example_apppascallibexceptio'
    +'nhandlerdemo1_Controls_pOnBluetoothServerSocketConnected',
  pOnBluetoothServerSocketIncomingData name 'Java_com_example_'
    +'apppascallibexceptionhandlerdemo1_Controls_'
    +'pOnBluetoothServerSocketIncomingData',
  pOnBluetoothServerSocketListen name 'Java_com_example_apppascallibexceptionha'
    +'ndlerdemo1_Controls_pOnBluetoothServerSocketListen',
  pOnBluetoothServerSocketAcceptTimeout name 'Java_com_example_'
    +'apppascallibexceptionhandlerdemo1_Controls_'
    +'pOnBluetoothServerSocketAcceptTimeout',
  pOnSpinnerItemSeleceted name 'Java_com_example_apppascallibexceptionhandlerde'
    +'mo1_Controls_pOnSpinnerItemSeleceted',
  pOnLocationChanged name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pOnLocationChanged',
  pOnLocationStatusChanged name 'Java_com_example_apppascallibexceptionhandlerd'
    +'emo1_Controls_pOnLocationStatusChanged',
  pOnLocationProviderEnabled name 'Java_com_example_apppascallibexceptionhandle'
    +'rdemo1_Controls_pOnLocationProviderEnabled',
  pOnLocationProviderDisabled name 'Java_com_example_apppascallibexceptionhandl'
    +'erdemo1_Controls_pOnLocationProviderDisabled',
  pAppOnViewClick name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_apppascallibexceptionhandlerdemo1'
    +'_Controls_pAppOnListItemClick',
  pOnActionBarTabSelected name 'Java_com_example_apppascallibexceptionhandlerde'
    +'mo1_Controls_pOnActionBarTabSelected',
  pOnActionBarTabUnSelected name 'Java_com_example_apppascallibexceptionhandler'
    +'demo1_Controls_pOnActionBarTabUnSelected',
  pOnCustomDialogShow name 'Java_com_example_apppascallibexceptionhandlerdemo1'
    +'_Controls_pOnCustomDialogShow',
  pOnCustomDialogBackKeyPressed name 'Java_com_example_apppascallibexceptionhan'
    +'dlerdemo1_Controls_pOnCustomDialogBackKeyPressed',
  pOnClickToggleButton name 'Java_com_example_apppascallibexceptionhandlerdemo'
    +'1_Controls_pOnClickToggleButton',
  pOnChangeSwitchButton name 'Java_com_example_apppascallibexceptionhandlerdemo'
    +'1_Controls_pOnChangeSwitchButton',
  pOnClickGridItem name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pOnClickGridItem',
  pOnLongClickGridItem name 'Java_com_example_apppascallibexceptionhandlerdemo'
    +'1_Controls_pOnLongClickGridItem',
  pOnGridDrawItemCaptionColor name 'Java_com_example_apppascallibexceptionhandl'
    +'erdemo1_Controls_pOnGridDrawItemCaptionColor',
  pOnGridDrawItemBitmap name 'Java_com_example_apppascallibexceptionhandlerdemo'
    +'1_Controls_pOnGridDrawItemBitmap',
  pOnChangedSensor name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pOnChangedSensor',
  pOnListeningSensor name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pOnListeningSensor',
  pOnUnregisterListeningSensor name 'Java_com_example_apppascallibexceptionhand'
    +'lerdemo1_Controls_pOnUnregisterListeningSensor',
  pOnBroadcastReceiver name 'Java_com_example_apppascallibexceptionhandlerdemo'
    +'1_Controls_pOnBroadcastReceiver',
  pOnTimePicker name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pOnTimePicker',
  pOnDatePicker name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pOnDatePicker',
  pOnFlingGestureDetected name 'Java_com_example_apppascallibexceptionhandlerde'
    +'mo1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_apppascallibexceptionhandl'
    +'erdemo1_Controls_pOnPinchZoomGestureDetected',
  pOnShellCommandExecuted name 'Java_com_example_apppascallibexceptionhandlerde'
    +'mo1_Controls_pOnShellCommandExecuted',
  pOnTCPSocketClientMessageReceived name 'Java_com_example_apppascallibexceptio'
    +'nhandlerdemo1_Controls_pOnTCPSocketClientMessageReceived',
  pOnTCPSocketClientConnected name 'Java_com_example_apppascallibexceptionhandl'
    +'erdemo1_Controls_pOnTCPSocketClientConnected',
  pOnHttpClientContentResult name 'Java_com_example_apppascallibexceptionhandle'
    +'rdemo1_Controls_pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_com_example_apppascallibexceptionhandlerde'
    +'mo1_Controls_pOnHttpClientCodeResult',
  pOnSurfaceViewCreated name 'Java_com_example_apppascallibexceptionhandlerdemo'
    +'1_Controls_pOnSurfaceViewCreated',
  pOnSurfaceViewDraw name 'Java_com_example_apppascallibexceptionhandlerdemo1_'
    +'Controls_pOnSurfaceViewDraw',
  pOnSurfaceViewChanged name 'Java_com_example_apppascallibexceptionhandlerdemo'
    +'1_Controls_pOnSurfaceViewChanged',
  pOnMediaPlayerPrepared name 'Java_com_example_apppascallibexceptionhandlerdem'
    +'o1_Controls_pOnMediaPlayerPrepared',
  pOnMediaPlayerVideoSizeChanged name 'Java_com_example_apppascallibexceptionha'
    +'ndlerdemo1_Controls_pOnMediaPlayerVideoSizeChanged',
  pOnMediaPlayerCompletion name 'Java_com_example_apppascallibexceptionhandlerd'
    +'emo1_Controls_pOnMediaPlayerCompletion',
  pOnMediaPlayerTimedText name 'Java_com_example_apppascallibexceptionhandlerde'
    +'mo1_Controls_pOnMediaPlayerTimedText',
  pOnSurfaceViewTouch name 'Java_com_example_apppascallibexceptionhandlerdemo1'
    +'_Controls_pOnSurfaceViewTouch',
  pOnSurfaceViewDrawingInBackground name 'Java_com_example_apppascallibexceptio'
    +'nhandlerdemo1_Controls_pOnSurfaceViewDrawingInBackground',
  pOnSurfaceViewDrawingPostExecute name 'Java_com_example_apppascallibexception'
    +'handlerdemo1_Controls_pOnSurfaceViewDrawingPostExecute',
  pOnContactManagerContactsExecuted name 'Java_com_example_apppascallibexceptio'
    +'nhandlerdemo1_Controls_pOnContactManagerContactsExecuted',
  pOnContactManagerContactsProgress name 'Java_com_example_apppascallibexceptio'
    +'nhandlerdemo1_Controls_pOnContactManagerContactsProgress',
  pOnSeekBarProgressChanged name 'Java_com_example_apppascallibexceptionhandler'
    +'demo1_Controls_pOnSeekBarProgressChanged',
  pOnSeekBarStartTrackingTouch name 'Java_com_example_apppascallibexceptionhand'
    +'lerdemo1_Controls_pOnSeekBarStartTrackingTouch',
  pOnSeekBarStopTrackingTouch name 'Java_com_example_apppascallibexceptionhandl'
    +'erdemo1_Controls_pOnSeekBarStopTrackingTouch';

  
begin
  gApp:= jApp.Create(nil);
  gApp.Title:= 'JNI Android Bridges Library';
  gjAppName:= 'com.example.apppascallibexceptionhandlerdemo1';
  gjClassName:= 'com/example/apppascallibexceptionhandlerdemo1/Controls';
