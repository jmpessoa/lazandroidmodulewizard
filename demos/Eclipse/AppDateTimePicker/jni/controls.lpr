...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_appdatetimepicker_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appdatetimepicker_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name
    'Java_com_example_appdatetimepicker_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appdatetimepicker_Controls_pAppOnPause',
  pAppOnRestart name
    'Java_com_example_appdatetimepicker_Controls_pAppOnRestart',
  ...
  pAppOnBackPressed name 'Java_com_example_appdatetimepicker_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appdatetimepicker_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appdatetimepicker_Controls'
    +'_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appdatetimepicker_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appdatetimepicker_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appdatetimepicker_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appdatetimepicker_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appdatetimepicker_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appdatetimepicker_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appdatetimepicker_Controls'
  ...
  pOnClickGeneric name 'Java_com_example_appdatetimepicker_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appdatetimepicker_Controls_'
  ...
  pAppOnViewClick name 'Java_com_example_appdatetimepicker_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appdatetimepicker_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appdatetimepicker_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appdatetimepicker_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnDatePicker name
    'Java_com_example_appdatetimepicker_Controls_pOnDatePicker',
  pOnTimePicker name
    'Java_com_example_appdatetimepicker_Controls_pOnTimePicker';
