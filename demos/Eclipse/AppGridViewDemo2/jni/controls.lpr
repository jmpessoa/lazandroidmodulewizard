...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 05/08/2016 17:21:22]
...
{ Class:     com_mrit_appgridviewdemo2_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/mrit/appgridviewdemo2/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_mrit_appgridviewdemo2_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 
    'Java_com_mrit_appgridviewdemo2_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_mrit_appgridviewdemo2_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_mrit_appgridviewdemo2_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_mrit_appgridviewdemo2_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_mrit_appgridviewdemo2_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_mrit_appgridviewdemo2_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_mrit_appgridviewdemo2_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_mrit_appgridviewdemo2_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_mrit_appgridviewdemo2_Controls_pOnDraw',
  pOnTouch name 'Java_com_mrit_appgridviewdemo2_Controls_pOnTouch',
  pOnClickGeneric name 
    'Java_com_mrit_appgridviewdemo2_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_mrit_appgridviewdemo2_Controls_pOnClick',
  pOnChange name 'Java_com_mrit_appgridviewdemo2_Controls_pOnChange',
  pOnChanged name 'Java_com_mrit_appgridviewdemo2_Controls_pOnChanged',
  pOnEnter name 'Java_com_mrit_appgridviewdemo2_Controls_pOnEnter',
  pOnClose name 'Java_com_mrit_appgridviewdemo2_Controls_pOnClose',
  pAppOnViewClick name 
    'Java_com_mrit_appgridviewdemo2_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnClickGridItem name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pOnClickGridItem',
  pOnLongClickGridItem name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pOnLongClickGridItem',
  pOnGridDrawItemCaptionColor name 'Java_com_mrit_appgridviewdemo2_Controls_'
    +'pOnGridDrawItemCaptionColor',
  pOnGridDrawItemBitmap name 'Java_com_mrit_appgridviewdemo2_Controls_'
...
begin
  ...
  gjAppName:= 'com.mrit.appgridviewdemo2';{AndroidWidget.pas}
  gjClassName:= 'com/mrit/appgridviewdemo2/Controls';{AndroidWidget.pas}
