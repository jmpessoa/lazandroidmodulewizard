...
begin
   ...
   begin
     ...
     FListDrafJavaClass.Add('   private LayoutParams lparams;              // layout XYWH ');
     ...
     FListDrafJavaClass.Add('      controls  = _ctrls;');
     FListDrafJavaClass.Add('   ');
     FListDrafJavaClass.Add('      lparams = new LayoutParams(lparamW, lparamH);');
     FListDrafJavaClass.Add('   ');
     ...
     FListDrafJavaClass.Add('   }');
     FListDrafJavaClass.Add('  ');
     FListDrafJavaClass.Add('   public void SetParent(ViewGroup _viewgroup) {');
     FListDrafJavaClass.Add('      if (parent != null) { parent.removeView(this); }');
     FListDrafJavaClass.Add('      parent = _viewgroup;');
     FListDrafJavaClass.Add('      _viewgroup.addView(this,lparams);');
     FListDrafJavaClass.Add('   }');
     FListDrafJavaClass.Add('  ');
