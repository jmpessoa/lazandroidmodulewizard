...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 12/16/2016 3:55:20]
...
{ Class:     com_example_appimagebtndemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appimagebtndemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_appimagebtndemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appimagebtndemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appimagebtndemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appimagebtndemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_appimagebtndemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_appimagebtndemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_appimagebtndemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appimagebtndemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appimagebtndemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_appimagebtndemo1_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_appimagebtndemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_appimagebtndemo1_Controls_pOnClick',
  pOnChange name 'Java_com_example_appimagebtndemo1_Controls_pOnChange',
  pOnChanged name 'Java_com_example_appimagebtndemo1_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_appimagebtndemo1_Controls_pOnEnter',
  pOnClose name 'Java_com_example_appimagebtndemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appimagebtndemo1_Controls'
    +'_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appimagebtndemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appimagebtndemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appimagebtndemo1_Controls_'
...
begin
  ...
  gjAppName:= 'com.example.appimagebtndemo1';
  gjClassName:= 'com/example/appimagebtndemo1/Controls';
