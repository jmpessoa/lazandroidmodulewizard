...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnRestart',
  ...
  pAppOnBackPressed name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnClickContextMenuItem',
  ...
  pOnClickGeneric name 'Java_com_example_apphttpclientdemo2_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnSpecialKeyDown',
  ...
  pAppOnViewClick name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_apphttpclientdemo2_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_apphttpclientdemo2_Controls_pOnPinchZoomGestureDetected',
  pOnHttpClientContentResult name 'Java_com_example_apphttpclientdemo2_Controls_pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_com_example_apphttpclientdemo2_Controls_pOnHttpClientCodeResult';

begin
  gApp:= jApp.Create(nil);{AndroidWidget.pas}
  gApp.Title:= 'My Android Bridges Library';
  gjAppName:= 'com.example.apphttpclientdemo2';{AndroidWidget.pas}
  gjClassName:= 'com/example/apphttpclientdemo2/Controls';{AndroidWidget.pas}
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TAndroidModule1, AndroidModule1);
end.
(*last [smart] upgrade: 7/4/2016 0:16:07*)
