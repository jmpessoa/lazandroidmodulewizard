...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 4/10/2016 20:44:41]
...
{ Class:     com_example_apphttpclientdemo2_Controls
...
begin
  ...
  begin
      curEnv:= PJNIEnv(PEnv);
      RegisterNativeMethods(curEnv, 'com/example/apphttpclientdemo2/Controls');
  end;
...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pAppOnScreenStyle',
  pAppOnCreate name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnCreate',
  pAppOnNewIntent name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_apphttpclientdemo2_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apphttpclientdemo2_Controls'
    +'_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnClick name 'Java_com_example_apphttpclientdemo2_Controls_pOnClick',
  pOnChange name 'Java_com_example_apphttpclientdemo2_Controls_pOnChange',
  pOnChanged name 'Java_com_example_apphttpclientdemo2_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_apphttpclientdemo2_Controls_pOnEnter',
  pOnTimer name 'Java_com_example_apphttpclientdemo2_Controls_pOnTimer',
  pOnDraw name 'Java_com_example_apphttpclientdemo2_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_apphttpclientdemo2_Controls_pOnTouch',
  pOnGLRenderer name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnGLRenderer',
  pOnClose name 'Java_com_example_apphttpclientdemo2_Controls_pOnClose',
  pOnWebViewStatus name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnWebViewStatus',
  pOnAsyncEventDoInBackground name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnAsyncEventDoInBackground',
  pOnAsyncEventProgressUpdate name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnAsyncEventProgressUpdate',
  pOnAsyncEventPreExecute name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnAsyncEventPreExecute',
  pOnAsyncEventPostExecute name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnAsyncEventPostExecute',
  pOnClickWidgetItem name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_com_example_apphttpclientdemo2_Controls'
    +'_pOnListViewDrawItemBitmap',
  pOnBluetoothEnabled name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnBluetoothEnabled',
  pOnBluetoothDisabled name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnBluetoothDisabled',
  pOnBluetoothDeviceFound name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnBluetoothDeviceFound',
  pOnBluetoothDiscoveryStarted name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnBluetoothDiscoveryStarted',
  pOnBluetoothDiscoveryFinished name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnBluetoothDiscoveryFinished',
  pOnBluetoothDeviceBondStateChanged name 'Java_com_example_apphttpclientdemo2'
    +'_Controls_pOnBluetoothDeviceBondStateChanged',
  pOnBluetoothClientSocketConnected name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnBluetoothClientSocketConnected',
  pOnBluetoothClientSocketIncomingData name 'Java_com_example_'
    +'apphttpclientdemo2_Controls_pOnBluetoothClientSocketIncomingData',
  pOnBluetoothClientSocketDisconnected name 'Java_com_example_'
    +'apphttpclientdemo2_Controls_pOnBluetoothClientSocketDisconnected',
  pOnBluetoothServerSocketConnected name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnBluetoothServerSocketConnected',
  pOnBluetoothServerSocketIncomingData name 'Java_com_example_'
    +'apphttpclientdemo2_Controls_pOnBluetoothServerSocketIncomingData',
  pOnBluetoothServerSocketListen name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnBluetoothServerSocketListen',
  pOnBluetoothServerSocketAcceptTimeout name 'Java_com_example_'
    +'apphttpclientdemo2_Controls_pOnBluetoothServerSocketAcceptTimeout',
  pOnSpinnerItemSeleceted name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnSpinnerItemSeleceted',
  pOnLocationChanged name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnLocationChanged',
  pOnLocationStatusChanged name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnLocationStatusChanged',
  pOnLocationProviderEnabled name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnLocationProviderEnabled',
  pOnLocationProviderDisabled name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnLocationProviderDisabled',
  pAppOnViewClick name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pAppOnListItemClick',
  pOnActionBarTabSelected name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnActionBarTabSelected',
  pOnActionBarTabUnSelected name 'Java_com_example_apphttpclientdemo2_Controls'
    +'_pOnActionBarTabUnSelected',
  pOnCustomDialogShow name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnCustomDialogShow',
  pOnCustomDialogBackKeyPressed name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnCustomDialogBackKeyPressed',
  pOnClickToggleButton name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnClickToggleButton',
  pOnChangeSwitchButton name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnChangeSwitchButton',
  pOnClickGridItem name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnClickGridItem',
  pOnLongClickGridItem name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnLongClickGridItem',
  pOnGridDrawItemCaptionColor name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnGridDrawItemCaptionColor',
  pOnGridDrawItemBitmap name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnGridDrawItemBitmap',
  pOnChangedSensor name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnChangedSensor',
  pOnListeningSensor name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnListeningSensor',
  pOnUnregisterListeningSensor name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnUnregisterListeningSensor',
  pOnBroadcastReceiver name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnBroadcastReceiver',
  pOnTimePicker name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnTimePicker',
  pOnDatePicker name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnDatePicker',
  pOnFlingGestureDetected name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnShellCommandExecuted name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnShellCommandExecuted',
  pOnTCPSocketClientMessageReceived name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnTCPSocketClientMessageReceived',
  pOnTCPSocketClientConnected name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnTCPSocketClientConnected',
  pOnHttpClientContentResult name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnHttpClientCodeResult',
  pOnSurfaceViewCreated name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnSurfaceViewCreated',
  pOnSurfaceViewDraw name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnSurfaceViewDraw',
  pOnSurfaceViewChanged name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnSurfaceViewChanged',
  pOnMediaPlayerPrepared name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnMediaPlayerPrepared',
  pOnMediaPlayerVideoSizeChanged name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnMediaPlayerVideoSizeChanged',
  pOnMediaPlayerCompletion name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnMediaPlayerCompletion',
  pOnMediaPlayerTimedText name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnMediaPlayerTimedText',
  pOnSurfaceViewTouch name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnSurfaceViewTouch',
  pOnSurfaceViewDrawingInBackground name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnSurfaceViewDrawingInBackground',
  pOnSurfaceViewDrawingPostExecute name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnSurfaceViewDrawingPostExecute',
  pOnContactManagerContactsExecuted name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnContactManagerContactsExecuted',
  pOnContactManagerContactsProgress name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnContactManagerContactsProgress',
  pOnSeekBarProgressChanged name 'Java_com_example_apphttpclientdemo2_Controls'
    +'_pOnSeekBarProgressChanged',
  pOnSeekBarStartTrackingTouch name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnSeekBarStartTrackingTouch',
  pOnSeekBarStopTrackingTouch name 'Java_com_example_apphttpclientdemo2_'
    +'Controls_pOnSeekBarStopTrackingTouch',
  pOnRatingBarChanged name 'Java_com_example_apphttpclientdemo2_Controls_'
    +'pOnRatingBarChanged',
  pRadioGroupCheckedChanged name 'Java_com_example_apphttpclientdemo2_Controls'
    +'_pRadioGroupCheckedChanged';

  
begin
  gApp:= jApp.Create(nil);
  gApp.Title:= 'JNI Android Bridges Library';
  gjAppName:= 'com.example.apphttpclientdemo2';
  gjClassName:= 'com/example/apphttpclientdemo2/Controls';
