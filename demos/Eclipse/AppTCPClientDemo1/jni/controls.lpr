...
library controls;  //by Lamw: Lazarus Android Module Wizard: 5/20/2015 2:45:47]
...
procedure pOnTCPSocketClientMessageReceived(PEnv: PJNIEnv; this: JObject; pasobj: JLong; messageReceived: jObjectArray); cdecl;
begin
  Java_Event_pOnTCPSocketClientMessageReceived(PEnv,this,TObject(pasobj),messageReceived);
end;
...
exports
  ...
  pOnAsyncEvent name 'Java_com_example_apptcpclientdemo1_Controls_pOnAsyncEvent',
