...
const NativeMethods:array[0..33] of JNINativeMethod = (
   (name:'pAppOnCreate';
    signature:'(Landroid/content/Context;Landroid/widget/RelativeLayout;)V';
    fnPtr:@pAppOnCreate;),
...
exports
  ...
  pOnClickGeneric name 'Java_com_example_apphttpclientcookiesdemo1_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_apphttpclientcookiesdemo1_Controls_pAppOnSpecialKeyDown',
...
(*last [smart] upgrade: 7/4/2016 0:13:02*)
