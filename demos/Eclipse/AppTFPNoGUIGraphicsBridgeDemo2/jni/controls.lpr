...
exports
  ...
  pOnEnter name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pOnEnter',
  pOnTimer name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pOnTimer',
  ...
  pOnTouch name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pOnTouch',
  pOnGLRenderer name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls'
    +'_pOnGLRenderer',
  pOnClose name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_'
    +'pOnClose',
  pOnWebViewStatus name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnWebViewStatus',
  pOnAsyncEventDoInBackground name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo2_Controls_pOnAsyncEventDoInBackground',
  ...
  pOnBluetoothServerSocketConnected name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo2_Controls_pOnBluetoothServerSocketConnected',
  ...
  pOnBluetoothServerSocketListen name 'Java_com_example_apptfpnoguigraphicsbrid'
    +'gedemo2_Controls_pOnBluetoothServerSocketListen',
  ...
  pOnSpinnerItemSeleceted name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'2_Controls_pOnSpinnerItemSeleceted',
  pOnLocationChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnLocationChanged',
  pOnLocationStatusChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'2_Controls_pOnLocationStatusChanged',
  pOnLocationProviderEnabled name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo2_Controls_pOnLocationProviderEnabled',
  ...
  pOnActionBarTabSelected name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'2_Controls_pOnActionBarTabSelected',
  pOnActionBarTabUnSelected name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o2_Controls_pOnActionBarTabUnSelected',
  pOnCustomDialogShow name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
  ...
  pOnClickToggleButton name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnClickToggleButton',
  pOnChangeSwitchButton name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnChangeSwitchButton',
  pOnClickGridItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnClickGridItem',
  pOnLongClickGridItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnLongClickGridItem',
  pOnGridDrawItemCaptionColor name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo2_Controls_pOnGridDrawItemCaptionColor',
  pOnGridDrawItemBitmap name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnGridDrawItemBitmap',
  pOnChangedSensor name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnChangedSensor',
  pOnListeningSensor name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnListeningSensor',
  pOnUnregisterListeningSensor name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo2_Controls_pOnUnregisterListeningSensor',
  pOnBroadcastReceiver name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnBroadcastReceiver',
  pOnTimePicker name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls'
    +'_pOnTimePicker',
  pOnDatePicker name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls'
    +'_pOnDatePicker',
  ...
  pOnShellCommandExecuted name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'2_Controls_pOnShellCommandExecuted',
  pOnTCPSocketClientMessageReceived name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo2_Controls_pOnTCPSocketClientMessageReceived',
  pOnTCPSocketClientConnected name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo2_Controls_pOnTCPSocketClientConnected',
  pOnHttpClientContentResult name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo2_Controls_pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'2_Controls_pOnHttpClientCodeResult',
  pOnSurfaceViewCreated name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnSurfaceViewCreated',
  pOnSurfaceViewDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
    +'Controls_pOnSurfaceViewDraw',
  pOnSurfaceViewChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_'
