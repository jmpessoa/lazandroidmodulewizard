...
library controls;  //by Lamw: Lazarus Android Module Wizard: 7/15/2015 23:58:32]
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appmenudemo/Controls');
  end;
...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_appmenudemo_Controls_pAppOnScreenStyle',
  pAppOnCreate name 'Java_com_example_appmenudemo_Controls_pAppOnCreate',
  pAppOnNewIntent name 'Java_com_example_appmenudemo_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appmenudemo_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appmenudemo_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appmenudemo_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_appmenudemo_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_appmenudemo_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_appmenudemo_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appmenudemo_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appmenudemo_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appmenudemo_Controls_pAppOnConfigurationChanged',
  ...
  pOnTouch name 'Java_com_example_appmenudemo_Controls_pOnTouch',
  pOnGLRenderer name 'Java_com_example_appmenudemo_Controls_pOnGLRenderer',
  pOnClose name 'Java_com_example_appmenudemo_Controls_pOnClose',
  pOnWebViewStatus name 'Java_com_example_appmenudemo_Controls_pOnWebViewStatus',
  pOnAsyncEventDoInBackground name 'Java_com_example_appmenudemo_Controls_pOnAsyncEventDoInBackground',
  pOnAsyncEventProgressUpdate name 'Java_com_example_appmenudemo_Controls_pOnAsyncEventProgressUpdate',
  pOnAsyncEventPreExecute name 'Java_com_example_appmenudemo_Controls_pOnAsyncEventPreExecute',
  ...
  pOnBluetoothDiscoveryStarted name 'Java_com_example_appmenudemo_Controls_pOnBluetoothDiscoveryStarted',
  pOnBluetoothDiscoveryFinished name 'Java_com_example_appmenudemo_Controls_pOnBluetoothDiscoveryFinished',
  pOnBluetoothDeviceBondStateChanged name 'Java_com_example_appmenudemo_Controls_pOnBluetoothDeviceBondStateChanged',
  pOnBluetoothClientSocketConnected name 'Java_com_example_appmenudemo_Controls_pOnBluetoothClientSocketConnected',
  pOnBluetoothClientSocketIncomingData name 'Java_com_example_appmenudemo_Controls_pOnBluetoothClientSocketIncomingData',
  pOnBluetoothClientSocketDisconnected name 'Java_com_example_appmenudemo_Controls_pOnBluetoothClientSocketDisconnected',
  pOnBluetoothServerSocketConnected name 'Java_com_example_appmenudemo_Controls_pOnBluetoothServerSocketConnected',
  pOnBluetoothServerSocketIncomingData name 'Java_com_example_appmenudemo_Controls_pOnBluetoothServerSocketIncomingData',
  pOnBluetoothServerSocketListen name 'Java_com_example_appmenudemo_Controls_pOnBluetoothServerSocketListen',
  pOnBluetoothServerSocketAcceptTimeout name 'Java_com_example_appmenudemo_Controls_pOnBluetoothServerSocketAcceptTimeout',
  pOnSpinnerItemSeleceted name 'Java_com_example_appmenudemo_Controls_pOnSpinnerItemSeleceted',
  pOnLocationChanged name 'Java_com_example_appmenudemo_Controls_pOnLocationChanged',
  pOnLocationStatusChanged name 'Java_com_example_appmenudemo_Controls_pOnLocationStatusChanged',
  pOnLocationProviderEnabled name 'Java_com_example_appmenudemo_Controls_pOnLocationProviderEnabled',
  pOnLocationProviderDisabled name 'Java_com_example_appmenudemo_Controls_pOnLocationProviderDisabled',
  ...
  pOnBroadcastReceiver name 'Java_com_example_appmenudemo_Controls_pOnBroadcastReceiver',
  pOnTimePicker name 'Java_com_example_appmenudemo_Controls_pOnTimePicker',
  pOnDatePicker name 'Java_com_example_appmenudemo_Controls_pOnDatePicker',
  pOnFlingGestureDetected name 'Java_com_example_appmenudemo_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appmenudemo_Controls_pOnPinchZoomGestureDetected',
  pOnShellCommandExecuted name 'Java_com_example_appmenudemo_Controls_pOnShellCommandExecuted',
  pOnTCPSocketClientMessageReceived name 'Java_com_example_appmenudemo_Controls_pOnTCPSocketClientMessageReceived',
  pOnTCPSocketClientConnected name 'Java_com_example_appmenudemo_Controls_pOnTCPSocketClientConnected',
  pOnHttpClientContentResult name 'Java_com_example_appmenudemo_Controls_pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_com_example_appmenudemo_Controls_pOnHttpClientCodeResult',
  pOnSurfaceViewCreated name 'Java_com_example_appmenudemo_Controls_pOnSurfaceViewCreated',
  pOnSurfaceViewDraw name 'Java_com_example_appmenudemo_Controls_pOnSurfaceViewDraw',
  pOnSurfaceViewChanged name 'Java_com_example_appmenudemo_Controls_pOnSurfaceViewChanged',
  pOnMediaPlayerPrepared name 'Java_com_example_appmenudemo_Controls_pOnMediaPlayerPrepared',
  pOnMediaPlayerVideoSizeChanged name 'Java_com_example_appmenudemo_Controls_pOnMediaPlayerVideoSizeChanged',
  pOnMediaPlayerCompletion name 'Java_com_example_appmenudemo_Controls_pOnMediaPlayerCompletion',
  ...
  pOnSeekBarProgressChanged name 'Java_com_example_appmenudemo_Controls_pOnSeekBarProgressChanged',
  pOnSeekBarStartTrackingTouch name 'Java_com_example_appmenudemo_Controls_pOnSeekBarStartTrackingTouch',
  pOnSeekBarStopTrackingTouch name 'Java_com_example_appmenudemo_Controls_pOnSeekBarStopTrackingTouch',
  pOnRatingBarChanged name 'Java_com_example_appmenudemo_Controls_pOnRatingBarChanged',
  pRadioGroupCheckedChanged name 'Java_com_example_appmenudemo_Controls_pRadioGroupCheckedChanged',
  pOnClickAutoDropDownItem name 'Java_com_example_appmenudemo_Controls_pOnClickAutoDropDownItem',
  pOnClickGeneric name 'Java_com_example_appmenudemo_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appmenudemo_Controls_pAppOnSpecialKeyDown';

begin
  gApp:= jApp.Create(nil);{AndroidWidget.pas}
  gApp.Title:= 'My Android Bridges Library';
  gjAppName:= 'com.example.appmenudemo';{AndroidWidget.pas}
  gjClassName:= 'com/example/appmenudemo/Controls';{AndroidWidget.pas}
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TAndroidModule1, AndroidModule1);
end.
(*last [template] upgrade: 5/10/2016 23:10:16*)
