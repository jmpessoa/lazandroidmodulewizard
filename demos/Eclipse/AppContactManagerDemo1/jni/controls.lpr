...
library controls;  //by Lamw: Lazarus Android Module Wizard: 7/5/2015 15:33:44]
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appcontactmanagerdemo1/Controls');
  end;
...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnScreenStyle',
  pAppOnCreate name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnCreate',
  pAppOnNewIntent name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnClickContextMenuItem',
  pOnClick name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnClick',
  pOnChange name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnChange',
  pOnChanged name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnEnter',
  pOnTimer name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnTimer',
  pOnDraw name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnTouch',
  pOnGLRenderer name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnGLRenderer',
  pOnClose name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnClose',
  pOnWebViewStatus name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnWebViewStatus',
  pOnAsyncEventDoInBackground name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnAsyncEventDoInBackground',
  pOnAsyncEventProgressUpdate name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnAsyncEventProgressUpdate',
  pOnAsyncEventPreExecute name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnAsyncEventPreExecute',
  pOnAsyncEventPostExecute name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnAsyncEventPostExecute',
  pOnClickWidgetItem name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnListViewDrawItemBitmap',
  pOnBluetoothEnabled name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnBluetoothEnabled',
  pOnBluetoothDisabled name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnBluetoothDisabled',
  pOnBluetoothDeviceFound name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnBluetoothDeviceFound',
  pOnBluetoothDiscoveryStarted name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnBluetoothDiscoveryStarted',
  pOnBluetoothDiscoveryFinished name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnBluetoothDiscoveryFinished',
  pOnBluetoothDeviceBondStateChanged name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnBluetoothDeviceBondStateChanged',
  pOnBluetoothClientSocketConnected name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnBluetoothClientSocketConnected',
  pOnBluetoothClientSocketIncomingData name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnBluetoothClientSocketIncomingData',
  pOnBluetoothClientSocketDisconnected name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnBluetoothClientSocketDisconnected',
  pOnBluetoothServerSocketConnected name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnBluetoothServerSocketConnected',
  pOnBluetoothServerSocketIncomingData name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnBluetoothServerSocketIncomingData',
  pOnBluetoothServerSocketListen name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnBluetoothServerSocketListen',
  pOnBluetoothServerSocketAcceptTimeout name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnBluetoothServerSocketAcceptTimeout',
  pOnSpinnerItemSeleceted name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnSpinnerItemSeleceted',
  pOnLocationChanged name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnLocationChanged',
  pOnLocationStatusChanged name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnLocationStatusChanged',
  pOnLocationProviderEnabled name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnLocationProviderEnabled',
  pOnLocationProviderDisabled name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnLocationProviderDisabled',
  pAppOnViewClick name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnListItemClick',
  pOnActionBarTabSelected name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnActionBarTabSelected',
  pOnActionBarTabUnSelected name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnActionBarTabUnSelected',
  pOnCustomDialogShow name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnCustomDialogShow',
  pOnCustomDialogBackKeyPressed name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnCustomDialogBackKeyPressed',
  pOnClickToggleButton name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnClickToggleButton',
  pOnChangeSwitchButton name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnChangeSwitchButton',
  pOnClickGridItem name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnClickGridItem',
  pOnLongClickGridItem name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnLongClickGridItem',
  pOnGridDrawItemCaptionColor name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnGridDrawItemCaptionColor',
  pOnGridDrawItemBitmap name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnGridDrawItemBitmap',
  pOnChangedSensor name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnChangedSensor',
  pOnListeningSensor name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnListeningSensor',
  pOnUnregisterListeningSensor name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnUnregisterListeningSensor',
  pOnBroadcastReceiver name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnBroadcastReceiver',
  pOnTimePicker name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnTimePicker',
  pOnDatePicker name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnDatePicker',
  pOnFlingGestureDetected name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnPinchZoomGestureDetected',
  pOnShellCommandExecuted name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnShellCommandExecuted',
  pOnTCPSocketClientMessageReceived name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnTCPSocketClientMessageReceived',
  pOnTCPSocketClientConnected name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnTCPSocketClientConnected',
  pOnHttpClientContentResult name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnHttpClientCodeResult',
  pOnSurfaceViewCreated name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnSurfaceViewCreated',
  pOnSurfaceViewDraw name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnSurfaceViewDraw',
  pOnSurfaceViewChanged name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnSurfaceViewChanged',
  pOnMediaPlayerPrepared name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnMediaPlayerPrepared',
  pOnMediaPlayerVideoSizeChanged name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnMediaPlayerVideoSizeChanged',
  pOnMediaPlayerCompletion name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnMediaPlayerCompletion',
  pOnMediaPlayerTimedText name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnMediaPlayerTimedText',
  pOnSurfaceViewTouch name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnSurfaceViewTouch',
  pOnSurfaceViewDrawingInBackground name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnSurfaceViewDrawingInBackground',
  pOnSurfaceViewDrawingPostExecute name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnSurfaceViewDrawingPostExecute',
  ...
  pOnSeekBarProgressChanged name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnSeekBarProgressChanged',
  pOnSeekBarStartTrackingTouch name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnSeekBarStartTrackingTouch',
  pOnSeekBarStopTrackingTouch name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnSeekBarStopTrackingTouch';

begin
  gApp:= jApp.Create(nil);{AndroidWidget.pas}
  gApp.Title:= 'My Android Bridges Library';
  gjAppName:= 'com.example.appcontactmanagerdemo1';{AndroidWidget.pas}
  gjClassName:= 'com/example/appcontactmanagerdemo1/Controls';{AndroidWidget.pas}
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TAndroidModule1, AndroidModule1);
end.
(*last [template] upgrade: 10/12/2015 19:41:39*)
