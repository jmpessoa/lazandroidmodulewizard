...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appdemo2/Controls');
  end;
...
exports
  ...
  pAppOnStart name 'Java_com_example_appdemo2_Controls_pAppOnStart',
  ...
  pAppOnCreateOptionsMenu name 'Java_com_example_appdemo2_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appdemo2_Controls_pAppOnClickOptionMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appdemo2_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appdemo2_Controls_pAppOnClickContextMenuItem',
  ...
  pOnActive name 'Java_com_example_appdemo2_Controls_pOnActive',
  ...
  pOnClickWidgetItem name 'Java_com_example_appdemo2_Controls_pOnClickWidgetItem';
