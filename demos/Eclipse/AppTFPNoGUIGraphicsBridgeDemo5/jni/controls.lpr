...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/apptfpnoguigraphicsbridgedemo5/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pOnClick',
  pOnChange name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pOnChange',
  pOnChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pOnEnter',
  pOnClose name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_pOnPinchZoomGestureDetected';

begin
  gApp:= jApp.Create(nil);{AndroidWidget.pas}
  gApp.Title:= 'My Android Bridges Library';
  gjAppName:= 'com.example.apptfpnoguigraphicsbridgedemo5';{AndroidWidget.pas}
  gjClassName:= 'com/example/apptfpnoguigraphicsbridgedemo5/Controls';{AndroidWidget.pas}
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TAndroidModule1, AndroidModule1);
end.
(*last [smart] upgrade: 7/4/2016 1:57:05*)
