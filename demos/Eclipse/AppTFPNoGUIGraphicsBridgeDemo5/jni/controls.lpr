...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 12/21/2015 2:44:27]
...
{ Class:     com_example_apptfpnoguigraphicsbridgedemo5_Controls
...
begin
  ...
  begin
      curEnv:= PJNIEnv(PEnv);
      RegisterNativeMethods(curEnv, 'com/example/apptfpnoguigraphicsbridgedemo5'
        +'/Controls');
  end;
...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pAppOnScreenStyle',
  pAppOnCreate name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_'
    +'pAppOnCreate',
  pAppOnNewIntent name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls'
    +'_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls'
    +'_pAppOnRestart',
  pAppOnResume name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo5_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'5_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o5_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'5_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo5_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'5_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo5_Controls_pAppOnClickContextMenuItem',
  pOnClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_'
    +'pOnClick',
  pOnChange name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_'
    +'pOnEnter',
  pOnTimer name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_'
    +'pOnTimer',
  pOnDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_'
    +'pOnDraw',
  pOnTouch name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_'
    +'pOnTouch',
  pOnGLRenderer name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls'
    +'_pOnGLRenderer',
  pOnClose name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls_'
    +'pOnClose',
  pOnWebViewStatus name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnWebViewStatus',
  pOnAsyncEventDoInBackground name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo5_Controls_pOnAsyncEventDoInBackground',
  pOnAsyncEventProgressUpdate name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo5_Controls_pOnAsyncEventProgressUpdate',
  pOnAsyncEventPreExecute name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'5_Controls_pOnAsyncEventPreExecute',
  pOnAsyncEventPostExecute name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'5_Controls_pOnAsyncEventPostExecute',
  pOnClickWidgetItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_com_example_apptfpnoguigraphicsbri'
    +'dgedemo5_Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_com_example_apptfpnoguigraphicsbri'
    +'dgedemo5_Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o5_Controls_pOnListViewDrawItemBitmap',
  pOnBluetoothEnabled name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnBluetoothEnabled',
  pOnBluetoothDisabled name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnBluetoothDisabled',
  pOnBluetoothDeviceFound name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'5_Controls_pOnBluetoothDeviceFound',
  pOnBluetoothDiscoveryStarted name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo5_Controls_pOnBluetoothDiscoveryStarted',
  pOnBluetoothDiscoveryFinished name 'Java_com_example_apptfpnoguigraphicsbridg'
    +'edemo5_Controls_pOnBluetoothDiscoveryFinished',
  pOnBluetoothDeviceBondStateChanged name 'Java_com_example_apptfpnoguigraphics'
    +'bridgedemo5_Controls_pOnBluetoothDeviceBondStateChanged',
  pOnBluetoothClientSocketConnected name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo5_Controls_pOnBluetoothClientSocketConnected',
  pOnBluetoothClientSocketIncomingData name 'Java_com_example_'
    +'apptfpnoguigraphicsbridgedemo5_Controls_'
  ...
  pOnBluetoothServerSocketConnected name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo5_Controls_pOnBluetoothServerSocketConnected',
  ...
  pOnBluetoothServerSocketListen name 'Java_com_example_apptfpnoguigraphicsbrid'
    +'gedemo5_Controls_pOnBluetoothServerSocketListen',
  ...
  pOnSpinnerItemSeleceted name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'5_Controls_pOnSpinnerItemSeleceted',
  pOnLocationChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnLocationChanged',
  pOnLocationStatusChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'5_Controls_pOnLocationStatusChanged',
  pOnLocationProviderEnabled name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo5_Controls_pOnLocationProviderEnabled',
  pOnLocationProviderDisabled name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo5_Controls_pOnLocationProviderDisabled',
  pAppOnViewClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pAppOnListItemClick',
  pOnActionBarTabSelected name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'5_Controls_pOnActionBarTabSelected',
  pOnActionBarTabUnSelected name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o5_Controls_pOnActionBarTabUnSelected',
  pOnCustomDialogShow name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnCustomDialogShow',
  pOnCustomDialogBackKeyPressed name 'Java_com_example_apptfpnoguigraphicsbridg'
    +'edemo5_Controls_pOnCustomDialogBackKeyPressed',
  pOnClickToggleButton name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnClickToggleButton',
  pOnChangeSwitchButton name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnChangeSwitchButton',
  pOnClickGridItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnClickGridItem',
  pOnLongClickGridItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnLongClickGridItem',
  pOnGridDrawItemCaptionColor name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo5_Controls_pOnGridDrawItemCaptionColor',
  pOnGridDrawItemBitmap name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnGridDrawItemBitmap',
  pOnChangedSensor name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnChangedSensor',
  pOnListeningSensor name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnListeningSensor',
  pOnUnregisterListeningSensor name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo5_Controls_pOnUnregisterListeningSensor',
  pOnBroadcastReceiver name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnBroadcastReceiver',
  pOnTimePicker name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls'
    +'_pOnTimePicker',
  pOnDatePicker name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_Controls'
    +'_pOnDatePicker',
  pOnFlingGestureDetected name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'5_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo5_Controls_pOnPinchZoomGestureDetected',
  pOnShellCommandExecuted name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'5_Controls_pOnShellCommandExecuted',
  pOnTCPSocketClientMessageReceived name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo5_Controls_pOnTCPSocketClientMessageReceived',
  pOnTCPSocketClientConnected name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo5_Controls_pOnTCPSocketClientConnected',
  pOnHttpClientContentResult name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo5_Controls_pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'5_Controls_pOnHttpClientCodeResult',
  pOnSurfaceViewCreated name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnSurfaceViewCreated',
  pOnSurfaceViewDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnSurfaceViewDraw',
  pOnSurfaceViewChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnSurfaceViewChanged',
  pOnMediaPlayerPrepared name 'Java_com_example_apptfpnoguigraphicsbridgedemo5'
    +'_Controls_pOnMediaPlayerPrepared',
  pOnMediaPlayerVideoSizeChanged name 'Java_com_example_apptfpnoguigraphicsbrid'
    +'gedemo5_Controls_pOnMediaPlayerVideoSizeChanged',
  pOnMediaPlayerCompletion name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'5_Controls_pOnMediaPlayerCompletion',
  pOnMediaPlayerTimedText name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'5_Controls_pOnMediaPlayerTimedText',
  pOnSurfaceViewTouch name 'Java_com_example_apptfpnoguigraphicsbridgedemo5_'
    +'Controls_pOnSurfaceViewTouch',
  pOnSurfaceViewDrawingInBackground name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo5_Controls_pOnSurfaceViewDrawingInBackground',
  pOnSurfaceViewDrawingPostExecute name 'Java_com_example_apptfpnoguigraphicsbr'
    +'idgedemo5_Controls_pOnSurfaceViewDrawingPostExecute',
  pOnContactManagerContactsExecuted name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo5_Controls_pOnContactManagerContactsExecuted',
  pOnContactManagerContactsProgress name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo5_Controls_pOnContactManagerContactsProgress',
  pOnSeekBarProgressChanged name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o5_Controls_pOnSeekBarProgressChanged',
  pOnSeekBarStartTrackingTouch name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo5_Controls_pOnSeekBarStartTrackingTouch',
  pOnSeekBarStopTrackingTouch name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo5_Controls_pOnSeekBarStopTrackingTouch';

  
begin
  gApp:= jApp.Create(nil);
  gApp.Title:= 'JNI Android Bridges Library';
  gjAppName:= 'com.example.apptfpnoguigraphicsbridgedemo5';
  gjClassName:= 'com/example/apptfpnoguigraphicsbridgedemo5/Controls';
