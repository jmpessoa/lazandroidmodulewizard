...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 12/13/2015 23:46:27]
...
{ Class:     com_example_apptfpnoguigraphicsbridgedemo3_Controls
...
begin
  ...
  begin
      curEnv:= PJNIEnv(PEnv);
      RegisterNativeMethods(curEnv, 'com/example/apptfpnoguigraphicsbridgedemo3'
        +'/Controls');
  end;
...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pAppOnScreenStyle',
  pAppOnCreate name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls_'
    +'pAppOnCreate',
  pAppOnNewIntent name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls'
    +'_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls'
    +'_pAppOnRestart',
  pAppOnResume name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo3_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'3_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o3_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'3_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo3_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'3_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo3_Controls_pAppOnClickContextMenuItem',
  pOnClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls_'
    +'pOnClick',
  pOnChange name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls_'
    +'pOnEnter',
  pOnTimer name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls_'
    +'pOnTimer',
  pOnDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls_'
    +'pOnDraw',
  pOnTouch name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls_'
    +'pOnTouch',
  pOnGLRenderer name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls'
    +'_pOnGLRenderer',
  pOnClose name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls_'
    +'pOnClose',
  pOnWebViewStatus name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnWebViewStatus',
  pOnAsyncEventDoInBackground name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo3_Controls_pOnAsyncEventDoInBackground',
  pOnAsyncEventProgressUpdate name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo3_Controls_pOnAsyncEventProgressUpdate',
  pOnAsyncEventPreExecute name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'3_Controls_pOnAsyncEventPreExecute',
  pOnAsyncEventPostExecute name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'3_Controls_pOnAsyncEventPostExecute',
  pOnClickWidgetItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_com_example_apptfpnoguigraphicsbri'
    +'dgedemo3_Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_com_example_apptfpnoguigraphicsbri'
    +'dgedemo3_Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o3_Controls_pOnListViewDrawItemBitmap',
  pOnBluetoothEnabled name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnBluetoothEnabled',
  pOnBluetoothDisabled name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnBluetoothDisabled',
  pOnBluetoothDeviceFound name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'3_Controls_pOnBluetoothDeviceFound',
  pOnBluetoothDiscoveryStarted name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo3_Controls_pOnBluetoothDiscoveryStarted',
  pOnBluetoothDiscoveryFinished name 'Java_com_example_apptfpnoguigraphicsbridg'
    +'edemo3_Controls_pOnBluetoothDiscoveryFinished',
  pOnBluetoothDeviceBondStateChanged name 'Java_com_example_apptfpnoguigraphics'
    +'bridgedemo3_Controls_pOnBluetoothDeviceBondStateChanged',
  pOnBluetoothClientSocketConnected name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo3_Controls_pOnBluetoothClientSocketConnected',
  pOnBluetoothClientSocketIncomingData name 'Java_com_example_'
    +'apptfpnoguigraphicsbridgedemo3_Controls_'
  ...
  pOnBluetoothServerSocketConnected name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo3_Controls_pOnBluetoothServerSocketConnected',
  ...
  pOnBluetoothServerSocketListen name 'Java_com_example_apptfpnoguigraphicsbrid'
    +'gedemo3_Controls_pOnBluetoothServerSocketListen',
  ...
  pOnSpinnerItemSeleceted name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'3_Controls_pOnSpinnerItemSeleceted',
  pOnLocationChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnLocationChanged',
  pOnLocationStatusChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'3_Controls_pOnLocationStatusChanged',
  pOnLocationProviderEnabled name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo3_Controls_pOnLocationProviderEnabled',
  pOnLocationProviderDisabled name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo3_Controls_pOnLocationProviderDisabled',
  pAppOnViewClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pAppOnListItemClick',
  pOnActionBarTabSelected name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'3_Controls_pOnActionBarTabSelected',
  pOnActionBarTabUnSelected name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o3_Controls_pOnActionBarTabUnSelected',
  pOnCustomDialogShow name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnCustomDialogShow',
  pOnCustomDialogBackKeyPressed name 'Java_com_example_apptfpnoguigraphicsbridg'
    +'edemo3_Controls_pOnCustomDialogBackKeyPressed',
  pOnClickToggleButton name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnClickToggleButton',
  pOnChangeSwitchButton name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnChangeSwitchButton',
  pOnClickGridItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnClickGridItem',
  pOnLongClickGridItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnLongClickGridItem',
  pOnGridDrawItemCaptionColor name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo3_Controls_pOnGridDrawItemCaptionColor',
  pOnGridDrawItemBitmap name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnGridDrawItemBitmap',
  pOnChangedSensor name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnChangedSensor',
  pOnListeningSensor name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnListeningSensor',
  pOnUnregisterListeningSensor name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo3_Controls_pOnUnregisterListeningSensor',
  pOnBroadcastReceiver name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnBroadcastReceiver',
  pOnTimePicker name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls'
    +'_pOnTimePicker',
  pOnDatePicker name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_Controls'
    +'_pOnDatePicker',
  pOnFlingGestureDetected name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'3_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo3_Controls_pOnPinchZoomGestureDetected',
  pOnShellCommandExecuted name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'3_Controls_pOnShellCommandExecuted',
  pOnTCPSocketClientMessageReceived name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo3_Controls_pOnTCPSocketClientMessageReceived',
  pOnTCPSocketClientConnected name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo3_Controls_pOnTCPSocketClientConnected',
  pOnHttpClientContentResult name 'Java_com_example_apptfpnoguigraphicsbridgede'
    +'mo3_Controls_pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'3_Controls_pOnHttpClientCodeResult',
  pOnSurfaceViewCreated name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnSurfaceViewCreated',
  pOnSurfaceViewDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnSurfaceViewDraw',
  pOnSurfaceViewChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnSurfaceViewChanged',
  pOnMediaPlayerPrepared name 'Java_com_example_apptfpnoguigraphicsbridgedemo3'
    +'_Controls_pOnMediaPlayerPrepared',
  pOnMediaPlayerVideoSizeChanged name 'Java_com_example_apptfpnoguigraphicsbrid'
    +'gedemo3_Controls_pOnMediaPlayerVideoSizeChanged',
  pOnMediaPlayerCompletion name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'3_Controls_pOnMediaPlayerCompletion',
  pOnMediaPlayerTimedText name 'Java_com_example_apptfpnoguigraphicsbridgedemo'
    +'3_Controls_pOnMediaPlayerTimedText',
  pOnSurfaceViewTouch name 'Java_com_example_apptfpnoguigraphicsbridgedemo3_'
    +'Controls_pOnSurfaceViewTouch',
  pOnSurfaceViewDrawingInBackground name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo3_Controls_pOnSurfaceViewDrawingInBackground',
  pOnSurfaceViewDrawingPostExecute name 'Java_com_example_apptfpnoguigraphicsbr'
    +'idgedemo3_Controls_pOnSurfaceViewDrawingPostExecute',
  pOnContactManagerContactsExecuted name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo3_Controls_pOnContactManagerContactsExecuted',
  pOnContactManagerContactsProgress name 'Java_com_example_apptfpnoguigraphicsb'
    +'ridgedemo3_Controls_pOnContactManagerContactsProgress',
  pOnSeekBarProgressChanged name 'Java_com_example_apptfpnoguigraphicsbridgedem'
    +'o3_Controls_pOnSeekBarProgressChanged',
  pOnSeekBarStartTrackingTouch name 'Java_com_example_apptfpnoguigraphicsbridge'
    +'demo3_Controls_pOnSeekBarStartTrackingTouch',
  pOnSeekBarStopTrackingTouch name 'Java_com_example_apptfpnoguigraphicsbridged'
    +'emo3_Controls_pOnSeekBarStopTrackingTouch';

  
begin
  gApp:= jApp.Create(nil);
  gApp.Title:= 'JNI Android Bridges Library';
  gjAppName:= 'com.example.apptfpnoguigraphicsbridgedemo3';
  gjClassName:= 'com/example/apptfpnoguigraphicsbridgedemo3/Controls';
