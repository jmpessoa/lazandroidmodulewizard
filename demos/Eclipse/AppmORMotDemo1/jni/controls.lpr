...
exports
  ...
  pAppOnScreenStyle name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnScreenStyle',
  ...
  pAppOnBackPressed name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appmormotdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appmormotdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appmormotdemo1_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnSpecialKeyDown',
  ...
  pAppOnListItemClick name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appmormotdemo1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appmormotdemo1_Controls_pOnPinchZoomGestureDetected',
...
begin
  ...
  gjAppName:= 'org.lamw.appmormotdemo1';{AndroidWidget.pas}
  gjClassName:= 'org/lamw/appmormotdemo1/Controls';{AndroidWidget.pas}
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TAndroidModule1, AndroidModule1);
end.
(*last [smart] upgrade: 7/4/2016 2:20:03*)
