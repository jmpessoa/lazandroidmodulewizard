library controls;  //[by Lamw: Lazarus Android Module Wizard: 8-10-2015 21:34:19]
  
{$mode delphi}
  
uses
  Classes, SysUtils, And_jni, And_jni_Bridge, AndroidWidget, Laz_And_Controls,
  Laz_And_Controls_Events, main, unit1;
  
{ Class:     org_lamw_appmormotdemo1_Controls
...
begin
  ...
  begin
      curEnv:= PJNIEnv(PEnv);
      RegisterNativeMethods(curEnv, 'org/lamw/appmormotdemo1/Controls');
  end;
...
exports
  ...
  pAppOnScreenStyle name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnCreate name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnCreate',
  pAppOnNewIntent name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnClick name 'Java_org_lamw_appmormotdemo1_Controls_pOnClick',
  pOnChange name 'Java_org_lamw_appmormotdemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appmormotdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appmormotdemo1_Controls_pOnEnter',
  pOnTimer name 'Java_org_lamw_appmormotdemo1_Controls_pOnTimer',
  pOnDraw name 'Java_org_lamw_appmormotdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appmormotdemo1_Controls_pOnTouch',
  pOnGLRenderer name 'Java_org_lamw_appmormotdemo1_Controls_pOnGLRenderer',
  pOnClose name 'Java_org_lamw_appmormotdemo1_Controls_pOnClose',
  pOnWebViewStatus name 
    'Java_org_lamw_appmormotdemo1_Controls_pOnWebViewStatus',
  pOnAsyncEventDoInBackground name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnAsyncEventDoInBackground',
  pOnAsyncEventProgressUpdate name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnAsyncEventProgressUpdate',
  pOnAsyncEventPreExecute name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnAsyncEventPreExecute',
  pOnAsyncEventPostExecute name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnAsyncEventPostExecute',
  pOnClickWidgetItem name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnListViewDrawItemBitmap',
  pOnBluetoothEnabled name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnBluetoothEnabled',
  pOnBluetoothDisabled name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnBluetoothDisabled',
  pOnBluetoothDeviceFound name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnBluetoothDeviceFound',
  pOnBluetoothDiscoveryStarted name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnBluetoothDiscoveryStarted',
  pOnBluetoothDiscoveryFinished name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnBluetoothDiscoveryFinished',
  pOnBluetoothDeviceBondStateChanged name 'Java_org_lamw_appmormotdemo1_'
    +'Controls_pOnBluetoothDeviceBondStateChanged',
  pOnBluetoothClientSocketConnected name 'Java_org_lamw_appmormotdemo1_'
    +'Controls_pOnBluetoothClientSocketConnected',
  pOnBluetoothClientSocketIncomingData name 'Java_org_lamw_appmormotdemo1_'
    +'Controls_pOnBluetoothClientSocketIncomingData',
  pOnBluetoothClientSocketDisconnected name 'Java_org_lamw_appmormotdemo1_'
    +'Controls_pOnBluetoothClientSocketDisconnected',
  pOnBluetoothServerSocketConnected name 'Java_org_lamw_appmormotdemo1_'
    +'Controls_pOnBluetoothServerSocketConnected',
  pOnBluetoothServerSocketIncomingData name 'Java_org_lamw_appmormotdemo1_'
    +'Controls_pOnBluetoothServerSocketIncomingData',
  pOnBluetoothServerSocketListen name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnBluetoothServerSocketListen',
  pOnBluetoothServerSocketAcceptTimeout name 'Java_org_lamw_appmormotdemo1_'
    +'Controls_pOnBluetoothServerSocketAcceptTimeout',
  pOnSpinnerItemSeleceted name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnSpinnerItemSeleceted',
  pOnLocationChanged name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnLocationChanged',
  pOnLocationStatusChanged name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnLocationStatusChanged',
  pOnLocationProviderEnabled name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnLocationProviderEnabled',
  pOnLocationProviderDisabled name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnLocationProviderDisabled',
  pAppOnViewClick name 'Java_org_lamw_appmormotdemo1_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnActionBarTabSelected name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnActionBarTabSelected',
  pOnActionBarTabUnSelected name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnActionBarTabUnSelected',
  pOnCustomDialogShow name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnCustomDialogShow',
  pOnCustomDialogBackKeyPressed name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnCustomDialogBackKeyPressed',
  pOnClickToggleButton name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnClickToggleButton',
  pOnChangeSwitchButton name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnChangeSwitchButton',
  pOnClickGridItem name 
    'Java_org_lamw_appmormotdemo1_Controls_pOnClickGridItem',
  pOnLongClickGridItem name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnLongClickGridItem',
  pOnGridDrawItemCaptionColor name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnGridDrawItemCaptionColor',
  pOnGridDrawItemBitmap name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnGridDrawItemBitmap',
  pOnChangedSensor name 
    'Java_org_lamw_appmormotdemo1_Controls_pOnChangedSensor',
  pOnListeningSensor name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnListeningSensor',
  pOnUnregisterListeningSensor name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnUnregisterListeningSensor',
  pOnBroadcastReceiver name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnBroadcastReceiver',
  pOnTimePicker name 'Java_org_lamw_appmormotdemo1_Controls_pOnTimePicker',
  pOnDatePicker name 'Java_org_lamw_appmormotdemo1_Controls_pOnDatePicker',
  pOnFlingGestureDetected name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnShellCommandExecuted name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnShellCommandExecuted',
  pOnTCPSocketClientMessageReceived name 'Java_org_lamw_appmormotdemo1_'
    +'Controls_pOnTCPSocketClientMessageReceived',
  pOnTCPSocketClientConnected name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnTCPSocketClientConnected',
  pOnHttpClientContentResult name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnHttpClientCodeResult',
  pOnSurfaceViewCreated name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnSurfaceViewCreated',
  pOnSurfaceViewDraw name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnSurfaceViewDraw',
  pOnSurfaceViewChanged name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnSurfaceViewChanged',
  pOnMediaPlayerPrepared name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnMediaPlayerPrepared',
  pOnMediaPlayerVideoSizeChanged name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnMediaPlayerVideoSizeChanged',
  pOnMediaPlayerCompletion name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnMediaPlayerCompletion',
  pOnMediaPlayerTimedText name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnMediaPlayerTimedText',
  pOnSurfaceViewTouch name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnSurfaceViewTouch',
  pOnSurfaceViewDrawingInBackground name 'Java_org_lamw_appmormotdemo1_'
    +'Controls_pOnSurfaceViewDrawingInBackground',
  pOnSurfaceViewDrawingPostExecute name 'Java_org_lamw_appmormotdemo1_Controls'
    +'_pOnSurfaceViewDrawingPostExecute',
  pOnContactManagerContactsExecuted name 'Java_org_lamw_appmormotdemo1_'
    +'Controls_pOnContactManagerContactsExecuted',
  pOnContactManagerContactsProgress name 'Java_org_lamw_appmormotdemo1_'
    +'Controls_pOnContactManagerContactsProgress',
  pOnSeekBarProgressChanged name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnSeekBarProgressChanged',
  pOnSeekBarStartTrackingTouch name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnSeekBarStartTrackingTouch',
  pOnSeekBarStopTrackingTouch name 'Java_org_lamw_appmormotdemo1_Controls_'
...
begin
  ...
  gjAppName:= 'org.lamw.appmormotdemo1';
  gjClassName:= 'org/lamw/appmormotdemo1/Controls';
