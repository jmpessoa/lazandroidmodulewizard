...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 5/21/2016 16:53:03]
...
{ Class:     com_example_appalarmmanagerdemo1_Controls
...
{ Class:     com_example_appalarmmanagerdemo1_Controls
  ...
  Signature: (JILjava/lang/String;)V }
procedure pOnClickAutoDropDownItem(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  itemIndex: JInt; itemCaption: JString); cdecl;
begin
  Java_Event_pOnClickAutoDropDownItem(PEnv, this, TObject(pasobj), itemIndex, 
    itemCaption);
end;
...
begin
  ...
  begin
      curEnv:= PJNIEnv(PEnv);
      RegisterNativeMethods(curEnv, 'com/example/appalarmmanagerdemo1/Controls');
  end;
...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnCreate name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnNewIntent name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appalarmmanagerdemo1_Controls'
    +'_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appalarmmanagerdemo1_Controls'
    +'_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnClick name 'Java_com_example_appalarmmanagerdemo1_Controls_pOnClick',
  pOnChange name 'Java_com_example_appalarmmanagerdemo1_Controls_pOnChange',
  pOnChanged name 'Java_com_example_appalarmmanagerdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_appalarmmanagerdemo1_Controls_pOnEnter',
  pOnTimer name 'Java_com_example_appalarmmanagerdemo1_Controls_pOnTimer',
  pOnDraw name 'Java_com_example_appalarmmanagerdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_appalarmmanagerdemo1_Controls_pOnTouch',
  pOnGLRenderer name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnGLRenderer',
  pOnClose name 'Java_com_example_appalarmmanagerdemo1_Controls_pOnClose',
  pOnWebViewStatus name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnWebViewStatus',
  pOnAsyncEventDoInBackground name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnAsyncEventDoInBackground',
  pOnAsyncEventProgressUpdate name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnAsyncEventProgressUpdate',
  pOnAsyncEventPreExecute name 'Java_com_example_appalarmmanagerdemo1_Controls'
    +'_pOnAsyncEventPreExecute',
  pOnAsyncEventPostExecute name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnAsyncEventPostExecute',
  pOnClickWidgetItem name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnListViewDrawItemBitmap',
  pOnBluetoothEnabled name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnBluetoothEnabled',
  pOnBluetoothDisabled name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnBluetoothDisabled',
  pOnBluetoothDeviceFound name 'Java_com_example_appalarmmanagerdemo1_Controls'
    +'_pOnBluetoothDeviceFound',
  pOnBluetoothDiscoveryStarted name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnBluetoothDiscoveryStarted',
  pOnBluetoothDiscoveryFinished name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnBluetoothDiscoveryFinished',
  pOnBluetoothDeviceBondStateChanged name 'Java_com_example_appalarmmanagerdemo'
    +'1_Controls_pOnBluetoothDeviceBondStateChanged',
  pOnBluetoothClientSocketConnected name 'Java_com_example_appalarmmanagerdemo'
    +'1_Controls_pOnBluetoothClientSocketConnected',
  pOnBluetoothClientSocketIncomingData name 'Java_com_example_'
    +'appalarmmanagerdemo1_Controls_pOnBluetoothClientSocketIncomingData',
  pOnBluetoothClientSocketDisconnected name 'Java_com_example_'
    +'appalarmmanagerdemo1_Controls_pOnBluetoothClientSocketDisconnected',
  pOnBluetoothServerSocketConnected name 'Java_com_example_appalarmmanagerdemo'
    +'1_Controls_pOnBluetoothServerSocketConnected',
  pOnBluetoothServerSocketIncomingData name 'Java_com_example_'
    +'appalarmmanagerdemo1_Controls_pOnBluetoothServerSocketIncomingData',
  pOnBluetoothServerSocketListen name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnBluetoothServerSocketListen',
  pOnBluetoothServerSocketAcceptTimeout name 'Java_com_example_'
    +'appalarmmanagerdemo1_Controls_pOnBluetoothServerSocketAcceptTimeout',
  pOnSpinnerItemSeleceted name 'Java_com_example_appalarmmanagerdemo1_Controls'
    +'_pOnSpinnerItemSeleceted',
  pOnLocationChanged name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnLocationChanged',
  pOnLocationStatusChanged name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnLocationStatusChanged',
  pOnLocationProviderEnabled name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnLocationProviderEnabled',
  pOnLocationProviderDisabled name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnLocationProviderDisabled',
  pAppOnViewClick name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnActionBarTabSelected name 'Java_com_example_appalarmmanagerdemo1_Controls'
    +'_pOnActionBarTabSelected',
  pOnActionBarTabUnSelected name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnActionBarTabUnSelected',
  pOnCustomDialogShow name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnCustomDialogShow',
  pOnCustomDialogBackKeyPressed name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnCustomDialogBackKeyPressed',
  pOnClickToggleButton name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnClickToggleButton',
  pOnChangeSwitchButton name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnChangeSwitchButton',
  pOnClickGridItem name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnClickGridItem',
  pOnLongClickGridItem name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnLongClickGridItem',
  pOnGridDrawItemCaptionColor name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnGridDrawItemCaptionColor',
  pOnGridDrawItemBitmap name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnGridDrawItemBitmap',
  pOnChangedSensor name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnChangedSensor',
  pOnListeningSensor name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnListeningSensor',
  pOnUnregisterListeningSensor name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnUnregisterListeningSensor',
  pOnBroadcastReceiver name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnBroadcastReceiver',
  pOnTimePicker name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnTimePicker',
  pOnDatePicker name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnDatePicker',
  pOnFlingGestureDetected name 'Java_com_example_appalarmmanagerdemo1_Controls'
    +'_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnShellCommandExecuted name 'Java_com_example_appalarmmanagerdemo1_Controls'
    +'_pOnShellCommandExecuted',
  pOnTCPSocketClientMessageReceived name 'Java_com_example_appalarmmanagerdemo'
    +'1_Controls_pOnTCPSocketClientMessageReceived',
  pOnTCPSocketClientConnected name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnTCPSocketClientConnected',
  pOnHttpClientContentResult name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_com_example_appalarmmanagerdemo1_Controls'
    +'_pOnHttpClientCodeResult',
  pOnSurfaceViewCreated name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnSurfaceViewCreated',
  pOnSurfaceViewDraw name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnSurfaceViewDraw',
  pOnSurfaceViewChanged name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnSurfaceViewChanged',
  pOnMediaPlayerPrepared name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnMediaPlayerPrepared',
  pOnMediaPlayerVideoSizeChanged name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnMediaPlayerVideoSizeChanged',
  pOnMediaPlayerCompletion name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnMediaPlayerCompletion',
  pOnMediaPlayerTimedText name 'Java_com_example_appalarmmanagerdemo1_Controls'
    +'_pOnMediaPlayerTimedText',
  pOnSurfaceViewTouch name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnSurfaceViewTouch',
  pOnSurfaceViewDrawingInBackground name 'Java_com_example_appalarmmanagerdemo'
    +'1_Controls_pOnSurfaceViewDrawingInBackground',
  pOnSurfaceViewDrawingPostExecute name 'Java_com_example_appalarmmanagerdemo1'
    +'_Controls_pOnSurfaceViewDrawingPostExecute',
  pOnContactManagerContactsExecuted name 'Java_com_example_appalarmmanagerdemo'
    +'1_Controls_pOnContactManagerContactsExecuted',
  pOnContactManagerContactsProgress name 'Java_com_example_appalarmmanagerdemo'
    +'1_Controls_pOnContactManagerContactsProgress',
  pOnSeekBarProgressChanged name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnSeekBarProgressChanged',
  pOnSeekBarStartTrackingTouch name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnSeekBarStartTrackingTouch',
  pOnSeekBarStopTrackingTouch name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnSeekBarStopTrackingTouch',
  pOnRatingBarChanged name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnRatingBarChanged',
  pRadioGroupCheckedChanged name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pRadioGroupCheckedChanged',
  pOnClickAutoDropDownItem name 'Java_com_example_appalarmmanagerdemo1_'
    +'Controls_pOnClickAutoDropDownItem',
  pOnClickGeneric name 'Java_com_example_appalarmmanagerdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appalarmmanagerdemo1_Controls_'
...
begin
  ...
  gjAppName:= 'com.example.appalarmmanagerdemo1';
  gjClassName:= 'com/example/appalarmmanagerdemo1/Controls';
