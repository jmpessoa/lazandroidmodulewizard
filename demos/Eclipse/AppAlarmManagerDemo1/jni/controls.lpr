...
exports
  ...
  pAppOnCreate name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnResume',
  ...
  pAppOnBackPressed name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnClickContextMenuItem',
  ...
  pOnClickGeneric name 'Java_com_example_appalarmmanagerdemo1_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnSpecialKeyDown',
  ...
  pAppOnViewClick name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appalarmmanagerdemo1_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appalarmmanagerdemo1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appalarmmanagerdemo1_Controls_pOnPinchZoomGestureDetected',
  pOnBroadcastReceiver name 'Java_com_example_appalarmmanagerdemo1_Controls_pOnBroadcastReceiver',
  pOnDatePicker name 'Java_com_example_appalarmmanagerdemo1_Controls_pOnDatePicker',
  pOnTimePicker name 'Java_com_example_appalarmmanagerdemo1_Controls_pOnTimePicker';

begin
  gApp:= jApp.Create(nil);{AndroidWidget.pas}
  gApp.Title:= 'My Android Bridges Library';
  gjAppName:= 'com.example.appalarmmanagerdemo1';{AndroidWidget.pas}
  gjClassName:= 'com/example/appalarmmanagerdemo1/Controls';{AndroidWidget.pas}
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TAndroidModule1, AndroidModule1);
end.
(*last [smart] upgrade: 7/8/2016 23:08:43*)
