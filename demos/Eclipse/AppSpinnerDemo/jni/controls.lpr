...
exports
  ...
  pOnActive name 'Java_com_example_appspinnerdemo_Controls_pOnActive',
...
begin
  ...
  gjAppName:= 'com.example.appspinnerdemo';{And_jni_Bridge}
  gjClassName:= 'com/example/appspinnerdemo/Controls';{And_jni_Bridge}
