...
library controls;  //[by LazAndroidWizard: 2/22/2015 4:02:07]
...
{ Class:     com_example_appaddsinglelibrarydemo1_Controls
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appaddsinglelibrarydemo1/Controls');
  end;
...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnScreenStyle',
  pAppOnCreate name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnCreate',
  pAppOnNewIntent name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnClickOptionMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnClickContextMenuItem',
  pOnClick name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnClick',
  pOnChange name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnChange',
  pOnChanged name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnEnter',
  pOnTimer name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnTimer',
  pOnDraw name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnTouch',
  pOnGLRenderer name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnGLRenderer',
  pOnClose name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnClose',
  pOnWebViewStatus name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnWebViewStatus',
  pOnAsyncEvent name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnAsyncEvent',
  pOnClickWidgetItem name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnClickCaptionItem',
  pOnBluetoothEnabled name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnBluetoothEnabled',
  pOnBluetoothDisabled name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnBluetoothDisabled',
  pOnBluetoothDeviceFound name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnBluetoothDeviceFound',
  pOnBluetoothDiscoveryStarted name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnBluetoothDiscoveryStarted',
  pOnBluetoothDiscoveryFinished name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnBluetoothDiscoveryFinished',
  pOnBluetoothDeviceBondStateChanged name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnBluetoothDeviceBondStateChanged',
  pOnBluetoothClientSocketConnected name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnBluetoothClientSocketConnected',
  pOnBluetoothClientSocketIncomingMessage name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnBluetoothClientSocketIncomingMessage',
  pOnBluetoothClientSocketWritingMessage name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnBluetoothClientSocketWritingMessage',
  pOnBluetoothServerSocketConnected name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnBluetoothServerSocketConnected',
  pOnBluetoothServerSocketIncomingMessage name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnBluetoothServerSocketIncomingMessage',
  pOnBluetoothServerSocketWritingMessage name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnBluetoothServerSocketWritingMessage',
  pOnBluetoothServerSocketListen name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnBluetoothServerSocketListen',
  pOnSpinnerItemSeleceted name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnSpinnerItemSeleceted',
  pOnLocationChanged name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnLocationChanged',
  pOnLocationStatusChanged name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnLocationStatusChanged',
  pOnLocationProviderEnabled name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnLocationProviderEnabled',
  pOnLocationProviderDisabled name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnLocationProviderDisabled',
  pAppOnViewClick name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pAppOnListItemClick',
  pOnActionBarTabSelected name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnActionBarTabSelected',
  pOnActionBarTabUnSelected name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnActionBarTabUnSelected',
  pOnCustomDialogShow name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnCustomDialogShow',
  pOnClickToggleButton name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnClickToggleButton',
  pOnChangeSwitchButton name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnChangeSwitchButton',
  pOnClickGridItem name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnClickGridItem',
  pOnChangedSensor name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnChangedSensor',
  pOnListeningSensor name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnListeningSensor',
  pOnStopedListeningSensors name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnStopedListeningSensors',
  pOnUnregisterListeningSensor name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnUnregisterListeningSensor',
  pOnBroadcastReceiver name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnBroadcastReceiver',
  pOnTimePicker name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnTimePicker',
  pOnDatePicker name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnDatePicker',
  pOnFlingGestureDetected name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appaddsinglelibrarydemo1_Controls_pOnPinchZoomGestureDetected';
 
begin
  gApp:= jApp.Create(nil);
  gApp.Title:= 'JNI Android Bridges Library';
  gjAppName:= 'com.example.appaddsinglelibrarydemo1';
  gjClassName:= 'com/example/appaddsinglelibrarydemo1/Controls';
