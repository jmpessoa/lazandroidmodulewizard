...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 6/29/2016 0:23:43]
...
{ Class:     com_example_appmediarecorderdemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appmediarecorderdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_appmediarecorderdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_appmediarecorderdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_example_appmediarecorderdemo1_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_appmediarecorderdemo1_Controls_pOnClick',
  pOnChange name 'Java_com_example_appmediarecorderdemo1_Controls_pOnChange',
  pOnChanged name 'Java_com_example_appmediarecorderdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_appmediarecorderdemo1_Controls_pOnEnter',
  pOnClose name 'Java_com_example_appmediarecorderdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appmediarecorderdemo1_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appmediarecorderdemo1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appmediarecorderdemo1_Controls_pOnPinchZoomGestureDetected',
  pOnMediaPlayerPrepared name 'Java_com_example_appmediarecorderdemo1_Controls_pOnMediaPlayerPrepared',
  pOnMediaPlayerVideoSizeChanged name 'Java_com_example_appmediarecorderdemo1_Controls_pOnMediaPlayerVideoSizeChanged',
  pOnMediaPlayerCompletion name 'Java_com_example_appmediarecorderdemo1_Controls_pOnMediaPlayerCompletion',
  pOnMediaPlayerTimedText name 'Java_com_example_appmediarecorderdemo1_Controls_pOnMediaPlayerTimedText';

begin
  gApp:= jApp.Create(nil);{AndroidWidget.pas}
  gApp.Title:= 'My Android Bridges Library';
  gjAppName:= 'com.example.appmediarecorderdemo1';{AndroidWidget.pas}
  gjClassName:= 'com/example/appmediarecorderdemo1/Controls';{AndroidWidget.pas}
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TAndroidModule1, AndroidModule1);
end.
(*last [smart] upgrade: 7/4/2016 0:51:08*)
