...
begin
  Java_Event_pOnClickToggleButton(PEnv,this,TObject(pasobj),state);
end;
...
exports
  ...
  pOnClickGeneric name 'Java_com_example_apptogglebuttondemo1_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_apptogglebuttondemo1_Controls_pAppOnSpecialKeyDown',
...
(*last [smart] upgrade: 7/4/2016 1:38:14*)
