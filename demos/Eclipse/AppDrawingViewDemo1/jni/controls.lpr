...
exports
  ...
  pAppOnNewIntent name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pAppOnDestroy',
  ...
  pAppOnActivityResult name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appdrawingviewdemo1_Controls'
    +'_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appdrawingviewdemo1_'
  ...
  pOnGLRenderer name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnGLRenderer',
  pOnClose name 'Java_com_example_appdrawingviewdemo1_Controls_pOnClose',
  pOnWebViewStatus name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnWebViewStatus',
  pOnAsyncEventDoInBackground name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnAsyncEventDoInBackground',
  pOnAsyncEventProgressUpdate name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnAsyncEventProgressUpdate',
  pOnAsyncEventPreExecute name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnAsyncEventPreExecute',
  pOnAsyncEventPostExecute name 'Java_com_example_appdrawingviewdemo1_Controls'
    +'_pOnAsyncEventPostExecute',
  pOnClickWidgetItem name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnListViewDrawItemBitmap',
  pOnBluetoothEnabled name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnBluetoothEnabled',
  pOnBluetoothDisabled name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnBluetoothDisabled',
  pOnBluetoothDeviceFound name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnBluetoothDeviceFound',
  pOnBluetoothDiscoveryStarted name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnBluetoothDiscoveryStarted',
  pOnBluetoothDiscoveryFinished name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnBluetoothDiscoveryFinished',
  pOnBluetoothDeviceBondStateChanged name 'Java_com_example_appdrawingviewdemo'
    +'1_Controls_pOnBluetoothDeviceBondStateChanged',
  pOnBluetoothClientSocketConnected name 'Java_com_example_appdrawingviewdemo1'
    +'_Controls_pOnBluetoothClientSocketConnected',
  pOnBluetoothClientSocketIncomingData name 'Java_com_example_'
    +'appdrawingviewdemo1_Controls_pOnBluetoothClientSocketIncomingData',
  pOnBluetoothClientSocketDisconnected name 'Java_com_example_'
    +'appdrawingviewdemo1_Controls_pOnBluetoothClientSocketDisconnected',
  pOnBluetoothServerSocketConnected name 'Java_com_example_appdrawingviewdemo1'
    +'_Controls_pOnBluetoothServerSocketConnected',
  pOnBluetoothServerSocketIncomingData name 'Java_com_example_'
    +'appdrawingviewdemo1_Controls_pOnBluetoothServerSocketIncomingData',
  pOnBluetoothServerSocketListen name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnBluetoothServerSocketListen',
  pOnBluetoothServerSocketAcceptTimeout name 'Java_com_example_'
    +'appdrawingviewdemo1_Controls_pOnBluetoothServerSocketAcceptTimeout',
  pOnSpinnerItemSeleceted name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnSpinnerItemSeleceted',
  pOnLocationChanged name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnLocationChanged',
  pOnLocationStatusChanged name 'Java_com_example_appdrawingviewdemo1_Controls'
    +'_pOnLocationStatusChanged',
  pOnLocationProviderEnabled name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnLocationProviderEnabled',
  pOnLocationProviderDisabled name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnLocationProviderDisabled',
  pAppOnViewClick name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnActionBarTabSelected name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnActionBarTabSelected',
  pOnActionBarTabUnSelected name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnActionBarTabUnSelected',
  pOnCustomDialogShow name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnCustomDialogShow',
  pOnCustomDialogBackKeyPressed name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnCustomDialogBackKeyPressed',
  pOnClickToggleButton name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnClickToggleButton',
  pOnChangeSwitchButton name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnChangeSwitchButton',
  pOnClickGridItem name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnClickGridItem',
  pOnLongClickGridItem name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnLongClickGridItem',
  pOnGridDrawItemCaptionColor name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnGridDrawItemCaptionColor',
  pOnGridDrawItemBitmap name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnGridDrawItemBitmap',
  pOnChangedSensor name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnChangedSensor',
  pOnListeningSensor name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnListeningSensor',
  pOnUnregisterListeningSensor name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnUnregisterListeningSensor',
  pOnBroadcastReceiver name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnBroadcastReceiver',
  pOnTimePicker name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnTimePicker',
  pOnDatePicker name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnDatePicker',
  pOnFlingGestureDetected name 'Java_com_example_appdrawingviewdemo1_Controls_'
  ...
  pOnShellCommandExecuted name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnShellCommandExecuted',
  pOnTCPSocketClientMessageReceived name 'Java_com_example_appdrawingviewdemo1'
    +'_Controls_pOnTCPSocketClientMessageReceived',
  pOnTCPSocketClientConnected name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnTCPSocketClientConnected',
  pOnHttpClientContentResult name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnHttpClientCodeResult',
  pOnSurfaceViewCreated name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnSurfaceViewCreated',
  pOnSurfaceViewDraw name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnSurfaceViewDraw',
  pOnSurfaceViewChanged name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnSurfaceViewChanged',
  pOnMediaPlayerPrepared name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnMediaPlayerPrepared',
  pOnMediaPlayerVideoSizeChanged name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnMediaPlayerVideoSizeChanged',
  pOnMediaPlayerCompletion name 'Java_com_example_appdrawingviewdemo1_Controls'
    +'_pOnMediaPlayerCompletion',
  pOnMediaPlayerTimedText name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnMediaPlayerTimedText',
  pOnSurfaceViewTouch name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnSurfaceViewTouch',
  pOnSurfaceViewDrawingInBackground name 'Java_com_example_appdrawingviewdemo1'
    +'_Controls_pOnSurfaceViewDrawingInBackground',
  pOnSurfaceViewDrawingPostExecute name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnSurfaceViewDrawingPostExecute',
  pOnContactManagerContactsExecuted name 'Java_com_example_appdrawingviewdemo1'
    +'_Controls_pOnContactManagerContactsExecuted',
  pOnContactManagerContactsProgress name 'Java_com_example_appdrawingviewdemo1'
    +'_Controls_pOnContactManagerContactsProgress',
  pOnSeekBarProgressChanged name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnSeekBarProgressChanged',
  pOnSeekBarStartTrackingTouch name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnSeekBarStartTrackingTouch',
  pOnSeekBarStopTrackingTouch name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pOnSeekBarStopTrackingTouch',
  pOnRatingBarChanged name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnRatingBarChanged',
  pRadioGroupCheckedChanged name 'Java_com_example_appdrawingviewdemo1_'
    +'Controls_pRadioGroupCheckedChanged',
  pOnClickAutoDropDownItem name 'Java_com_example_appdrawingviewdemo1_Controls'
    +'_pOnClickAutoDropDownItem',
  pOnClickGeneric name 'Java_com_example_appdrawingviewdemo1_Controls_'
    +'pOnClickGeneric',
...
begin
  ...
  gjAppName:= 'com.example.appdrawingviewdemo1';
  gjClassName:= 'com/example/appdrawingviewdemo1/Controls';
