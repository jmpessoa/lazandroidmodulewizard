...
library controls;  //[by LazAndroidWizard: 2/16/2015 19:59:56]
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/apphttpclientdemo1/Controls');
  end;
...
exports
  ...
  pAppOnRestart name 'Java_com_example_apphttpclientdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_apphttpclientdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_apphttpclientdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_apphttpclientdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_apphttpclientdemo1_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_apphttpclientdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_apphttpclientdemo1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apphttpclientdemo1_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apphttpclientdemo1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apphttpclientdemo1_Controls_pAppOnClickOptionMenuItem',
  ...
  pOnAsyncEvent name 'Java_com_example_apphttpclientdemo1_Controls_pOnAsyncEvent',
  ...
  pOnBluetoothClientSocketIncomingMessage name 'Java_com_example_apphttpclientdemo1_Controls_pOnBluetoothClientSocketIncomingMessage',
  pOnBluetoothClientSocketWritingMessage name 'Java_com_example_apphttpclientdemo1_Controls_pOnBluetoothClientSocketWritingMessage',
  pOnBluetoothServerSocketConnected name 'Java_com_example_apphttpclientdemo1_Controls_pOnBluetoothServerSocketConnected',
  pOnBluetoothServerSocketIncomingMessage name 'Java_com_example_apphttpclientdemo1_Controls_pOnBluetoothServerSocketIncomingMessage',
  pOnBluetoothServerSocketWritingMessage name 'Java_com_example_apphttpclientdemo1_Controls_pOnBluetoothServerSocketWritingMessage',
  ...
  pOnStopedListeningSensors name 'Java_com_example_apphttpclientdemo1_Controls_pOnStopedListeningSensors',
...
begin
  ...
  gjAppName:= 'com.example.apphttpclientdemo1';{AndroidWidget.pas}
  gjClassName:= 'com/example/apphttpclientdemo1/Controls';{AndroidWidget.pas}
