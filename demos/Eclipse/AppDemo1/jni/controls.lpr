...
exports
  ...
  pAppOnPrepareOptionsMenu name 'Java_com_example_appdemo1_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appdemo1_Controls_pAppOnPrepareOptionsMenuItem',
  ...
  pOnAsyncEventDoInBackground name 'Java_com_example_appdemo1_Controls_pOnAsyncEventDoInBackground',
  pOnAsyncEventProgressUpdate name 'Java_com_example_appdemo1_Controls_pOnAsyncEventProgressUpdate',
  pOnAsyncEventPreExecute name 'Java_com_example_appdemo1_Controls_pOnAsyncEventPreExecute',
  pOnAsyncEventPostExecute name 'Java_com_example_appdemo1_Controls_pOnAsyncEventPostExecute',
  ...
  pOnListViewLongClickCaptionItem name 'Java_com_example_appdemo1_Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_com_example_appdemo1_Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_com_example_appdemo1_Controls_pOnListViewDrawItemBitmap',
  ...
  pOnBluetoothClientSocketIncomingData name 'Java_com_example_appdemo1_Controls_pOnBluetoothClientSocketIncomingData',
  pOnBluetoothClientSocketDisconnected name 'Java_com_example_appdemo1_Controls_pOnBluetoothClientSocketDisconnected',
  pOnBluetoothServerSocketConnected name 'Java_com_example_appdemo1_Controls_pOnBluetoothServerSocketConnected',
  pOnBluetoothServerSocketIncomingData name 'Java_com_example_appdemo1_Controls_pOnBluetoothServerSocketIncomingData',
  pOnBluetoothServerSocketListen name 'Java_com_example_appdemo1_Controls_pOnBluetoothServerSocketListen',
  pOnBluetoothServerSocketAcceptTimeout name 'Java_com_example_appdemo1_Controls_pOnBluetoothServerSocketAcceptTimeout',
  ...
  pOnCustomDialogBackKeyPressed name 'Java_com_example_appdemo1_Controls_pOnCustomDialogBackKeyPressed',
  ...
  pOnLongClickGridItem name 'Java_com_example_appdemo1_Controls_pOnLongClickGridItem',
  pOnGridDrawItemCaptionColor name 'Java_com_example_appdemo1_Controls_pOnGridDrawItemCaptionColor',
  pOnGridDrawItemBitmap name 'Java_com_example_appdemo1_Controls_pOnGridDrawItemBitmap',
  pOnChangedSensor name 'Java_com_example_appdemo1_Controls_pOnChangedSensor',
  pOnListeningSensor name 'Java_com_example_appdemo1_Controls_pOnListeningSensor',
  pOnUnregisterListeningSensor name 'Java_com_example_appdemo1_Controls_pOnUnregisterListeningSensor',
  pOnBroadcastReceiver name 'Java_com_example_appdemo1_Controls_pOnBroadcastReceiver',
  pOnTimePicker name 'Java_com_example_appdemo1_Controls_pOnTimePicker',
  pOnDatePicker name 'Java_com_example_appdemo1_Controls_pOnDatePicker',
  pOnFlingGestureDetected name 'Java_com_example_appdemo1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appdemo1_Controls_pOnPinchZoomGestureDetected',
  pOnShellCommandExecuted name 'Java_com_example_appdemo1_Controls_pOnShellCommandExecuted',
  pOnTCPSocketClientMessageReceived name 'Java_com_example_appdemo1_Controls_pOnTCPSocketClientMessageReceived',
  pOnTCPSocketClientConnected name 'Java_com_example_appdemo1_Controls_pOnTCPSocketClientConnected',
  pOnHttpClientContentResult name 'Java_com_example_appdemo1_Controls_pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_com_example_appdemo1_Controls_pOnHttpClientCodeResult',
  pOnSurfaceViewCreated name 'Java_com_example_appdemo1_Controls_pOnSurfaceViewCreated',
  pOnSurfaceViewDraw name 'Java_com_example_appdemo1_Controls_pOnSurfaceViewDraw',
  pOnSurfaceViewChanged name 'Java_com_example_appdemo1_Controls_pOnSurfaceViewChanged',
  pOnMediaPlayerPrepared name 'Java_com_example_appdemo1_Controls_pOnMediaPlayerPrepared',
  pOnMediaPlayerVideoSizeChanged name 'Java_com_example_appdemo1_Controls_pOnMediaPlayerVideoSizeChanged',
  pOnMediaPlayerCompletion name 'Java_com_example_appdemo1_Controls_pOnMediaPlayerCompletion',
  pOnMediaPlayerTimedText name 'Java_com_example_appdemo1_Controls_pOnMediaPlayerTimedText',
  pOnSurfaceViewTouch name 'Java_com_example_appdemo1_Controls_pOnSurfaceViewTouch',
  pOnSurfaceViewDrawingInBackground name 'Java_com_example_appdemo1_Controls_pOnSurfaceViewDrawingInBackground',
  pOnSurfaceViewDrawingPostExecute name 'Java_com_example_appdemo1_Controls_pOnSurfaceViewDrawingPostExecute',
  pOnContactManagerContactsExecuted name 'Java_com_example_appdemo1_Controls_pOnContactManagerContactsExecuted',
  pOnContactManagerContactsProgress name 'Java_com_example_appdemo1_Controls_pOnContactManagerContactsProgress',
  pOnSeekBarProgressChanged name 'Java_com_example_appdemo1_Controls_pOnSeekBarProgressChanged',
  pOnSeekBarStartTrackingTouch name 'Java_com_example_appdemo1_Controls_pOnSeekBarStartTrackingTouch',
  pOnSeekBarStopTrackingTouch name 'Java_com_example_appdemo1_Controls_pOnSeekBarStopTrackingTouch',
  pOnRatingBarChanged name 'Java_com_example_appdemo1_Controls_pOnRatingBarChanged',
  pRadioGroupCheckedChanged name 'Java_com_example_appdemo1_Controls_pRadioGroupCheckedChanged',
  pOnClickAutoDropDownItem name 'Java_com_example_appdemo1_Controls_pOnClickAutoDropDownItem',
  pOnClickGeneric name 'Java_com_example_appdemo1_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appdemo1_Controls_pAppOnSpecialKeyDown';
...
(*last [template] upgrade: 5/21/2016 3:08:40*)
