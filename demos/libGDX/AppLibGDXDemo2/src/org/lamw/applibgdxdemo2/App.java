...
//Lamw: Lazarus Android Module Wizard - version 0.8.5.1 - 02 September - 2019
...
public class App extends AndroidApplication {
    ...
    public void onCreate(Bundle savedInstanceState) {
     ...
     if (systemVersion > 9) {
      ...
      Log.i("GDXApp","01.Activity.onCreate");
      controls = new Controls();

      controls.isGDXGame = true;
      ...
      switch( controls.screenStyle ) {
        ...
        //config.useImmersiveMode = true; // add this line to hide the status bar and navigation buttons:
        //config.useAccelerometer = false;
        //config.useCompass = false;
        gdxGame = new MyGdxGame(controls);
        controls.GDXGame = gdxGame;
        //initialize(new MyGdxGame(), config);
        View gameView = initializeForView(gdxGame, config);
        //controls.appLayout.addView(gameView, ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT);
        //controls.appLayout.addView(gameView);
        //controls.appLayout.getRootView().setBackgroundColor (0x00FFFFFF);
      this.setContentView(gameView); //controls.appLayout
   ...
   //[ifdef_api23up]
    ...
    protected void onPause() {super.onPause();
       //controls.jAppOnPause();
        Log.i("GDXApp","onPause");
    }
    
    @Override
    protected void onRestart() {
        super.onRestart();
        Log.i("GDXApp","onRestart");
    ...
    protected void onResume() { super.onResume();
       //controls.jAppOnResume();
        Log.i("GDXApp","onResume");
    }
    	                                        
    @Override
    protected void onStart() { super.onStart();
      //controls.jAppOnStart();
        Log.i("GDXApp","onStart");
    }
