...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 10/22/2019 0:34:05]
...
{ Class:     org_lamw_applibgdxdemo2_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_applibgdxdemo2_Controls
  Method:    pOnGDXFormShow
  Signature: (J)V }
procedure pOnGDXFormShow(PEnv: PJNIEnv; this: JObject; pasobj: JLong); cdecl;
begin
  Java_Event_pOnGDXFormShow(PEnv, this, TObject(pasobj));
end;

{ Class:     org_lamw_applibgdxdemo2_Controls
  Method:    pOnGDXFormResize
  Signature: (JII)V }
procedure pOnGDXFormResize(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  width: JInt; height: JInt); cdecl;
begin
  Java_Event_pOnGDXFormResize(PEnv, this, TObject(pasobj), width, height);
end;

{ Class:     org_lamw_applibgdxdemo2_Controls
  Method:    pOnGDXFormRender
  Signature: (JF)V }
procedure pOnGDXFormRender(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  deltaTime: JFloat); cdecl;
begin
  Java_Event_pOnGDXFormRender(PEnv, this, TObject(pasobj), deltaTime);
end;

{ Class:     org_lamw_applibgdxdemo2_Controls
  Method:    pOnGDXFormClose
  Signature: (J)V }
procedure pOnGDXFormClose(PEnv: PJNIEnv; this: JObject; pasobj: JLong); cdecl;
begin
  Java_Event_pOnGDXFormClose(PEnv, this, TObject(pasobj));
end;

{ Class:     org_lamw_applibgdxdemo2_Controls
  Method:    pOnGDXFormResume
  Signature: (J)V }
procedure pOnGDXFormResume(PEnv: PJNIEnv; this: JObject; pasobj: JLong); cdecl;
begin
  Java_Event_pOnGDXFormResume(PEnv, this, TObject(pasobj));
end;

{ Class:     org_lamw_applibgdxdemo2_Controls
  Method:    pOnGDXFormPause
  Signature: (J)V }
procedure pOnGDXFormPause(PEnv: PJNIEnv; this: JObject; pasobj: JLong); cdecl;
begin
  Java_Event_pOnGDXFormPause(PEnv, this, TObject(pasobj));
end;

{ Class:     org_lamw_applibgdxdemo2_Controls
  Method:    pOnGDXFormHide
  Signature: (J)V }
procedure pOnGDXFormHide(PEnv: PJNIEnv; this: JObject; pasobj: JLong); cdecl;
begin
  Java_Event_pOnGDXFormHide(PEnv, this, TObject(pasobj));
end;

{ Class:     org_lamw_applibgdxdemo2_Controls
  Method:    pOnGDXFormKeyPressed
  Signature: (JI)I }
function pOnGDXFormKeyPressed(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  keyCode: JInt): JInt; cdecl;
begin
  Result:=Java_Event_pOnGDXFormKeyPressed(PEnv, this, TObject(pasobj), keyCode);
end;

{ Class:     org_lamw_applibgdxdemo2_Controls
  Method:    pOnGDXFormTouchDown
  Signature: (JIIII)V }
procedure pOnGDXFormTouchDown(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  screenX: JInt; screenY: JInt; pointer: JInt; button: JInt); cdecl;
begin
  Java_Event_pOnGDXFormTouchDown(PEnv, this, TObject(pasobj), screenX, screenY, 
    pointer, button);
end;

{ Class:     org_lamw_applibgdxdemo2_Controls
  Method:    pOnGDXFormTouchUp
  Signature: (JIIII)V }
procedure pOnGDXFormTouchUp(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  screenX: JInt; screenY: JInt; pointer: JInt; button: JInt); cdecl;
begin
  Java_Event_pOnGDXFormTouchUp(PEnv, this, TObject(pasobj), screenX, screenY, 
    pointer, button);
end;
...
const NativeMethods: array[0..50] of JNINativeMethod = (
   ...
   (name: 'pOnGDXFormShow';
    signature: '(J)V';
    fnPtr: @pOnGDXFormShow; ),
   (name: 'pOnGDXFormResize';
    signature: '(JII)V';
    fnPtr: @pOnGDXFormResize; ),
   (name: 'pOnGDXFormRender';
    signature: '(JF)V';
    fnPtr: @pOnGDXFormRender; ),
   (name: 'pOnGDXFormClose';
    signature: '(J)V';
    fnPtr: @pOnGDXFormClose; ),
   (name: 'pOnGDXFormResume';
    signature: '(J)V';
    fnPtr: @pOnGDXFormResume; ),
   (name: 'pOnGDXFormPause';
    signature: '(J)V';
    fnPtr: @pOnGDXFormPause; ),
   (name: 'pOnGDXFormHide';
    signature: '(J)V';
    fnPtr: @pOnGDXFormHide; ),
   (name: 'pOnGDXFormKeyPressed';
    signature: '(JI)I';
    fnPtr: @pOnGDXFormKeyPressed; ),
   (name: 'pOnGDXFormTouchDown';
    signature: '(JIIII)V';
    fnPtr: @pOnGDXFormTouchDown; ),
   (name: 'pOnGDXFormTouchUp';
    signature: '(JIIII)V';
    fnPtr: @pOnGDXFormTouchUp; )
);
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/applibgdxdemo2/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_applibgdxdemo2_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_applibgdxdemo2_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_applibgdxdemo2_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_applibgdxdemo2_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_applibgdxdemo2_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_applibgdxdemo2_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_applibgdxdemo2_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_applibgdxdemo2_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_applibgdxdemo2_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_applibgdxdemo2_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_applibgdxdemo2_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_applibgdxdemo2_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_applibgdxdemo2_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_applibgdxdemo2_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_applibgdxdemo2_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_applibgdxdemo2_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_applibgdxdemo2_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_applibgdxdemo2_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_applibgdxdemo2_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_applibgdxdemo2_Controls_pOnBackPressed',
  pOnClose name 'Java_org_lamw_applibgdxdemo2_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_applibgdxdemo2_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_applibgdxdemo2_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_applibgdxdemo2_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pAppOnRequestPermissionResult',
  pOnGDXFormShow name 'Java_org_lamw_applibgdxdemo2_Controls_pOnGDXFormShow',
  pOnGDXFormResize name 
    'Java_org_lamw_applibgdxdemo2_Controls_pOnGDXFormResize',
  pOnGDXFormRender name 
    'Java_org_lamw_applibgdxdemo2_Controls_pOnGDXFormRender',
  pOnGDXFormClose name 'Java_org_lamw_applibgdxdemo2_Controls_pOnGDXFormClose',
  pOnGDXFormResume name 
    'Java_org_lamw_applibgdxdemo2_Controls_pOnGDXFormResume',
  pOnGDXFormPause name 'Java_org_lamw_applibgdxdemo2_Controls_pOnGDXFormPause',
  pOnGDXFormHide name 'Java_org_lamw_applibgdxdemo2_Controls_pOnGDXFormHide',
  pOnGDXFormKeyPressed name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pOnGDXFormKeyPressed',
  pOnGDXFormTouchDown name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pOnGDXFormTouchDown',
  pOnGDXFormTouchUp name 'Java_org_lamw_applibgdxdemo2_Controls_'
    +'pOnGDXFormTouchUp';
...
begin
  ...
  gApp.Title:= 'LAMW GDX Android Bridges Library';
  gjAppName:= 'org.lamw.applibgdxdemo2';
  gjClassName:= 'org/lamw/applibgdxdemo2/Controls';
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TGdxModule1, GdxModule1);
end.
