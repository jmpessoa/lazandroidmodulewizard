...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 10/13/2019 1:04:17]
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/applibgdxdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_applibgdxdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_applibgdxdemo1_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_applibgdxdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_applibgdxdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_applibgdxdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_applibgdxdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_applibgdxdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_applibgdxdemo1_Controls_pAppOnStop',
  ...
  pAppOnCreateOptionsMenu name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_applibgdxdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_applibgdxdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_applibgdxdemo1_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_applibgdxdemo1_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_applibgdxdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_applibgdxdemo1_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_applibgdxdemo1_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_applibgdxdemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_applibgdxdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_applibgdxdemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_applibgdxdemo1_Controls_pOnBackPressed',
  pOnClose name 'Java_org_lamw_applibgdxdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_applibgdxdemo1_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_applibgdxdemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_applibgdxdemo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pAppOnRequestPermissionResult',
  pOnGDXFormShow name 'Java_org_lamw_applibgdxdemo1_Controls_pOnGDXFormShow',
  pOnGDXFormResize name
    'Java_org_lamw_applibgdxdemo1_Controls_pOnGDXFormResize',
  pOnGDXFormRender name
    'Java_org_lamw_applibgdxdemo1_Controls_pOnGDXFormRender',
  pOnGDXFormClose name 'Java_org_lamw_applibgdxdemo1_Controls_pOnGDXFormClose',
  pOnGDXFormResume name
    'Java_org_lamw_applibgdxdemo1_Controls_pOnGDXFormResume',
  pOnGDXFormPause name 'Java_org_lamw_applibgdxdemo1_Controls_pOnGDXFormPause',
  pOnGDXFormHide name 'Java_org_lamw_applibgdxdemo1_Controls_pOnGDXFormHide',
  pOnGDXFormKeyPressed name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pOnGDXFormKeyPressed',
  pOnGDXFormTouchDown name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pOnGDXFormTouchDown',
  pOnGDXFormTouchUp name 'Java_org_lamw_applibgdxdemo1_Controls_'
    +'pOnGDXFormTouchUp';
...
begin
  ...
  gjAppName:= 'org.lamw.applibgdxdemo1';
  gjClassName:= 'org/lamw/applibgdxdemo1/Controls';
