...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 9/30/2017 20:33:09]
...
{ Class:     org_lamw_appincomingcallwidgetproviderdemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appincomingcallwidgetproviderdemo'
       +'1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls'
    +'_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_'
    +'Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_'
    +'Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_'
    +'Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_'
    +'Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls'
    +'_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls'
    +'_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appincomingcallwidgetproviderd'
    +'emo1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appincomingcallwidgetproviderdemo'
    +'1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appincomingcallwidgetproviderde'
    +'mo1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appincomingcallwidgetproviderdem'
    +'o1_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appincomingcallwidgetprovide'
    +'rdemo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appincomingcallwidgetproviderdemo'
    +'1_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appincomingcallwidgetproviderd'
    +'emo1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls_'
    +'pOnDraw',
  pOnTouch name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls_'
    +'pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_'
    +'Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls_'
    +'pOnClick',
  pOnLongClick name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls'
    +'_pOnLongClick',
  pOnChange name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls_'
    +'pOnEnter',
  pOnClose name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls_'
    +'pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_'
    +'Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appincomingcallwidgetproviderdemo'
    +'1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appincomingcallwidgetprovider'
    +'demo1_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls'
    +'_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appincomingcallwidgetproviderdemo1'
    +'_Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appincomingcallwidgetproviderdemo1_Controls'
    +'_pOnLayouting';
...
begin
  ...
  gjAppName:= 'org.lamw.appincomingcallwidgetproviderdemo1';
  gjClassName:= 'org/lamw/appincomingcallwidgetproviderdemo1/Controls';
