...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 1/22/2017 22:46:40]
...
{ Class:     com_example_appfileproviderclientdemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appfileproviderclientdemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_appfileproviderclientdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appfileproviderclientdemo1_Controls'
    +'_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appfileproviderclientdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appfileproviderclientdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appfileproviderclientdemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_com_example_appfileproviderclientdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_com_example_appfileproviderclientdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_appfileproviderclientdemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_com_example_appfileproviderclientdemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appfileproviderclientdemo1_Controls'
    +'_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appfileproviderclientdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appfileproviderclientdemo1'
    +'_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appfileproviderclientdemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appfileproviderclientdemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appfileproviderclientdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appfileproviderclientdemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appfileproviderclientdemo'
    +'1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appfileproviderclientdemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appfileproviderclientdemo1'
    +'_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_appfileproviderclientdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_appfileproviderclientdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_example_appfileproviderclientdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appfileproviderclientdemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_appfileproviderclientdemo1_Controls_pOnClick',
  pOnChange name 'Java_com_example_appfileproviderclientdemo1_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_com_example_appfileproviderclientdemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_com_example_appfileproviderclientdemo1_Controls_pOnEnter',
  pOnClose name 'Java_com_example_appfileproviderclientdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_appfileproviderclientdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appfileproviderclientdemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appfileproviderclientdemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appfileproviderclientdemo'
    +'1_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appfileproviderclientdemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appfileproviderclientdemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appfileproviderclientdemo1_'
...
begin
  ...
  gjAppName:= 'com.example.appfileproviderclientdemo1';
  gjClassName:= 'com/example/appfileproviderclientdemo1/Controls';
