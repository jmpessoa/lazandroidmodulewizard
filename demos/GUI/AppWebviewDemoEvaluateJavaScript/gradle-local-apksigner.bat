...
zipalign -v -p 4 C:\android\workspace\AppWebviewDemoEvaluateJavaScript\build\outputs\apk\release\AppWebviewDemoEvaluateJavaScript-release-unsigned.apk C:\android\workspace\AppWebviewDemoEvaluateJavaScript\build\outputs\apk\release\AppWebviewDemoEvaluateJavaScript-release-unsigned-aligned.apk
