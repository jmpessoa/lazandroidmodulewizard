...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 8/16/2020 16:28:24]
...
{ Class:     org_lamw_appwebviewdemoevaluatejavascript_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appwebviewdemoevaluatejavascript/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appwebviewdemoevaluatejavascript_'
    +'Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appwebviewdemoevaluatejavascript_'
    +'Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appwebviewdemoevaluatejavascript_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_appwebviewdemoevaluatejavascript_'
    +'Controls_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_appwebviewdemoevaluatejavascri'
    +'pt_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appwebviewdemoevaluatejavascript_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appwebviewdemoevaluatejavascript'
    +'_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appwebviewdemoevaluatejavascrip'
    +'t_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appwebviewdemoevaluatejavascript'
    +'_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appwebviewdemoevaluatejavasc'
    +'ript_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appwebviewdemoevaluatejavascript'
    +'_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appwebviewdemoevaluatejavascri'
    +'pt_Controls_pAppOnClickContextMenuItem',
  pOnDraw name
    'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appwebviewdemoevaluatejavascript_'
    +'Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appwebviewdemoevaluatejavascript_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnDown name
    'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pOnClick',
  pOnLongClick name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls'
    +'_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls'
    +'_pOnBackPressed',
  pOnClose name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appwebviewdemoevaluatejavascript_'
    +'Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appwebviewdemoevaluatejavascript_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appwebviewdemoevaluatejavascript'
    +'_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appwebviewdemoevaluatejavascr'
    +'ipt_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appwebviewdemoevaluatejavascript_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appwebviewdemoevaluatejavascript_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appwebviewdemoevaluatejavascript_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appwebviewdemoevaluatejavas'
    +'cript_Controls_pAppOnRequestPermissionResult',
  pOnWebViewStatus name 'Java_org_lamw_appwebviewdemoevaluatejavascript_'
    +'Controls_pOnWebViewStatus',
  pOnWebViewFindResultReceived name 'Java_org_lamw_appwebviewdemoevaluatejavasc'
    +'ript_Controls_pOnWebViewFindResultReceived',
  pOnWebViewEvaluateJavascriptResult name 'Java_org_lamw_appwebviewdemoevaluate'
    +'javascript_Controls_pOnWebViewEvaluateJavascriptResult';
...
begin
  ...
  gjAppName:= 'org.lamw.appwebviewdemoevaluatejavascript';
  gjClassName:= 'org/lamw/appwebviewdemoevaluatejavascript/Controls';
