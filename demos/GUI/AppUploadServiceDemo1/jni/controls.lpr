...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 2/24/2019 17:57:39]
...
{ Class:     org_lamw_appuploadservicedemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appuploadservicedemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appuploadservicedemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appuploadservicedemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appuploadservicedemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appuploadservicedemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appuploadservicedemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appuploadservicedemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appuploadservicedemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appuploadservicedemo1_Controls'
    +'_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appuploadservicedemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appuploadservicedemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appuploadservicedemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appuploadservicedemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appuploadservicedemo1_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_appuploadservicedemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appuploadservicedemo1_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appuploadservicedemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appuploadservicedemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appuploadservicedemo1_Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_appuploadservicedemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appuploadservicedemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appuploadservicedemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appuploadservicedemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appuploadservicedemo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appuploadservicedemo1_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnBroadcastReceiver name 'Java_org_lamw_appuploadservicedemo1_Controls_'
...
begin
  ...
  gjAppName:= 'org.lamw.appuploadservicedemo1';
  gjClassName:= 'org/lamw/appuploadservicedemo1/Controls';
