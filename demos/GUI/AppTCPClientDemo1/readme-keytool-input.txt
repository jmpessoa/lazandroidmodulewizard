...
Is <CN=MyFirstName MyLastName, OU=MyDevelopmentUnit, O=MyExampleCompany,
  ...
  [no]:  y
Enter key password for <apptcpclientdemo1aliaskey> <RETURN if same as keystore password>: 123456

3. Execute "release-keystore.bat" [.sh]
            warning: well, before execute, you can change/edit the [param] -alias apptcpclientdemo1aliaskey
              ex.  -alias www.mycompany.com 
              Please, change/edit/Sync [key.alias=apptcpclientdemo1aliaskey] "ant.properties" too!

4. Edit [notepad like] "ant.properties" to more representative information!"
        warning: "key.alias=apptcpclientdemo1aliaskey" need be the same as in "release-keystore.bat [.sh]"
