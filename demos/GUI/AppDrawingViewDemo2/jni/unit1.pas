...
uses
  Classes, SysUtils, And_jni, And_jni_Bridge, Laz_And_Controls, 
    Laz_And_Controls_Events, AndroidWidget, drawingview, uData;
...
//by kordal
//ref. https://forum.lazarus.freepascal.org/index.php/topic,21919.msg334887/
...
begin
  ...
  jDrawingView1.DrawFrame(jBitmap1.GetImage(), 0, 0, 96, 96, P.X, P.Y, 144, 144, Angle); //by kordal
...
begin
  // load image from "uData.pas"
  jBitmap1.LoadFromBuffer(@IMGDATA, IMGDATA_SIZE);  //by kordal
  jTimer1.Enabled := True;

  jDrawingView1.PaintStrokeWidth:= 2 ;  //fixed!! thanks to Manlio!
