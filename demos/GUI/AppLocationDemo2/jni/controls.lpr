...
exports
  ...
  pAppOnUpdateLayout name 'Java_com_example_applocationdemo1_Controls_'
    +'pAppOnUpdateLayout',
  ...
  pOnDown name 'Java_com_example_applocationdemo1_Controls_pOnDown',
  ...
  pOnDoubleClick name 'Java_com_example_applocationdemo1_Controls_'
    +'pOnDoubleClick',
  ...
  pOnBackPressed name 'Java_com_example_applocationdemo1_Controls_'
    +'pOnBackPressed',
  ...
  pOnWebViewStatus name 'Java_com_example_applocationdemo1_Controls_'
    +'pOnWebViewStatus',
  pOnWebViewFindResultReceived name 'Java_com_example_applocationdemo1_'
