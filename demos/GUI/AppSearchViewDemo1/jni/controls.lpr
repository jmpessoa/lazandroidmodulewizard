...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 9/21/2018 21:28:44]
...
{ Class:     org_lamw_appsearchviewdemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appsearchviewdemo1_Controls
  Method:    pOnSearchViewFocusChange
  Signature: (JZ)V }
procedure pOnSearchViewFocusChange(PEnv: PJNIEnv; this: JObject; pasobj: JLong;
  hasFocus: JBoolean); cdecl;
begin
  Java_Event_pOnSearchViewFocusChange(PEnv, this, TObject(pasobj), hasFocus);
end;

{ Class:     org_lamw_appsearchviewdemo1_Controls
  Method:    pOnSearchViewQueryTextSubmit
  Signature: (JLjava/lang/String;)V }
procedure pOnSearchViewQueryTextSubmit(PEnv: PJNIEnv; this: JObject;
  pasobj: JLong; query: JString); cdecl;
begin
  Java_Event_pOnSearchViewQueryTextSubmit(PEnv, this, TObject(pasobj), query);
end;

{ Class:     org_lamw_appsearchviewdemo1_Controls
  Method:    pOnSearchViewQueryTextChange
  Signature: (JLjava/lang/String;)V }
procedure pOnSearchViewQueryTextChange(PEnv: PJNIEnv; this: JObject;
  pasobj: JLong; newText: JString); cdecl;
begin
  Java_Event_pOnSearchViewQueryTextChange(PEnv, this, TObject(pasobj), newText);
end;
...
const NativeMethods: array[0..50] of JNINativeMethod = (
   ...
   (name: 'pOnSearchViewFocusChange';
    signature: '(JZ)V';
    fnPtr: @pOnSearchViewFocusChange; ),
   (name: 'pOnSearchViewQueryTextSubmit';
    signature: '(JLjava/lang/String;)V';
    fnPtr: @pOnSearchViewQueryTextSubmit; ),
   (name: 'pOnSearchViewQueryTextChange';
    signature: '(JLjava/lang/String;)V';
    fnPtr: @pOnSearchViewQueryTextChange; )
);
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appsearchviewdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appsearchviewdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appsearchviewdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appsearchviewdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appsearchviewdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appsearchviewdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appsearchviewdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appsearchviewdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appsearchviewdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appsearchviewdemo1_Controls'
    +'_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appsearchviewdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appsearchviewdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_appsearchviewdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appsearchviewdemo1_Controls_pOnLongClick',
  pOnChange name 'Java_org_lamw_appsearchviewdemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appsearchviewdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appsearchviewdemo1_Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_appsearchviewdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appsearchviewdemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appsearchviewdemo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appsearchviewdemo1_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnClickWidgetItem name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_org_lamw_appsearchviewdemo1_'
    +'Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_org_lamw_appsearchviewdemo1_'
    +'Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_org_lamw_appsearchviewdemo1_'
    +'Controls_pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_org_lamw_appsearchviewdemo1_'
    +'Controls_pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetImage name 'Java_org_lamw_appsearchviewdemo1_'
    +'Controls_pOnListViewDrawItemWidgetImage',
  pRadioGroupCheckedChanged name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pRadioGroupCheckedChanged',
  pOnSearchViewFocusChange name 'Java_org_lamw_appsearchviewdemo1_Controls_'
    +'pOnSearchViewFocusChange',
  pOnSearchViewQueryTextSubmit name 'Java_org_lamw_appsearchviewdemo1_Controls'
    +'_pOnSearchViewQueryTextSubmit',
  pOnSearchViewQueryTextChange name 'Java_org_lamw_appsearchviewdemo1_Controls'
    +'_pOnSearchViewQueryTextChange';
...
begin
  ...
  gjAppName:= 'org.lamw.appsearchviewdemo1';
  gjClassName:= 'org/lamw/appsearchviewdemo1/Controls';
