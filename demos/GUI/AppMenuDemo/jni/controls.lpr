...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_appmenudemo_Controls_'
    +'pAppOnScreenStyle',
  ...
  pAppOnBackPressed name 'Java_com_example_appmenudemo_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appmenudemo_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appmenudemo_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appmenudemo_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appmenudemo_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appmenudemo_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appmenudemo_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appmenudemo_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appmenudemo_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appmenudemo_Controls_'
  ...
  pAppOnSpecialKeyDown name 'Java_com_example_appmenudemo_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_com_example_appmenudemo_Controls_pOnDown',
  pOnClick name 'Java_com_example_appmenudemo_Controls_pOnClick',
  pOnLongClick name 'Java_com_example_appmenudemo_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_com_example_appmenudemo_Controls_pOnDoubleClick',
  ...
  pAppOnListItemClick name 'Java_com_example_appmenudemo_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appmenudemo_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appmenudemo_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appmenudemo_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appmenudemo_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appmenudemo_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appmenudemo_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_appmenudemo_Controls_'
    +'pAppOnRequestPermissionResult',
  pOnClickWidgetItem name 'Java_com_example_appmenudemo_Controls_'
    +'pOnClickWidgetItem',
  pOnClickImageItem name 'Java_com_example_appmenudemo_Controls_'
    +'pOnClickImageItem',
  pOnClickCaptionItem name 'Java_com_example_appmenudemo_Controls_'
    +'pOnClickCaptionItem',
  pOnClickItemTextLeft name 'Java_com_example_appmenudemo_Controls_'
    +'pOnClickItemTextLeft',
  pOnClickItemTextCenter name 'Java_com_example_appmenudemo_Controls_'
    +'pOnClickItemTextCenter',
  pOnClickItemTextRight name 'Java_com_example_appmenudemo_Controls_'
    +'pOnClickItemTextRight',
  pOnListViewLongClickCaptionItem name 'Java_com_example_appmenudemo_Controls_'
    +'pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_com_example_appmenudemo_Controls_'
    +'pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBackgroundColor name 'Java_com_example_appmenudemo_'
    +'Controls_pOnListViewDrawItemBackgroundColor',
  pOnListViewDrawItemBitmap name 'Java_com_example_appmenudemo_Controls_'
    +'pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_com_example_appmenudemo_Controls_'
    +'pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_com_example_appmenudemo_Controls_'
    +'pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_com_example_appmenudemo_'
    +'Controls_pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetText name 'Java_com_example_appmenudemo_Controls_'
    +'pOnListViewDrawItemWidgetText',
  pOnListViewDrawItemWidgetImage name 'Java_com_example_appmenudemo_Controls_'
...
(*last [smart] upgrade: 7/4/2016 0:53:51*)
