...
exports
  ...
  pAppOnSpecialKeyDown name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_appmormotdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appmormotdemo1_Controls_pOnLongClick',
  ...
  pOnLostFocus name 'Java_org_lamw_appmormotdemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appmormotdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appmormotdemo1_Controls_pOnLayouting',
