...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 5/29/2023 16:11:56]
...
{ Class:     org_lamw_appcompatescposthermalprinterdemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     rc := RegisterNativeMethods(curEnv, 'org/lamw/appcompatescposthermalprinte'
       +'rdemo1/Controls');
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls'
    +'_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
    +'Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
    +'Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
    +'Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
    +'Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls'
    +'_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls'
    +'_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
    +'Controls_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_appcompatescposthermalprinterd'
    +'emo1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appcompatescposthermalprinterdemo'
    +'1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appcompatescposthermalprinterde'
    +'mo1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appcompatescposthermalprinterdem'
    +'o1_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appcompatescposthermalprinte'
    +'rdemo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appcompatescposthermalprinterdemo'
    +'1_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appcompatescposthermalprinterd'
    +'emo1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls_'
    +'pOnDraw',
  pOnTouch name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls_'
    +'pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
    +'Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls_'
    +'pOnDown',
  pOnUp name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls_pOnUp',
  pOnClick name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls_'
    +'pOnClick',
  pOnLongClick name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls'
    +'_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
    +'Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls_'
    +'pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
    +'Controls_pOnBackPressed',
  pOnClose name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls_'
    +'pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
    +'Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appcompatescposthermalprinterdemo'
    +'1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appcompatescposthermalprinter'
    +'demo1_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls'
    +'_pOnLostFocus',
  pOnFocus name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls_'
    +'pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appcompatescposthermalprinterdemo1'
    +'_Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appcompatescposthermalprinterdemo1_Controls'
    +'_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appcompatescposthermalprint'
    +'erdemo1_Controls_pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_org_lamw_appcompatescposthermalprinterdemo1_'
...
begin
  ...
  gjAppName:= 'org.lamw.appcompatescposthermalprinterdemo1';
  gjClassName:= 'org/lamw/appcompatescposthermalprinterdemo1/Controls';
