...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 12/17/2023 17:48:25]
...
{ Class:     org_lamw_apptextviewverticalscrolling_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     rc := RegisterNativeMethods(curEnv, 'org/lamw/apptextviewverticalscrolling'
       +'/Controls');
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_apptextviewverticalscrolling_Controls'
    +'_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_apptextviewverticalscrolling_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_apptextviewverticalscrolling_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_apptextviewverticalscrolling_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_apptextviewverticalscrolling_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_apptextviewverticalscrolling_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_apptextviewverticalscrolling'
    +'_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_apptextviewverticalscrolling_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_apptextviewverticalscrolling_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_apptextviewverticalscrolling_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_apptextviewverticalscrolling_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_apptextviewverticalscrolling_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_apptextviewverticalscrolling_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_apptextviewverticalscrolling_Controls_pOnUp',
  pOnClick name 'Java_org_lamw_apptextviewverticalscrolling_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pOnDoubleClick',
  pOnChange name 
    'Java_org_lamw_apptextviewverticalscrolling_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_org_lamw_apptextviewverticalscrolling_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pOnBackPressed',
  pOnDone name 'Java_org_lamw_apptextviewverticalscrolling_Controls_pOnDone',
  pOnSearch name 
    'Java_org_lamw_apptextviewverticalscrolling_Controls_pOnSearch',
  pOnNext name 'Java_org_lamw_apptextviewverticalscrolling_Controls_pOnNext',
  pOnGo name 'Java_org_lamw_apptextviewverticalscrolling_Controls_pOnGo',
  pOnClose name 'Java_org_lamw_apptextviewverticalscrolling_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_apptextviewverticalscrolling_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_apptextviewverticalscrolling_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_apptextviewverticalscrolling'
    +'_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pOnLostFocus',
  pOnFocus name 'Java_org_lamw_apptextviewverticalscrolling_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_apptextviewverticalscrolling_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_apptextviewverticalscrolling_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_apptextviewverticalscrollin'
    +'g_Controls_pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_org_lamw_apptextviewverticalscrolling_Controls_'
    +'pOnRunOnUiThread';
...
begin
  ...
  gjAppName:= 'org.lamw.apptextviewverticalscrolling';
  gjClassName:= 'org/lamw/apptextviewverticalscrolling/Controls';
