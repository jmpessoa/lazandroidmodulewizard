...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 2/21/2017 17:17:18]
...
{ Class:     com_example_apptextviewshaderandshadowdemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/apptextviewshaderandshadowdemo'
       +'1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls'
    +'_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_apptextviewshaderandshadowdemo1_'
    +'Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_apptextviewshaderandshadowdemo1_'
    +'Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_apptextviewshaderandshadowdemo1_'
    +'Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_com_example_apptextviewshaderandshadowdemo1_'
    +'Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls'
    +'_pAppOnResume',
  pAppOnStart name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_apptextviewshaderandshadowdemo1_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls'
    +'_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_apptextviewshaderandshadowd'
    +'emo1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apptextviewshaderandshadowdemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apptextviewshaderandshadowdemo'
    +'1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apptextviewshaderandshadowde'
    +'mo1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_apptextviewshaderandshadowdem'
    +'o1_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_apptextviewshaderandshado'
    +'wdemo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_apptextviewshaderandshadowdemo'
    +'1_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_apptextviewshaderandshadowd'
    +'emo1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls_'
    +'pOnDraw',
  pOnTouch name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls_'
    +'pOnTouch',
  pOnClickGeneric name 'Java_com_example_apptextviewshaderandshadowdemo1_'
    +'Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_apptextviewshaderandshadowdemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls_'
    +'pOnClick',
  pOnChange name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls_'
    +'pOnEnter',
  pOnClose name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls_'
    +'pOnClose',
  pAppOnViewClick name 'Java_com_example_apptextviewshaderandshadowdemo1_'
    +'Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_apptextviewshaderandshadowdemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_apptextviewshaderandshadowdemo'
    +'1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_apptextviewshaderandshadow'
    +'demo1_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls'
    +'_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_apptextviewshaderandshadowdemo1'
    +'_Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_apptextviewshaderandshadowdemo1_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_apptextviewshaderandshadowdemo1_Controls'
    +'_pOnLayouting';
...
begin
  ...
  gjAppName:= 'com.example.apptextviewshaderandshadowdemo1';
  gjClassName:= 'com/example/apptextviewshaderandshadowdemo1/Controls';
