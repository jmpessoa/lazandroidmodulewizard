...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appcustomshowmessagedemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pAppOnRotate',
  pAppOnUpdateLayout name 'Java_com_example_appcustomshowmessagedemo1_Controls'
    +'_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_com_example_appcustomshowmessagedemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appcustomshowmessagedemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appcustomshowmessagedemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appcustomshowmessagedemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appcustomshowmessagedemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appcustomshowmessagedemo'
    +'1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appcustomshowmessagedemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appcustomshowmessagedemo1_'
  ...
  pOnClickGeneric name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appcustomshowmessagedemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_com_example_appcustomshowmessagedemo1_Controls_pOnDown',
  pOnUp name 'Java_com_example_appcustomshowmessagedemo1_Controls_pOnUp',
  pOnClick name 'Java_com_example_appcustomshowmessagedemo1_Controls_pOnClick',
  pOnLongClick name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name
    'Java_com_example_appcustomshowmessagedemo1_Controls_pOnChange',
  pOnChanged name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_com_example_appcustomshowmessagedemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_com_example_appcustomshowmessagedemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appcustomshowmessagedemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appcustomshowmessagedemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appcustomshowmessagedemo1'
    +'_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pOnLostFocus',
  pOnFocus name 'Java_com_example_appcustomshowmessagedemo1_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appcustomshowmessagedemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appcustomshowmessagedemo1_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_appcustomshowmessagedemo'
    +'1_Controls_pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_com_example_appcustomshowmessagedemo1_Controls_'
    +'pOnRunOnUiThread',
  pOnImageViewPopupItemSelected name 'Java_com_example_appcustomshowmessagedemo'
    +'1_Controls_pOnImageViewPopupItemSelected';
...
(*last [smart] upgrade: 7/3/2016 23:36:46*)
