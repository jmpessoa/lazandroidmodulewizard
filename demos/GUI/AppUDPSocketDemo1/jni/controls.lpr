...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 9/24/2016 23:21:53]
...
{ Class:     com_example_appudpsocketdemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     com_example_appudpsocketdemo1_Controls
  Method:    pOnUDPSocketReceived
  Signature: (JLjava/lang/String;Ljava/lang/String;I)Z }
function pOnUDPSocketReceived(PEnv: PJNIEnv; this: JObject; pasobj: JLong;
  content: JString; fromIP: JString; fromPort: JInt): JBoolean; cdecl;
begin
  Result:=Java_Event_pOnUDPSocketReceived(PEnv, this, TObject(pasobj), content,
    fromIP, fromPort);
end;
...
const NativeMethods: array[0..35] of JNINativeMethod = (
   ...
   (name: 'pOnUDPSocketReceived';
    signature: '(JLjava/lang/String;Ljava/lang/String;I)Z';
    fnPtr: @pOnUDPSocketReceived; )
);
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appudpsocketdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_appudpsocketdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name
    'Java_com_example_appudpsocketdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appudpsocketdemo1_Controls_pAppOnPause',
  pAppOnRestart name
    'Java_com_example_appudpsocketdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_appudpsocketdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_appudpsocketdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_appudpsocketdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appudpsocketdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appudpsocketdemo1_Controls'
    +'_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appudpsocketdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appudpsocketdemo1_Controls'
    +'_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_appudpsocketdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_appudpsocketdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_appudpsocketdemo1_Controls_pOnClick',
  pOnChange name 'Java_com_example_appudpsocketdemo1_Controls_pOnChange',
  pOnChanged name 'Java_com_example_appudpsocketdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_appudpsocketdemo1_Controls_pOnEnter',
  pOnClose name 'Java_com_example_appudpsocketdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appudpsocketdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appudpsocketdemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnUDPSocketReceived name 'Java_com_example_appudpsocketdemo1_Controls_'
    +'pOnUDPSocketReceived';
...
begin
  ...
  gjAppName:= 'com.example.appudpsocketdemo1';
  gjClassName:= 'com/example/appudpsocketdemo1/Controls';
