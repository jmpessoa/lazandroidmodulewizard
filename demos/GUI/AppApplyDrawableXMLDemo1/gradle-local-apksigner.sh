...
zipalign -v -p 4 /android/workspace/AppApplyDrawableXMLDemo1/build/outputs/apk/release/AppApplyDrawableXMLDemo1-armeabi-v7a-release-unsigned.apk /android/workspace/AppApplyDrawableXMLDemo1/build/outputs/apk/release/AppApplyDrawableXMLDemo1-armeabi-v7a-release-unsigned-aligned.apk
