...
zipalign -v -p 4 C:\android\workspace\AppApplyDrawableXMLDemo1\build\outputs\apk\release\AppApplyDrawableXMLDemo1-universal-release-unsigned.apk C:\android\workspace\AppApplyDrawableXMLDemo1\build\outputs\apk\release\AppApplyDrawableXMLDemo1-universal-release-unsigned-aligned.apk
