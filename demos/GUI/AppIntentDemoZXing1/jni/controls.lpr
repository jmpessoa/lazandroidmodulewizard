...
exports
  ...
  pAppOnCreate name
    'Java_com_example_appintentdemozxing1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appintentdemozxing1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appintentdemozxing1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appintentdemozxing1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appintentdemozxing1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appintentdemozxing1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name
    'Java_com_example_appintentdemozxing1_Controls_pAppOnResume',
  ...
  pAppOnBackPressed name 'Java_com_example_appintentdemozxing1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name
  ...
  pAppOnCreateOptionsMenu name 'Java_com_example_appintentdemozxing1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appintentdemozxing1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appintentdemozxing1_Controls'
    +'_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appintentdemozxing1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appintentdemozxing1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appintentdemozxing1_'
  ...
  pOnClickGeneric name 'Java_com_example_appintentdemozxing1_Controls_'
    +'pOnClickGeneric',
  ...
  pOnDoubleClick name 'Java_com_example_appintentdemozxing1_Controls_'
    +'pOnDoubleClick',
  ...
  pAppOnViewClick name 'Java_com_example_appintentdemozxing1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appintentdemozxing1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appintentdemozxing1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appintentdemozxing1_'
  ...
  pOnListViewScrollStateChanged name 'Java_com_example_appintentdemozxing1_'
