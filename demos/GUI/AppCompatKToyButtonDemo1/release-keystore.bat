...
keytool -genkey -v -keystore appcompatktoybuttondemo1-release.keystore -alias appcompatktoybuttondemo1.keyalias -keyalg RSA -keysize 2048 -validity 10000 < C:\android\workspace\AppCompatKToyButtonDemo1\keytool_input.txt
:Error
echo off
cls
echo.
