...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 16-Nov-19 22:39:07]
...
{ Class:     org_lamw_inapp5_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_inapp5_Controls
  Method:    pOnBillingClientEvent
  Signature: (JLjava/lang/String;)V }
procedure pOnBillingClientEvent(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  xml: JString); cdecl;
begin
  Java_Event_pOnBillingClientEvent(PEnv, this, TObject(pasobj), xml);
end;
...
const NativeMethods: array[0..45] of JNINativeMethod = (
   ...
   (name: 'pOnBillingClientEvent';
    signature: '(JLjava/lang/String;)V';
    fnPtr: @pOnBillingClientEvent; ),
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/inapp5/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_inapp5_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_inapp5_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_inapp5_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_inapp5_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_inapp5_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_inapp5_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_inapp5_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_inapp5_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_inapp5_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_inapp5_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_inapp5_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_inapp5_Controls_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_inapp5_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 
    'Java_org_lamw_inapp5_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_inapp5_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_inapp5_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_inapp5_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_inapp5_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_inapp5_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_inapp5_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_inapp5_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_inapp5_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_inapp5_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 
    'Java_org_lamw_inapp5_Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_inapp5_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_inapp5_Controls_pOnUp',
  pOnClick name 'Java_org_lamw_inapp5_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_inapp5_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_inapp5_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_inapp5_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_inapp5_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_inapp5_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_inapp5_Controls_pOnBackPressed',
  pOnClose name 'Java_org_lamw_inapp5_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_inapp5_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_inapp5_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_inapp5_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_inapp5_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_inapp5_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_inapp5_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 
    'Java_org_lamw_inapp5_Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_inapp5_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_inapp5_Controls_'
    +'pAppOnRequestPermissionResult',
  pOnBillingClientEvent name 'Java_org_lamw_inapp5_Controls_'
    +'pOnBillingClientEvent',
  pOnWebViewStatus name 'Java_org_lamw_inapp5_Controls_pOnWebViewStatus',
  pOnWebViewFindResultReceived name 'Java_org_lamw_inapp5_Controls_'
...
begin
  ...
  gjAppName:= 'org.lamw.inapp5';
  gjClassName:= 'org/lamw/inapp5/Controls';
