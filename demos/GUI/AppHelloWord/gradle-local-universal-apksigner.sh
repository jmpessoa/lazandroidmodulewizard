...
zipalign -v -p 4 /android/workspace/AppHelloWord/build/outputs/apk/release/AppHelloWord-universal-release-unsigned.apk /android/workspace/AppHelloWord/build/outputs/apk/release/AppHelloWord-universal-release-unsigned-aligned.apk
