...
zipalign -v -p 4 C:\android\workspace\AppHelloWord\build\outputs\apk\release\AppHelloWord-universal-release-unsigned.apk C:\android\workspace\AppHelloWord\build\outputs\apk\release\AppHelloWord-universal-release-unsigned-aligned.apk
apksigner sign --ks C:\android\workspace\AppHelloWord\apphelloword-release.keystore --ks-pass pass:123456 --key-pass pass:123456 --out C:\android\workspace\AppHelloWord\build\outputs\apk\release\AppHelloWord-release.apk C:\android\workspace\AppHelloWord\build\outputs\apk\release\AppHelloWord-universal-release-unsigned-aligned.apk
