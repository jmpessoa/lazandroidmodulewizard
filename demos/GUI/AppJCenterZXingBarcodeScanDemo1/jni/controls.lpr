...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 3/15/2023 13:55:27]
...
{ Class:     org_lamw_appjcenterzxingbarcodescandemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     rc := RegisterNativeMethods(curEnv, 'org/lamw/appjcenterzxingbarcodescande'
       +'mo1/Controls');
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_'
    +'Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls'
    +'_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_'
    +'Controls_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_appjcenterzxingbarcodescandemo'
    +'1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appjcenterzxingbarcodescandemo'
    +'1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appjcenterzxingbarcodescandemo1'
    +'_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appjcenterzxingbarcodescande'
    +'mo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appjcenterzxingbarcodescandemo'
    +'1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls'
    +'_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_pOnUp',
  pOnClick name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pOnClick',
  pOnLongClick name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls'
    +'_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appjcenterzxingbarcodescandem'
    +'o1_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pOnLostFocus',
  pOnFocus name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appjcenterzxingbarcodescand'
    +'emo1_Controls_pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_org_lamw_appjcenterzxingbarcodescandemo1_'
...
begin
  ...
  gjAppName:= 'org.lamw.appjcenterzxingbarcodescandemo1';
  gjClassName:= 'org/lamw/appjcenterzxingbarcodescandemo1/Controls';
