...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_appsmsdemo1_Controls_'
    +'pAppOnScreenStyle',
  ...
  pAppOnBackPressed name 'Java_com_example_appsmsdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appsmsdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appsmsdemo1_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appsmsdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appsmsdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appsmsdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appsmsdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appsmsdemo1_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appsmsdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appsmsdemo1_Controls_'
  ...
  pOnClickGeneric name 'Java_com_example_appsmsdemo1_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appsmsdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_appsmsdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_com_example_appsmsdemo1_Controls_pOnLongClick',
  ...
  pAppOnListItemClick name 'Java_com_example_appsmsdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appsmsdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appsmsdemo1_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appsmsdemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appsmsdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appsmsdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appsmsdemo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_appsmsdemo1_Controls_'
    +'pAppOnRequestPermissionResult',
  pOnBroadcastReceiver name 'Java_com_example_appsmsdemo1_Controls_'
...
(*last [smart] upgrade: 7/4/2016 1:12:51*)
