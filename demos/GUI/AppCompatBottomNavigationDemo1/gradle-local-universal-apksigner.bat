...
zipalign -v -p 4 C:\android\workspace\AppCompatBottomNavigationDemo1\build\outputs\apk\release\AppCompatBottomNavigationDemo1-universal-release-unsigned.apk C:\android\workspace\AppCompatBottomNavigationDemo1\build\outputs\apk\release\AppCompatBottomNavigationDemo1-universal-release-unsigned-aligned.apk
