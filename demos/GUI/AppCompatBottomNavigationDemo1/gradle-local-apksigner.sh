...
zipalign -v -p 4 /android/workspace/AppCompatBottomNavigationDemo1/build/outputs/apk/release/AppCompatBottomNavigationDemo1-armeabi-v7a-release-unsigned.apk /android/workspace/AppCompatBottomNavigationDemo1/build/outputs/apk/release/AppCompatBottomNavigationDemo1-armeabi-v7a-release-unsigned-aligned.apk
