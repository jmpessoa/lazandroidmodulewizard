...
keytool -genkey -v -keystore appcompatbottomnavigationdemo1-release.keystore -alias appcompatbottomnavigationdemo1.keyalias -keyalg RSA -keysize 2048 -validity 10000 < C:\android\workspace\AppCompatBottomNavigationDemo1\keytool_input.txt
:Error
echo off
cls
echo.
