...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 4/22/2017 20:57:34]
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appsmswidgetproviderdemo1/Controls'
       );
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appsmswidgetproviderdemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appsmswidgetproviderdemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appsmswidgetproviderdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appsmswidgetproviderdemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appsmswidgetproviderdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appsmswidgetproviderdemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appsmswidgetproviderdemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pOnClickGeneric',
  ...
  pOnClose name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appsmswidgetproviderdemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appsmswidgetproviderdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appsmswidgetproviderdemo1_Controls'
...
begin
  ...
  gjAppName:= 'org.lamw.appsmswidgetproviderdemo1';
  gjClassName:= 'org/lamw/appsmswidgetproviderdemo1/Controls';
