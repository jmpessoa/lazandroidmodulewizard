...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pAppOnNewIntent',
  ...
  pAppOnBackPressed name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appsqlitedemo2_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appsqlitedemo2_Controls_'
  ...
  pOnClickGeneric name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appsqlitedemo2_Controls_'
  ...
  pAppOnViewClick name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appsqlitedemo2_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appsqlitedemo2_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appsqlitedemo2_Controls_pOnLayouting';
...
(*last [smart] upgrade: 7/4/2016 1:28:51*)
