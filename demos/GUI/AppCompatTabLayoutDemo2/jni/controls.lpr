...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 2/23/2018 23:41:35]
...
{ Class:     org_lamw_appcompattablayoutdemo2_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appcompattablayoutdemo2/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appcompattablayoutdemo2_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appcompattablayoutdemo2_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appcompattablayoutdemo2_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appcompattablayoutdemo2_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appcompattablayoutdemo2_Controls'
    +'_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appcompattablayoutdemo2_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appcompattablayoutdemo2_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appcompattablayoutdemo2_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appcompattablayoutdemo2_Controls'
    +'_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appcompattablayoutdemo2_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appcompattablayoutdemo2_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appcompattablayoutdemo2_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_appcompattablayoutdemo2_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pOnLongClick',
  pOnChange name 'Java_org_lamw_appcompattablayoutdemo2_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appcompattablayoutdemo2_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appcompattablayoutdemo2_Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_appcompattablayoutdemo2_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appcompattablayoutdemo2_Controls'
    +'_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appcompattablayoutdemo2_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pOnLayouting',
  pOnRecyclerViewItemClick name 'Java_org_lamw_appcompattablayoutdemo2_'
    +'Controls_pOnRecyclerViewItemClick',
  pOnSTabSelected name 'Java_org_lamw_appcompattablayoutdemo2_Controls_'
    +'pOnSTabSelected';
...
begin
  ...
  gjAppName:= 'org.lamw.appcompattablayoutdemo2';
  gjClassName:= 'org/lamw/appcompattablayoutdemo2/Controls';
