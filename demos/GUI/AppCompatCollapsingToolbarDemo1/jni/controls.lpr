...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 2/11/2018 23:56:27]
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appcompatcollapsingtoolbardemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_'
    +'Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls'
    +'_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_'
    +'Controls_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_appcompatcollapsingtoolbardemo'
    +'1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appcompatcollapsingtoolbardemo'
    +'1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appcompatcollapsingtoolbardemo1'
    +'_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appcompatcollapsingtoolbarde'
    +'mo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appcompatcollapsingtoolbardemo'
    +'1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls'
    +'_pOnClickGeneric',
  ...
  pOnLongClick name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls'
    +'_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appcompatcollapsingtoolbardem'
  ...
  pOnLayouting name 'Java_org_lamw_appcompatcollapsingtoolbardemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appcompatcollapsingtoolbard'
...
begin
  ...
  gjAppName:= 'org.lamw.appcompatcollapsingtoolbardemo1';
  gjClassName:= 'org/lamw/appcompatcollapsingtoolbardemo1/Controls';
