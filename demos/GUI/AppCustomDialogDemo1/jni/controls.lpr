...
exports
  ...
  pAppOnCreate name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appcustomdialogdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pAppOnResume',
  ...
  pAppOnBackPressed name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appcustomdialogdemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appcustomdialogdemo1_Controls'
    +'_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appcustomdialogdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appcustomdialogdemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appcustomdialogdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appcustomdialogdemo1_Controls'
    +'_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appcustomdialogdemo1_'
  ...
  pOnClickGeneric name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appcustomdialogdemo1_Controls_'
  ...
  pAppOnViewClick name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appcustomdialogdemo1_Controls'
    +'_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appcustomdialogdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pOnLayouting',
  pOnCustomDialogShow name 'Java_com_example_appcustomdialogdemo1_Controls_'
    +'pOnCustomDialogShow',
  pOnCustomDialogBackKeyPressed name 'Java_com_example_appcustomdialogdemo1_'
