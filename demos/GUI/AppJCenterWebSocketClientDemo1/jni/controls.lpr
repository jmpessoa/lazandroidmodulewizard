...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 12/22/2021 13:11:49]
...
{ Class:     org_lamw_appjcenterwebsocketclientdemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appjcenterwebsocketclientdemo1_Controls
  Method:    pWebSocketClientOnOpen
  Signature: (J)V }
procedure pWebSocketClientOnOpen(PEnv: PJNIEnv; this: JObject; pasobj: JLong); 
  cdecl;
begin
  Java_Event_pWebSocketClientOnOpen(PEnv, this, TObject(pasobj));
end;

{ Class:     org_lamw_appjcenterwebsocketclientdemo1_Controls
  Method:    pWebSocketClientOnTextReceived
  Signature: (JLjava/lang/String;)V }
procedure pWebSocketClientOnTextReceived(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; msgContent: JString); cdecl;
begin
  Java_Event_pWebSocketClientOnTextReceived(PEnv, this, TObject(pasobj), 
    msgContent);
end;

{ Class:     org_lamw_appjcenterwebsocketclientdemo1_Controls
  Method:    pWebSocketClientOnBinaryReceived
  Signature: (J[B)V }
procedure pWebSocketClientOnBinaryReceived(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; data: JByteArray); cdecl;
begin
  Java_Event_pWebSocketClientOnBinaryReceived(PEnv, this, TObject(pasobj), data
    );
end;

{ Class:     org_lamw_appjcenterwebsocketclientdemo1_Controls
  Method:    pWebSocketClientOnPingReceived
  Signature: (J[B)V }
procedure pWebSocketClientOnPingReceived(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; data: JByteArray); cdecl;
begin
  Java_Event_pWebSocketClientOnPingReceived(PEnv, this, TObject(pasobj), data);
end;

{ Class:     org_lamw_appjcenterwebsocketclientdemo1_Controls
  Method:    pWebSocketClientOnPongReceived
  Signature: (J[B)V }
procedure pWebSocketClientOnPongReceived(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; data: JByteArray); cdecl;
begin
  Java_Event_pWebSocketClientOnPongReceived(PEnv, this, TObject(pasobj), data);
end;

{ Class:     org_lamw_appjcenterwebsocketclientdemo1_Controls
  Method:    pWebSocketClientOnException
  Signature: (JLjava/lang/String;)V }
procedure pWebSocketClientOnException(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; exceptionMessage: JString); cdecl;
begin
  Java_Event_pWebSocketClientOnException(PEnv, this, TObject(pasobj), 
    exceptionMessage);
end;

{ Class:     org_lamw_appjcenterwebsocketclientdemo1_Controls
  Method:    pWebSocketClientOnCloseReceived
  Signature: (J)V }
procedure pWebSocketClientOnCloseReceived(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong); cdecl;
begin
  Java_Event_pWebSocketClientOnCloseReceived(PEnv, this, TObject(pasobj));
end;
...
const NativeMethods: array[0..51] of JNINativeMethod = (
   ...
   (name: 'pWebSocketClientOnOpen';
    signature: '(J)V';
    fnPtr: @pWebSocketClientOnOpen; ),
   (name: 'pWebSocketClientOnTextReceived';
    signature: '(JLjava/lang/String;)V';
    fnPtr: @pWebSocketClientOnTextReceived; ),
   (name: 'pWebSocketClientOnBinaryReceived';
    signature: '(J[B)V';
    fnPtr: @pWebSocketClientOnBinaryReceived; ),
   (name: 'pWebSocketClientOnPingReceived';
    signature: '(J[B)V';
    fnPtr: @pWebSocketClientOnPingReceived; ),
   (name: 'pWebSocketClientOnPongReceived';
    signature: '(J[B)V';
    fnPtr: @pWebSocketClientOnPongReceived; ),
   (name: 'pWebSocketClientOnException';
    signature: '(JLjava/lang/String;)V';
    fnPtr: @pWebSocketClientOnException; ),
   (name: 'pWebSocketClientOnCloseReceived';
    signature: '(J)V';
    fnPtr: @pWebSocketClientOnCloseReceived; )
);
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appjcenterwebsocketclientdemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appjcenterwebsocketclientdemo1_'
    +'Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appjcenterwebsocketclientdemo1_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_appjcenterwebsocketclientdemo1_'
    +'Controls_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_appjcenterwebsocketclientdemo'
    +'1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appjcenterwebsocketclientdemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appjcenterwebsocketclientdemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appjcenterwebsocketclientdemo1'
    +'_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appjcenterwebsocketclientdemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appjcenterwebsocketclientdem'
    +'o1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appjcenterwebsocketclientdemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appjcenterwebsocketclientdemo'
    +'1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_pOnDraw',
  pOnTouch name 
    'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appjcenterwebsocketclientdemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_pOnUp',
  pOnClick name 
    'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 
    'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pOnBackPressed',
  pOnClose name 
    'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appjcenterwebsocketclientdemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appjcenterwebsocketclientdemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appjcenterwebsocketclientdemo'
    +'1_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pOnLostFocus',
  pOnFocus name 
    'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appjcenterwebsocketclientdemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appjcenterwebsocketclientdemo1_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appjcenterwebsocketclientde'
    +'mo1_Controls_pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_org_lamw_appjcenterwebsocketclientdemo1_Controls'
    +'_pOnRunOnUiThread',
  pWebSocketClientOnOpen name 'Java_org_lamw_appjcenterwebsocketclientdemo1_'
    +'Controls_pWebSocketClientOnOpen',
  pWebSocketClientOnTextReceived name 'Java_org_lamw_appjcenterwebsocketclientd'
    +'emo1_Controls_pWebSocketClientOnTextReceived',
  pWebSocketClientOnBinaryReceived name 'Java_org_lamw_appjcenterwebsocketclien'
    +'tdemo1_Controls_pWebSocketClientOnBinaryReceived',
  pWebSocketClientOnPingReceived name 'Java_org_lamw_appjcenterwebsocketclientd'
    +'emo1_Controls_pWebSocketClientOnPingReceived',
  pWebSocketClientOnPongReceived name 'Java_org_lamw_appjcenterwebsocketclientd'
    +'emo1_Controls_pWebSocketClientOnPongReceived',
  pWebSocketClientOnException name 'Java_org_lamw_appjcenterwebsocketclientdemo'
    +'1_Controls_pWebSocketClientOnException',
  pWebSocketClientOnCloseReceived name 'Java_org_lamw_appjcenterwebsocketclient'
    +'demo1_Controls_pWebSocketClientOnCloseReceived';
...
begin
  ...
  gjAppName:= 'org.lamw.appjcenterwebsocketclientdemo1';
  gjClassName:= 'org/lamw/appjcenterwebsocketclientdemo1/Controls';
