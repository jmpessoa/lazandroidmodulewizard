...
zipalign -v -p 4 /android/workspace/AppPublicFoldersAccessDemo1/build/outputs/apk/release/AppPublicFoldersAccessDemo1-universal-release-unsigned.apk /android/workspace/AppPublicFoldersAccessDemo1/build/outputs/apk/release/AppPublicFoldersAccessDemo1-universal-release-unsigned-aligned.apk
