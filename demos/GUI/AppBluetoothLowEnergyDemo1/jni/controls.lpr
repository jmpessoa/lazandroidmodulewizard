...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 3/31/2019 17:11:13]
...
{ Class:     org_lamw_appbluetoothlowenergydemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appbluetoothlowenergydemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 
    'Java_org_lamw_appbluetoothlowenergydemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls'
    +'_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls'
    +'_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_pOnUp',
  pOnClick name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_pOnChange',
  pOnChanged name 
    'Java_org_lamw_appbluetoothlowenergydemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pOnLostFocus',
  pOnFocus name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls'
    +'_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appbluetoothlowenergydemo1'
    +'_Controls_pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pOnRunOnUiThread',
  pOnBluetoothLEConnected name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pOnBluetoothLEConnected',
  pOnBluetoothLEScanCompleted name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pOnBluetoothLEScanCompleted',
  pOnBluetoothLEServiceDiscovered name 'Java_org_lamw_appbluetoothlowenergydemo'
    +'1_Controls_pOnBluetoothLEServiceDiscovered',
  pOnBluetoothLECharacteristicChanged name 'Java_org_lamw_appbluetoothlowenergy'
    +'demo1_Controls_pOnBluetoothLECharacteristicChanged',
  pOnBluetoothLECharacteristicRead name 'Java_org_lamw_appbluetoothlowenergydem'
    +'o1_Controls_pOnBluetoothLECharacteristicRead',
  pOnClickWidgetItem name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pOnClickWidgetItem',
  pOnClickImageItem name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pOnClickImageItem',
  pOnClickCaptionItem name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls_'
    +'pOnClickCaptionItem',
  pOnClickItemTextLeft name 'Java_org_lamw_appbluetoothlowenergydemo1_Controls'
    +'_pOnClickItemTextLeft',
  pOnClickItemTextCenter name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pOnClickItemTextCenter',
  pOnClickItemTextRight name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pOnClickItemTextRight',
  pOnListViewLongClickCaptionItem name 'Java_org_lamw_appbluetoothlowenergydemo'
    +'1_Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_org_lamw_appbluetoothlowenergydemo'
    +'1_Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBackgroundColor name 'Java_org_lamw_appbluetoothlowenergyd'
    +'emo1_Controls_pOnListViewDrawItemBackgroundColor',
  pOnListViewDrawItemBitmap name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_org_lamw_appbluetoothlowenergydemo1_'
    +'Controls_pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_org_lamw_appbluetoothlowenergydemo1'
    +'_Controls_pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_org_lamw_appbluetoothlowenergyd'
    +'emo1_Controls_pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetText name 'Java_org_lamw_appbluetoothlowenergydemo1'
    +'_Controls_pOnListViewDrawItemWidgetText',
  pOnListViewDrawItemWidgetImage name 'Java_org_lamw_appbluetoothlowenergydemo'
...
begin
  ...
  gjAppName:= 'org.lamw.appbluetoothlowenergydemo1';
  gjClassName:= 'org/lamw/appbluetoothlowenergydemo1/Controls';
