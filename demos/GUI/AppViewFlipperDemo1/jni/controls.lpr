...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 2/5/2017 1:13:03]
...
{ Class:     com_example_appviewflipperdemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appviewflipperdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name
    'Java_com_example_appviewflipperdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appviewflipperdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appviewflipperdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appviewflipperdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appviewflipperdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appviewflipperdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name
    'Java_com_example_appviewflipperdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_appviewflipperdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_appviewflipperdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appviewflipperdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name
    'Java_com_example_appviewflipperdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appviewflipperdemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appviewflipperdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appviewflipperdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appviewflipperdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appviewflipperdemo1_Controls'
    +'_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appviewflipperdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appviewflipperdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appviewflipperdemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_appviewflipperdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_appviewflipperdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_example_appviewflipperdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appviewflipperdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_appviewflipperdemo1_Controls_pOnClick',
  pOnChange name 'Java_com_example_appviewflipperdemo1_Controls_pOnChange',
  pOnChanged name 'Java_com_example_appviewflipperdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_appviewflipperdemo1_Controls_pOnEnter',
  pOnClose name 'Java_com_example_appviewflipperdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_appviewflipperdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appviewflipperdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appviewflipperdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appviewflipperdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name
    'Java_com_example_appviewflipperdemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appviewflipperdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appviewflipperdemo1_Controls_'
...
begin
  ...
  gjAppName:= 'com.example.appviewflipperdemo1';
  gjClassName:= 'com/example/appviewflipperdemo1/Controls';
