...
keytool -genkey -v -keystore appmodbusdemo1-release.keystore -alias appmodbusdemo1.keyalias -keyalg RSA -keysize 2048 -validity 10000 < C:\android\workspace\AppModbusDemo1\keytool_input.txt
:Error
echo off
cls
echo.
