...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 19/12/2020 10:59:11]
...
{ Class:     com_example_appgridcolorpickerdemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appgridcolorpickerdemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 
    'Java_com_example_appgridcolorpickerdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnUpdateLayout name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_com_example_appgridcolorpickerdemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appgridcolorpickerdemo1_Controls'
    +'_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appgridcolorpickerdemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appgridcolorpickerdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appgridcolorpickerdemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appgridcolorpickerdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appgridcolorpickerdemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appgridcolorpickerdemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_appgridcolorpickerdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_appgridcolorpickerdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appgridcolorpickerdemo1_Controls'
    +'_pAppOnSpecialKeyDown',
  pOnDown name 'Java_com_example_appgridcolorpickerdemo1_Controls_pOnDown',
  pOnUp name 'Java_com_example_appgridcolorpickerdemo1_Controls_pOnUp',
  pOnClick name 'Java_com_example_appgridcolorpickerdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_com_example_appgridcolorpickerdemo1_Controls_pOnChange',
  pOnChanged name 
    'Java_com_example_appgridcolorpickerdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_appgridcolorpickerdemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_com_example_appgridcolorpickerdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appgridcolorpickerdemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appgridcolorpickerdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pOnLostFocus',
  pOnFocus name 'Java_com_example_appgridcolorpickerdemo1_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appgridcolorpickerdemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appgridcolorpickerdemo1_Controls'
    +'_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_appgridcolorpickerdemo1'
    +'_Controls_pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pOnRunOnUiThread',
  pOnClickGridItem name 'Java_com_example_appgridcolorpickerdemo1_Controls_'
    +'pOnClickGridItem',
  pOnLongClickGridItem name 'Java_com_example_appgridcolorpickerdemo1_Controls'
    +'_pOnLongClickGridItem',
  pOnGridDrawItemCaptionColor name 'Java_com_example_appgridcolorpickerdemo1_'
    +'Controls_pOnGridDrawItemCaptionColor',
  pOnGridDrawItemBitmap name 'Java_com_example_appgridcolorpickerdemo1_'
...
begin
  ...
  gjAppName:= 'com.example.appgridcolorpickerdemo1';
  gjClassName:= 'com/example/appgridcolorpickerdemo1/Controls';
