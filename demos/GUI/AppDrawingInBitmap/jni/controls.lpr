...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 9/26/2019 17:20:36]
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appdrawinginbitmap/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appdrawinginbitmap_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appdrawinginbitmap_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appdrawinginbitmap_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appdrawinginbitmap_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appdrawinginbitmap_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appdrawinginbitmap_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appdrawinginbitmap_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appdrawinginbitmap_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appdrawinginbitmap_Controls_pAppOnStop',
  ...
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appdrawinginbitmap_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appdrawinginbitmap_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appdrawinginbitmap_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appdrawinginbitmap_Controls'
    +'_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appdrawinginbitmap_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appdrawinginbitmap_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appdrawinginbitmap_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appdrawinginbitmap_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appdrawinginbitmap_Controls_'
    +'pOnClickGeneric',
  ...
  pOnDoubleClick name 
    'Java_org_lamw_appdrawinginbitmap_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appdrawinginbitmap_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appdrawinginbitmap_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appdrawinginbitmap_Controls_pOnEnter',
  pOnBackPressed name 
    'Java_org_lamw_appdrawinginbitmap_Controls_pOnBackPressed',
  pOnClose name 'Java_org_lamw_appdrawinginbitmap_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appdrawinginbitmap_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appdrawinginbitmap_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appdrawinginbitmap_Controls_'
...
begin
  ...
  gjAppName:= 'org.lamw.appdrawinginbitmap';
  gjClassName:= 'org/lamw/appdrawinginbitmap/Controls';
