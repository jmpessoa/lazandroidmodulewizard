...
uses
  Classes, SysUtils, AndroidWidget, Laz_And_Controls, cscreenshot;
...
begin
    jcScreenShot1.TakeScene(jTextView1.View);  // reference view

  if Self.IsRuntimePermissionGranted('android.permission.WRITE_EXTERNAL_STORAGE') then
     jcScreenShot1.SaveToFile('ScreenShotDemo1')   //Save to Picture Folder....
  else
