...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_applistviewdemo_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_applistviewdemo_Controls_'
    +'pAppOnNewIntent',
  ...
  pAppOnBackPressed name 'Java_com_example_applistviewdemo_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_applistviewdemo_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_applistviewdemo_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_applistviewdemo_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_applistviewdemo_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_applistviewdemo_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_applistviewdemo_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_applistviewdemo_Controls'
    +'_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_applistviewdemo_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_applistviewdemo_Controls_'
  ...
  pOnClickGeneric name 'Java_com_example_applistviewdemo_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_applistviewdemo_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_com_example_applistviewdemo_Controls_pOnDown',
  pOnClick name 'Java_com_example_applistviewdemo_Controls_pOnClick',
  pOnLongClick name 'Java_com_example_applistviewdemo_Controls_pOnLongClick',
  pOnDoubleClick name 
    'Java_com_example_applistviewdemo_Controls_pOnDoubleClick',
  ...
  pAppOnViewClick name 'Java_com_example_applistviewdemo_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_applistviewdemo_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_applistviewdemo_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_applistviewdemo_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_applistviewdemo_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_applistviewdemo_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_applistviewdemo_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_applistviewdemo_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_applistviewdemo_'
  ...
  pOnListViewDrawItemCaptionColor name 'Java_com_example_applistviewdemo_'
    +'Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBackgroundColor name 'Java_com_example_applistviewdemo_'
