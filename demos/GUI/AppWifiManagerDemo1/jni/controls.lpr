...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 7/25/2019 23:44:12]
...
{ Class:     org_lamw_appwifimanagerdemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appwifimanagerdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appwifimanagerdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appwifimanagerdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appwifimanagerdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appwifimanagerdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appwifimanagerdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appwifimanagerdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appwifimanagerdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appwifimanagerdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appwifimanagerdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appwifimanagerdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appwifimanagerdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appwifimanagerdemo1_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_appwifimanagerdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appwifimanagerdemo1_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appwifimanagerdemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appwifimanagerdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appwifimanagerdemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_org_lamw_appwifimanagerdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appwifimanagerdemo1_Controls'
    +'_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appwifimanagerdemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appwifimanagerdemo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appwifimanagerdemo1_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnClickWidgetItem name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pOnClickWidgetItem',
  pOnClickImageItem name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pOnClickImageItem',
  pOnClickCaptionItem name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pOnClickCaptionItem',
  pOnClickItemTextLeft name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pOnClickItemTextLeft',
  pOnClickItemTextCenter name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pOnClickItemTextCenter',
  pOnClickItemTextRight name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pOnClickItemTextRight',
  pOnListViewLongClickCaptionItem name 'Java_org_lamw_appwifimanagerdemo1_'
    +'Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_org_lamw_appwifimanagerdemo1_'
    +'Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBackgroundColor name 'Java_org_lamw_appwifimanagerdemo1_'
    +'Controls_pOnListViewDrawItemBackgroundColor',
  pOnListViewDrawItemBitmap name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_org_lamw_appwifimanagerdemo1_Controls_'
    +'pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_org_lamw_appwifimanagerdemo1_'
    +'Controls_pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_org_lamw_appwifimanagerdemo1_'
    +'Controls_pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetText name 'Java_org_lamw_appwifimanagerdemo1_'
    +'Controls_pOnListViewDrawItemWidgetText',
  pOnListViewDrawItemWidgetImage name 'Java_org_lamw_appwifimanagerdemo1_'
...
begin
  ...
  gjAppName:= 'org.lamw.appwifimanagerdemo1';
  gjClassName:= 'org/lamw/appwifimanagerdemo1/Controls';
