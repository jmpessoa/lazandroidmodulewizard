...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 2/7/2017 22:49:17]
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appwindowmanagerdemo1/Controls'
       );
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_appwindowmanagerdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appwindowmanagerdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appwindowmanagerdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appwindowmanagerdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name
    'Java_com_example_appwindowmanagerdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appwindowmanagerdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_com_example_appwindowmanagerdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name
    'Java_com_example_appwindowmanagerdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_appwindowmanagerdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appwindowmanagerdemo1_Controls_'
    +'pAppOnBackPressed',
  ...
  pAppOnCreateOptionsMenu name 'Java_com_example_appwindowmanagerdemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appwindowmanagerdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appwindowmanagerdemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appwindowmanagerdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appwindowmanagerdemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appwindowmanagerdemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_appwindowmanagerdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_appwindowmanagerdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_example_appwindowmanagerdemo1_Controls_'
    +'pOnClickGeneric',
  ...
  pAppOnViewClick name 'Java_com_example_appwindowmanagerdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appwindowmanagerdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appwindowmanagerdemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appwindowmanagerdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appwindowmanagerdemo1_Controls_'
    +'pOnLostFocus',
...
begin
  ...
  gjAppName:= 'com.example.appwindowmanagerdemo1';
  gjClassName:= 'com/example/appwindowmanagerdemo1/Controls';
