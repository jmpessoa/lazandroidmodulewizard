...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 03/11/17 20:03:50]
...
{ Class:     org_lamw_gltest1_Controls
  Method:    pOnTimer
  Signature: (J)V }
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/gltest1/Controls');
  end;
...
exports
  ...
  pOnTimer name 'Java_org_lamw_gltest1_Controls_pOnTimer',
  pOnGLRenderer2 name 'Java_org_lamw_gltest1_Controls_pOnGLRenderer2',
  pAppOnCreate name 'Java_org_lamw_gltest1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_gltest1_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_gltest1_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_gltest1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_gltest1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_gltest1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_gltest1_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_gltest1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_gltest1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_gltest1_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_gltest1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_gltest1_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_gltest1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_gltest1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_gltest1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_gltest1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_gltest1_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_gltest1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_gltest1_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_gltest1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_gltest1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_gltest1_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_gltest1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_gltest1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_gltest1_Controls_pOnLongClick',
  pOnChange name 'Java_org_lamw_gltest1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_gltest1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_gltest1_Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_gltest1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_gltest1_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_gltest1_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_gltest1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_gltest1_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_gltest1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_gltest1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_gltest1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_gltest1_Controls_pOnLayouting';
...
begin
  ...
  gjAppName:= 'org.lamw.gltest1';
  gjClassName:= 'org/lamw/gltest1/Controls';
