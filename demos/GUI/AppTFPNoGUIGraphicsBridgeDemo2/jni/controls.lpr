...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/apptfpnoguigraphicsbridgedemo2/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pOnClick',
  pOnChange name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pOnChange',
  pOnChanged name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pOnEnter',
  pOnClose name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_apptfpnoguigraphicsbridgedemo2_Controls_pOnPinchZoomGestureDetected';
