...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/apphorizontalscrollviewdemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_apphorizontalscrollviewdemo1_'
    +'Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_apphorizontalscrollviewdemo1_Controls'
    +'_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_apphorizontalscrollviewdemo1_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_apphorizontalscrollviewdemo'
    +'1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apphorizontalscrollviewdemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apphorizontalscrollviewdemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apphorizontalscrollviewdemo'
    +'1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_apphorizontalscrollviewdemo1'
    +'_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_apphorizontalscrollviewde'
    +'mo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_apphorizontalscrollviewdemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_apphorizontalscrollviewdemo'
    +'1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pOnTouch',
  pOnClickGeneric name 'Java_com_example_apphorizontalscrollviewdemo1_Controls'
    +'_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_apphorizontalscrollviewdemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pOnClick',
  pOnChange name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pOnEnter',
  pOnClose name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pOnClose',
  pAppOnViewClick name 'Java_com_example_apphorizontalscrollviewdemo1_Controls'
    +'_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_apphorizontalscrollviewdemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_apphorizontalscrollviewdemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_apphorizontalscrollviewdem'
    +'o1_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_apphorizontalscrollviewdemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_apphorizontalscrollviewdemo1_'
