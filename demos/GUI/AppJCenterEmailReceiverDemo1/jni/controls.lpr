...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 9/14/2019 15:03:23]
...
{ Class:     org_lamw_appjcenteremailreceiverdemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appjcenteremailreceiverdemo1_Controls
  Method:    pOnMailMessageRead
  Signature: (JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V }
procedure pOnMailMessageRead(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  position: JInt; Header: JString; Date: JString; Subject: JString; 
  ContentType: JString; ContentText: JString; Attachments: JString); cdecl;
begin
  Java_Event_pOnMailMessageRead(PEnv, this, TObject(pasobj), position, Header, 
    Date, Subject, ContentType, ContentText, Attachments);
end;

{ Class:     org_lamw_appjcenteremailreceiverdemo1_Controls
  Method:    pOnMailMessagesCount
  Signature: (JI)V }
procedure pOnMailMessagesCount(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  count: JInt); cdecl;
begin
  Java_Event_pOnMailMessagesCount(PEnv, this, TObject(pasobj), count);
end;
...
const NativeMethods: array[0..57] of JNINativeMethod = (
   ...
   (name: 'pOnMailMessageRead';
    signature: '(JILjava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava'
      +'/lang/String;Ljava/lang/String;Ljava/lang/String;)V';
    fnPtr: @pOnMailMessageRead; ),
   (name: 'pOnMailMessagesCount';
    signature: '(JI)V';
    fnPtr: @pOnMailMessagesCount; ),
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appjcenteremailreceiverdemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appjcenteremailreceiverdemo'
    +'1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 
    'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appjcenteremailreceiverdemo1'
    +'_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appjcenteremailreceiverdemo'
    +'1_Controls_pAppOnRequestPermissionResult',
  pOnMailMessageRead name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls'
    +'_pOnMailMessageRead',
  pOnMailMessagesCount name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pOnMailMessagesCount',
  pOnClickWidgetItem name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls'
    +'_pOnClickWidgetItem',
  pOnClickImageItem name 'Java_org_lamw_appjcenteremailreceiverdemo1_Controls_'
    +'pOnClickImageItem',
  pOnClickCaptionItem name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pOnClickCaptionItem',
  pOnClickItemTextLeft name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pOnClickItemTextLeft',
  pOnClickItemTextCenter name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pOnClickItemTextCenter',
  pOnClickItemTextRight name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pOnClickItemTextRight',
  pOnListViewLongClickCaptionItem name 'Java_org_lamw_appjcenteremailreceiverde'
    +'mo1_Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_org_lamw_appjcenteremailreceiverde'
    +'mo1_Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBackgroundColor name 'Java_org_lamw_appjcenteremailreceive'
    +'rdemo1_Controls_pOnListViewDrawItemBackgroundColor',
  pOnListViewDrawItemBitmap name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_org_lamw_appjcenteremailreceiverdemo1_'
    +'Controls_pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_org_lamw_appjcenteremailreceiverdemo'
    +'1_Controls_pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_org_lamw_appjcenteremailreceive'
    +'rdemo1_Controls_pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetText name 'Java_org_lamw_appjcenteremailreceiverdemo'
    +'1_Controls_pOnListViewDrawItemWidgetText',
  pOnListViewDrawItemWidgetImage name 'Java_org_lamw_appjcenteremailreceiverdem'
    +'o1_Controls_pOnListViewDrawItemWidgetImage';
...
begin
  ...
  gjAppName:= 'org.lamw.appjcenteremailreceiverdemo1';
  gjClassName:= 'org/lamw/appjcenteremailreceiverdemo1/Controls';
