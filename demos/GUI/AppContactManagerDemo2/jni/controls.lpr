...
exports
  ...
  pAppOnCreate name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_com_example_appcontactmanagerdemo2_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appcontactmanagerdemo2_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appcontactmanagerdemo2_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appcontactmanagerdemo2_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appcontactmanagerdemo2_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appcontactmanagerdemo2_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appcontactmanagerdemo2_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appcontactmanagerdemo2_'
  ...
  pOnClickGeneric name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_com_example_appcontactmanagerdemo2_Controls_pOnDown',
  pOnClick name 'Java_com_example_appcontactmanagerdemo2_Controls_pOnClick',
  pOnLongClick name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pOnDoubleClick',
  ...
  pAppOnViewClick name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appcontactmanagerdemo2_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appcontactmanagerdemo2_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appcontactmanagerdemo2_Controls'
    +'_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_appcontactmanagerdemo2_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnContactManagerContactsExecuted name 'Java_com_example_appcontactmanagerdem'
    +'o2_Controls_pOnContactManagerContactsExecuted',
  pOnContactManagerContactsProgress name 'Java_com_example_appcontactmanagerdem'
    +'o2_Controls_pOnContactManagerContactsProgress',
  pOnClickWidgetItem name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_com_example_appcontactmanagerdemo2_Controls_'
    +'pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_com_example_appcontactmanagerdemo'
    +'2_Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_com_example_appcontactmanagerdemo'
    +'2_Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_com_example_appcontactmanagerdemo2_'
    +'Controls_pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_com_example_appcontactmanagerdemo2_Controls'
    +'_pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_com_example_appcontactmanagerdemo2_'
    +'Controls_pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_com_example_appcontactmanagerde'
    +'mo2_Controls_pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetImage name 'Java_com_example_appcontactmanagerdemo2'
...
(*last [smart] upgrade: 7/3/2016 23:33:13*)
