...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 5/2/2019 1:30:58]
...
{ Class:     org_lamw_appcompatcontinuousscrollableimageviewdemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appcompatcontinuousscrollableimage'
       +'viewdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1'
    +'_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appcompatcontinuousscrollableimageviewd'
    +'emo1_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdem'
    +'o1_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo'
    +'1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1_'
    +'Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo'
    +'1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1'
    +'_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1_'
    +'Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1_'
    +'Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appcompatcontinuousscrollableimageviewd'
    +'emo1_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1'
    +'_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appcompatcontinuousscrollablei'
    +'mageviewdemo1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appcompatcontinuousscrollableimagevi'
    +'ewdemo1_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appcompatcontinuousscrollableimag'
    +'eviewdemo1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appcompatcontinuousscrollableim'
    +'ageviewdemo1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appcompatcontinuousscrollableima'
    +'geviewdemo1_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appcompatcontinuousscrollabl'
    +'eimageviewdemo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appcompatcontinuousscrollableimag'
    +'eviewdemo1_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appcompatcontinuousscrollablei'
    +'mageviewdemo1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1_'
    +'Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1_'
    +'Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdem'
    +'o1_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appcompatcontinuousscrollableimagevi'
    +'ewdemo1_Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1_'
    +'Controls_pOnDown',
  pOnClick name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1_'
    +'Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1'
    +'_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo'
    +'1_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1_'
    +'Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1_'
    +'Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1_'
    +'Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1_'
    +'Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdem'
    +'o1_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appcompatcontinuousscrollableimagevie'
    +'wdemo1_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appcompatcontinuousscrollableimag'
    +'eviewdemo1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appcompatcontinuousscrollable'
    +'imageviewdemo1_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1'
    +'_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appcompatcontinuousscrollableimagev'
    +'iewdemo1_Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appcompatcontinuousscrollableimagevi'
    +'ewdemo1_Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appcompatcontinuousscrollableimageviewdemo1'
    +'_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appcompatcontinuousscrollab'
    +'leimageviewdemo1_Controls_pAppOnRequestPermissionResult';
...
begin
  ...
  gjAppName:= 'org.lamw.appcompatcontinuousscrollableimageviewdemo1';
  gjClassName:= 'org/lamw/appcompatcontinuousscrollableimageviewdemo1/Controls';
