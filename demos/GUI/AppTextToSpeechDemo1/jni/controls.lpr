...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 3/27/2017 22:45:30]
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/apptexttospeechdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_apptexttospeechdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_apptexttospeechdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_apptexttospeechdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name
    'Java_org_lamw_apptexttospeechdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_apptexttospeechdemo1_Controls_pAppOnPause',
  pAppOnRestart name
    'Java_org_lamw_apptexttospeechdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_apptexttospeechdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_apptexttospeechdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_apptexttospeechdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_apptexttospeechdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_apptexttospeechdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_apptexttospeechdemo1_Controls'
    +'_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_apptexttospeechdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_apptexttospeechdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_apptexttospeechdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_apptexttospeechdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_apptexttospeechdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_apptexttospeechdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_apptexttospeechdemo1_Controls'
    +'_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_apptexttospeechdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_apptexttospeechdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_apptexttospeechdemo1_Controls_'
    +'pOnClickGeneric',
  ...
  pOnClose name 'Java_org_lamw_apptexttospeechdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_apptexttospeechdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_apptexttospeechdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_apptexttospeechdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_apptexttospeechdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_apptexttospeechdemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_apptexttospeechdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_apptexttospeechdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_apptexttospeechdemo1_Controls_pOnLayouting';
...
begin
  ...
  gjAppName:= 'org.lamw.apptexttospeechdemo1';
  gjClassName:= 'org/lamw/apptexttospeechdemo1/Controls';
