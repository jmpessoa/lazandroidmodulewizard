...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 2/17/2018 1:04:07]
...
{ Class:     ml_smartware_appdbgridviewdemo1_Controls
  Method:    pOnClickDBListItem
  Signature: (JILjava/lang/String;)V }
procedure pOnClickDBListItem(PEnv: PJNIEnv; this: JObject; pasobj: JLong;
  position: JInt; caption: JString); cdecl;
begin
  Java_Event_pOnClickDBListItem(PEnv, this, TObject(pasobj), position, caption);
end;

{ Class:     ml_smartware_appdbgridviewdemo1_Controls
  Method:    pOnLongClickDBListItem
  Signature: (JILjava/lang/String;)V }
procedure pOnLongClickDBListItem(PEnv: PJNIEnv; this: JObject; pasobj: JLong;
  position: JInt; caption: JString); cdecl;
begin
  Java_Event_pOnLongClickDBListItem(PEnv, this, TObject(pasobj), position,
    caption);
end;
...
const NativeMethods: array[0..41] of JNINativeMethod = (
   ...
   (name: 'pOnClickDBListItem';
    signature: '(JILjava/lang/String;)V';
    fnPtr: @pOnClickDBListItem; ),
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'ml/smartware/appdbgridviewdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name
    'Java_ml_smartware_appdbgridviewdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_ml_smartware_appdbgridviewdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name
    'Java_ml_smartware_appdbgridviewdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_ml_smartware_appdbgridviewdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_ml_smartware_appdbgridviewdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name
    'Java_ml_smartware_appdbgridviewdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_ml_smartware_appdbgridviewdemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_ml_smartware_appdbgridviewdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_ml_smartware_appdbgridviewdemo1_Controls'
    +'_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_ml_smartware_appdbgridviewdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_ml_smartware_appdbgridviewdemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_ml_smartware_appdbgridviewdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_ml_smartware_appdbgridviewdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
    +'pOnClickGeneric',
  ...
  pAppOnViewClick name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_ml_smartware_appdbgridviewdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name
    'Java_ml_smartware_appdbgridviewdemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
  ...
  pOnClickDBListItem name 'Java_ml_smartware_appdbgridviewdemo1_Controls_'
    +'pOnClickDBListItem',
...
begin
  ...
  gjAppName:= 'ml.smartware.appdbgridviewdemo1';
  gjClassName:= 'ml/smartware/appdbgridviewdemo1/Controls';
