...
zipalign -v -p 4 /android/workspace/AppCompatBasicDemo1/build/outputs/apk/release/AppCompatBasicDemo1-universal-release-unsigned.apk /android/workspace/AppCompatBasicDemo1/build/outputs/apk/release/AppCompatBasicDemo1-universal-release-unsigned-aligned.apk
