...
zipalign -v -p 4 C:\android\workspace\AppCompatBasicDemo1\build\outputs\apk\release\AppCompatBasicDemo1-armeabi-v7a-release-unsigned.apk C:\android\workspace\AppCompatBasicDemo1\build\outputs\apk\release\AppCompatBasicDemo1-armeabi-v7a-release-unsigned-aligned.apk
