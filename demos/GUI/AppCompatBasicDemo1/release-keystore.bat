...
keytool -genkey -v -keystore appcompatbasicdemo1-release.keystore -alias appcompatbasicdemo1.keyalias -keyalg RSA -keysize 2048 -validity 10000 < C:\android\workspace\AppCompatBasicDemo1\keytool_input.txt
:Error
echo off
cls
echo.
