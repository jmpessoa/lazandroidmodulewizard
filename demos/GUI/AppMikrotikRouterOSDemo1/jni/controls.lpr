...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 4/16/2019 19:34:46]
...
{ Class:     org_lamw_appmikrotikrouterosdemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appmikrotikrouterosdemo1/Controls'
       );
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 
    'Java_org_lamw_appmikrotikrouterosdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 
    'Java_org_lamw_appmikrotikrouterosdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appmikrotikrouterosdemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appmikrotikrouterosdemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appmikrotikrouterosdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appmikrotikrouterosdemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appmikrotikrouterosdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appmikrotikrouterosdemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appmikrotikrouterosdemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appmikrotikrouterosdemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appmikrotikrouterosdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appmikrotikrouterosdemo1_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnClickWidgetItem name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_org_lamw_appmikrotikrouterosdemo1'
    +'_Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_org_lamw_appmikrotikrouterosdemo1'
    +'_Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_org_lamw_appmikrotikrouterosdemo1_'
    +'Controls_pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_org_lamw_appmikrotikrouterosdemo1_Controls_'
    +'pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_org_lamw_appmikrotikrouterosdemo1_'
    +'Controls_pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_org_lamw_appmikrotikrouterosdem'
    +'o1_Controls_pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetText name 'Java_org_lamw_appmikrotikrouterosdemo1_'
    +'Controls_pOnListViewDrawItemWidgetText',
  pOnListViewDrawItemWidgetImage name 'Java_org_lamw_appmikrotikrouterosdemo1_'
...
begin
  ...
  gjAppName:= 'org.lamw.appmikrotikrouterosdemo1';
  gjClassName:= 'org/lamw/appmikrotikrouterosdemo1/Controls';
