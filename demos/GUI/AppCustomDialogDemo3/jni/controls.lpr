...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 5/21/2023 19:46:42]
...
{ Class:     org_lamw_appcustomdialogdemo3_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     rc := RegisterNativeMethods(curEnv, 'org/lamw/appcustomdialogdemo3/'
       +'Controls');
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appcustomdialogdemo3_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 
    'Java_org_lamw_appcustomdialogdemo3_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appcustomdialogdemo3_Controls_pAppOnPause',
  pAppOnRestart name 
    'Java_org_lamw_appcustomdialogdemo3_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appcustomdialogdemo3_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appcustomdialogdemo3_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appcustomdialogdemo3_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appcustomdialogdemo3_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_appcustomdialogdemo3_Controls'
    +'_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appcustomdialogdemo3_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appcustomdialogdemo3_Controls'
    +'_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appcustomdialogdemo3_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appcustomdialogdemo3_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appcustomdialogdemo3_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_appcustomdialogdemo3_Controls_pOnUp',
  pOnClick name 'Java_org_lamw_appcustomdialogdemo3_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appcustomdialogdemo3_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appcustomdialogdemo3_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appcustomdialogdemo3_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appcustomdialogdemo3_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_org_lamw_appcustomdialogdemo3_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appcustomdialogdemo3_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appcustomdialogdemo3_Controls_pOnLostFocus',
  pOnFocus name 'Java_org_lamw_appcustomdialogdemo3_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appcustomdialogdemo3_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appcustomdialogdemo3_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pOnRunOnUiThread',
  pOnCustomDialogShow name 'Java_org_lamw_appcustomdialogdemo3_Controls_'
    +'pOnCustomDialogShow',
  pOnCustomDialogBackKeyPressed name 'Java_org_lamw_appcustomdialogdemo3_'
...
begin
  ...
  gjAppName:= 'org.lamw.appcustomdialogdemo3';
  gjClassName:= 'org/lamw/appcustomdialogdemo3/Controls';
