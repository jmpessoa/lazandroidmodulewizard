...
keytool -genkey -v -keystore appcustomdialogdemo3-release.keystore -alias appcustomdialogdemo3.keyalias -keyalg RSA -keysize 2048 -validity 10000 < C:\android\workspace\AppCustomDialogDemo3\keytool_input.txt
:Error
echo off
cls
echo.
