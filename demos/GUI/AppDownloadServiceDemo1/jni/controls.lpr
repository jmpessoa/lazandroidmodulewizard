...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appdownloadservicedemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name
    'Java_com_example_appdownloadservicedemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appdownloadservicedemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appdownloadservicedemo1_Controls'
    +'_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appdownloadservicedemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appdownloadservicedemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appdownloadservicedemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appdownloadservicedemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appdownloadservicedemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appdownloadservicedemo1_'
  ...
  pOnClickGeneric name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appdownloadservicedemo1_Controls'
    +'_pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_appdownloadservicedemo1_Controls_pOnClick',
  pOnLongClick name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pOnLongClick',
  pOnChange name 'Java_com_example_appdownloadservicedemo1_Controls_pOnChange',
  pOnChanged name
    'Java_com_example_appdownloadservicedemo1_Controls_pOnChanged',
  ...
  pAppOnViewClick name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appdownloadservicedemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appdownloadservicedemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appdownloadservicedemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appdownloadservicedemo1_Controls'
    +'_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appdownloadservicedemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_appdownloadservicedemo1'
    +'_Controls_pAppOnRequestPermissionResult',
  pOnBroadcastReceiver name 'Java_com_example_appdownloadservicedemo1_Controls'
