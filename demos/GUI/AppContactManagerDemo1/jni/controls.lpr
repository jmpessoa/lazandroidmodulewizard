...
exports
  ...
  pAppOnCreate name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_com_example_appcontactmanagerdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appcontactmanagerdemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appcontactmanagerdemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appcontactmanagerdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appcontactmanagerdemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appcontactmanagerdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appcontactmanagerdemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appcontactmanagerdemo1_'
  ...
  pOnClickGeneric name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnDown',
  pOnClick name 'Java_com_example_appcontactmanagerdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pOnDoubleClick',
  ...
  pAppOnViewClick name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appcontactmanagerdemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appcontactmanagerdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appcontactmanagerdemo1_Controls'
    +'_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appcontactmanagerdemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_appcontactmanagerdemo1_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnAsyncEventDoInBackground name 'Java_com_example_appcontactmanagerdemo1_'
    +'Controls_pOnAsyncEventDoInBackground',
  pOnAsyncEventProgressUpdate name 'Java_com_example_appcontactmanagerdemo1_'
    +'Controls_pOnAsyncEventProgressUpdate',
  pOnAsyncEventPreExecute name 'Java_com_example_appcontactmanagerdemo1_'
    +'Controls_pOnAsyncEventPreExecute',
  pOnAsyncEventPostExecute name 'Java_com_example_appcontactmanagerdemo1_'
    +'Controls_pOnAsyncEventPostExecute',
  pOnContactManagerContactsExecuted name 'Java_com_example_appcontactmanagerdem'
    +'o1_Controls_pOnContactManagerContactsExecuted',
  pOnContactManagerContactsProgress name 'Java_com_example_appcontactmanagerdem'
    +'o1_Controls_pOnContactManagerContactsProgress';
...
(*last [smart] upgrade: 7/3/2016 23:30:19*)
