...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 05/11/2020 8:55:04]
...
{ Class:     org_lamw_appcompactfileprovider_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appcompactfileprovider/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 
    'Java_org_lamw_appcompactfileprovider_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appcompactfileprovider_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 
    'Java_org_lamw_appcompactfileprovider_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appcompactfileprovider_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appcompactfileprovider_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 
    'Java_org_lamw_appcompactfileprovider_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_appcompactfileprovider_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appcompactfileprovider_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appcompactfileprovider_Controls'
    +'_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appcompactfileprovider_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appcompactfileprovider_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appcompactfileprovider_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appcompactfileprovider_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appcompactfileprovider_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_appcompactfileprovider_Controls_pOnUp',
  pOnClick name 'Java_org_lamw_appcompactfileprovider_Controls_pOnClick',
  pOnLongClick name 
    'Java_org_lamw_appcompactfileprovider_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appcompactfileprovider_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appcompactfileprovider_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appcompactfileprovider_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_org_lamw_appcompactfileprovider_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appcompactfileprovider_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 
    'Java_org_lamw_appcompactfileprovider_Controls_pOnLostFocus',
  pOnFocus name 'Java_org_lamw_appcompactfileprovider_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appcompactfileprovider_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 
    'Java_org_lamw_appcompactfileprovider_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appcompactfileprovider_'
...
begin
  ...
  gjAppName:= 'org.lamw.appcompactfileprovider';
  gjClassName:= 'org/lamw/appcompactfileprovider/Controls';
