...
public class jFrameLayout extends FrameLayout /*dummy*/ { //please, fix what GUI object will be extended!
   ...
   public jFrameLayout(Controls _ctrls, long _Self) { //Add more others news "_xxx" params if needed!
