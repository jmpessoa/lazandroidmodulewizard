...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 12/18/2019 23:44:23]
...
{ Class:     org_lamw_appcompatnavigationdrawerdemo2_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appcompatnavigationdrawerdemo2/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appcompatnavigationdrawerdemo2_'
    +'Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appcompatnavigationdrawerdemo2_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_appcompatnavigationdrawerdemo2_'
    +'Controls_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_appcompatnavigationdrawerdemo'
    +'2_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appcompatnavigationdrawerdemo2_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appcompatnavigationdrawerdemo2_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appcompatnavigationdrawerdemo2'
    +'_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appcompatnavigationdrawerdemo2_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appcompatnavigationdrawerdem'
    +'o2_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appcompatnavigationdrawerdemo2_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appcompatnavigationdrawerdemo'
    +'2_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_pOnDraw',
  pOnTouch name 
    'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appcompatnavigationdrawerdemo2_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_pOnUp',
  pOnClick name 
    'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pOnChanged',
  pOnEnter name 
    'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pOnBackPressed',
  pOnClose name 
    'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appcompatnavigationdrawerdemo2_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appcompatnavigationdrawerdemo2_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appcompatnavigationdrawerdemo'
    +'2_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pOnLostFocus',
  pOnFocus name 
    'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appcompatnavigationdrawerdemo2_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appcompatnavigationdrawerdemo2_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appcompatnavigationdrawerdemo2_Controls_'
    +'pOnLayouting',
  ...
  pOnImageViewPopupItemSelected name 'Java_org_lamw_appcompatnavigationdrawerde'
    +'mo2_Controls_pOnImageViewPopupItemSelected',
  pOnClickNavigationViewItem name 'Java_org_lamw_appcompatnavigationdrawerdemo'
    +'2_Controls_pOnClickNavigationViewItem';
...
begin
  ...
  gjAppName:= 'org.lamw.appcompatnavigationdrawerdemo2';
  gjClassName:= 'org/lamw/appcompatnavigationdrawerdemo2/Controls';
