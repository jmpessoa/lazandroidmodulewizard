...
zipalign -v -p 4 /fpcupdeluxe/ccr/lamw/demos/GUI/AppBGRABitmapDemo1/build/outputs/apk/release/AppBGRABitmapDemo1-universal-release-unsigned.apk /fpcupdeluxe/ccr/lamw/demos/GUI/AppBGRABitmapDemo1/build/outputs/apk/release/AppBGRABitmapDemo1-universal-release-unsigned-aligned.apk
