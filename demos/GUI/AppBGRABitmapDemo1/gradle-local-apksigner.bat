...
zipalign -v -p 4 C:\fpcupdeluxe\ccr\lamw\demos\GUI\AppBGRABitmapDemo1\build\outputs\apk\release\AppBGRABitmapDemo1-armeabi-v7a-release-unsigned.apk C:\fpcupdeluxe\ccr\lamw\demos\GUI\AppBGRABitmapDemo1\build\outputs\apk\release\AppBGRABitmapDemo1-armeabi-v7a-release-unsigned-aligned.apk
