...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 8/31/2018 22:01:08]
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/apphttpclientdemo3/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_apphttpclientdemo3_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_apphttpclientdemo3_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_apphttpclientdemo3_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_apphttpclientdemo3_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_apphttpclientdemo3_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_apphttpclientdemo3_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_apphttpclientdemo3_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_apphttpclientdemo3_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_apphttpclientdemo3_Controls'
    +'_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_apphttpclientdemo3_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_apphttpclientdemo3_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_apphttpclientdemo3_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_apphttpclientdemo3_Controls_pOnLongClick',
  pOnChange name 'Java_org_lamw_apphttpclientdemo3_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_apphttpclientdemo3_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_apphttpclientdemo3_Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_apphttpclientdemo3_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_apphttpclientdemo3_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_apphttpclientdemo3_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_apphttpclientdemo3_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnHttpClientContentResult name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pOnHttpClientContentResult',
  pOnHttpClientCodeResult name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pOnHttpClientCodeResult',
  pOnHttpClientUploadProgress name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pOnHttpClientUploadProgress',
  pOnHttpClientUploadFinished name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pOnHttpClientUploadFinished',
  pOnFileSelected name 'Java_org_lamw_apphttpclientdemo3_Controls_'
    +'pOnFileSelected';
...
begin
  ...
  gjAppName:= 'org.lamw.apphttpclientdemo3';
  gjClassName:= 'org/lamw/apphttpclientdemo3/Controls';
