...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name
    'Java_com_example_appsharefiledemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appsharefiledemo1_Controls_pAppOnPause',
  pAppOnRestart name
    'Java_com_example_appsharefiledemo1_Controls_pAppOnRestart',
  ...
  pAppOnBackPressed name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appsharefiledemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appsharefiledemo1_Controls'
    +'_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appsharefiledemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appsharefiledemo1_Controls'
  ...
  pOnClickGeneric name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_appsharefiledemo1_Controls_pOnClick',
  pOnLongClick name 'Java_com_example_appsharefiledemo1_Controls_pOnLongClick',
  ...
  pAppOnViewClick name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appsharefiledemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appsharefiledemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appsharefiledemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appsharefiledemo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_appsharefiledemo1_'
...
(*last [smart] upgrade: 7/11/2016 3:00:39*)
