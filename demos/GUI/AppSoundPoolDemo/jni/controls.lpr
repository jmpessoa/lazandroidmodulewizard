{hint: save all files to location: C:\Temp\AppSoundPoolDemo\jni\ }
library controls;  //[by LAMW: Lazarus Android Module Wizard: 12/08/2019 18:35:01]
...
{ Class:     org_lamw_appsoundpooldemo_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appsoundpooldemo_Controls
  Method:    pOnSoundPoolLoadComplete
  Signature: (JII)V }
procedure pOnSoundPoolLoadComplete(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  streamId: JInt; status: JInt); cdecl;
begin
  Java_Event_pOnSoundPoolLoadComplete(PEnv, this, TObject(pasobj), streamId, 
    status);
end;
...
const NativeMethods: array[0..41] of JNINativeMethod = (
   ...
   (name: 'pOnSoundPoolLoadComplete';
    signature: '(JII)V';
    fnPtr: @pOnSoundPoolLoadComplete; )
);
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appsoundpooldemo/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appsoundpooldemo_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 
    'Java_org_lamw_appsoundpooldemo_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appsoundpooldemo_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appsoundpooldemo_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appsoundpooldemo_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appsoundpooldemo_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appsoundpooldemo_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appsoundpooldemo_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appsoundpooldemo_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appsoundpooldemo_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appsoundpooldemo_Controls_pOnTouch',
  pOnClickGeneric name 
    'Java_org_lamw_appsoundpooldemo_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appsoundpooldemo_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_appsoundpooldemo_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appsoundpooldemo_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appsoundpooldemo_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appsoundpooldemo_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appsoundpooldemo_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appsoundpooldemo_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appsoundpooldemo_Controls_pOnBackPressed',
  pOnClose name 'Java_org_lamw_appsoundpooldemo_Controls_pOnClose',
  pAppOnViewClick name 
    'Java_org_lamw_appsoundpooldemo_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appsoundpooldemo_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appsoundpooldemo_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pAppOnRequestPermissionResult',
  pOnSoundPoolLoadComplete name 'Java_org_lamw_appsoundpooldemo_Controls_'
    +'pOnSoundPoolLoadComplete';
...
begin
  ...
  gjAppName:= 'org.lamw.appsoundpooldemo';
  gjClassName:= 'org/lamw/appsoundpooldemo/Controls';
