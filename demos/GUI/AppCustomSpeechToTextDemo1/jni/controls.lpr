...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 7/13/2020 15:38:53]
...
{ Class:     org_lamw_appcustomspeechtotextdemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appcustomspeechtotextdemo1_Controls
  Method:    pOnBeginOfSpeech
  Signature: (J)V }
procedure pOnBeginOfSpeech(PEnv: PJNIEnv; this: JObject; pasobj: JLong); cdecl;
begin
  Java_Event_pOnBeginOfSpeech(PEnv, this, TObject(pasobj));
end;

{ Class:     org_lamw_appcustomspeechtotextdemo1_Controls
  Method:    pOnSpeechBufferReceived
  Signature: (J[B)V }
procedure pOnSpeechBufferReceived(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  txtBytes: JByteArray); cdecl;
begin
  Java_Event_pOnSpeechBufferReceived(PEnv, this, TObject(pasobj), txtBytes);
end;

{ Class:     org_lamw_appcustomspeechtotextdemo1_Controls
  Method:    pOnEndOfSpeech
  Signature: (J)V }
procedure pOnEndOfSpeech(PEnv: PJNIEnv; this: JObject; pasobj: JLong); cdecl;
begin
  Java_Event_pOnEndOfSpeech(PEnv, this, TObject(pasobj));
end;

{ Class:     org_lamw_appcustomspeechtotextdemo1_Controls
  Method:    pOnSpeechResults
  Signature: (JLjava/lang/String;)V }
procedure pOnSpeechResults(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  txt: JString); cdecl;
begin
  Java_Event_pOnSpeechResults(PEnv, this, TObject(pasobj), txt);
end;
...
const NativeMethods: array[0..46] of JNINativeMethod = (
   ...
   (name: 'pOnBeginOfSpeech';
    signature: '(J)V';
    fnPtr: @pOnBeginOfSpeech; ),
   (name: 'pOnSpeechBufferReceived';
    signature: '(J[B)V';
    fnPtr: @pOnSpeechBufferReceived; ),
   (name: 'pOnEndOfSpeech';
    signature: '(J)V';
    fnPtr: @pOnEndOfSpeech; ),
   (name: 'pOnSpeechResults';
    signature: '(JLjava/lang/String;)V';
    fnPtr: @pOnSpeechResults; )
);
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appcustomspeechtotextdemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 
    'Java_org_lamw_appcustomspeechtotextdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_appcustomspeechtotextdemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls'
    +'_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appcustomspeechtotextdemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appcustomspeechtotextdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appcustomspeechtotextdemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appcustomspeechtotextdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appcustomspeechtotextdemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appcustomspeechtotextdemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls'
    +'_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_pOnUp',
  pOnClick name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_pOnChange',
  pOnChanged name 
    'Java_org_lamw_appcustomspeechtotextdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appcustomspeechtotextdemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appcustomspeechtotextdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appcustomspeechtotextdemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls'
    +'_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appcustomspeechtotextdemo1'
    +'_Controls_pAppOnRequestPermissionResult',
  pOnBeginOfSpeech name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pOnBeginOfSpeech',
  pOnSpeechBufferReceived name 'Java_org_lamw_appcustomspeechtotextdemo1_'
    +'Controls_pOnSpeechBufferReceived',
  pOnEndOfSpeech name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pOnEndOfSpeech',
  pOnSpeechResults name 'Java_org_lamw_appcustomspeechtotextdemo1_Controls_'
    +'pOnSpeechResults';
...
begin
  ...
  gjAppName:= 'org.lamw.appcustomspeechtotextdemo1';
  gjClassName:= 'org/lamw/appcustomspeechtotextdemo1/Controls';
