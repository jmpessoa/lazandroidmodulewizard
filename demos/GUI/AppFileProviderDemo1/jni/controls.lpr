...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 1/15/2017 22:47:52]
...
{ Class:     com_example_appfileproviderdemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appfileproviderdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appfileproviderdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_appfileproviderdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_appfileproviderdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appfileproviderdemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appfileproviderdemo1_Controls'
    +'_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appfileproviderdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appfileproviderdemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appfileproviderdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appfileproviderdemo1_Controls'
    +'_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appfileproviderdemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_appfileproviderdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_appfileproviderdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_appfileproviderdemo1_Controls_pOnClick',
  pOnChange name 'Java_com_example_appfileproviderdemo1_Controls_pOnChange',
  pOnChanged name 'Java_com_example_appfileproviderdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_appfileproviderdemo1_Controls_pOnEnter',
  pOnClose name 'Java_com_example_appfileproviderdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appfileproviderdemo1_Controls'
    +'_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appfileproviderdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appfileproviderdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appfileproviderdemo1_Controls_'
...
begin
  ...
  gjAppName:= 'com.example.appfileproviderdemo1';
  gjClassName:= 'com/example/appfileproviderdemo1/Controls';
