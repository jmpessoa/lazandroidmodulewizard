...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 10/10/2019 19:43:58]
...
{ Class:     org_lamw_appftpclientdemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appftpclientdemo1_Controls
  Method:    pOnFTPClientTryConnect
  Signature: (JZ)V }
procedure pOnFTPClientTryConnect(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  success: JBoolean); cdecl;
begin
  Java_Event_pOnFTPClientTryConnect(PEnv, this, TObject(pasobj), success);
end;

{ Class:     org_lamw_appftpclientdemo1_Controls
  Method:    pOnFTPClientDownloadFinished
  Signature: (JLjava/lang/String;Z)V }
procedure pOnFTPClientDownloadFinished(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; destination: JString; success: JBoolean); cdecl;
begin
  Java_Event_pOnFTPClientDownloadFinished(PEnv, this, TObject(pasobj), 
    destination, success);
end;

{ Class:     org_lamw_appftpclientdemo1_Controls
  Method:    pOnFTPClientUploadFinished
  Signature: (JLjava/lang/String;Z)V }
procedure pOnFTPClientUploadFinished(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; destination: JString; success: JBoolean); cdecl;
begin
  Java_Event_pOnFTPClientUploadFinished(PEnv, this, TObject(pasobj), 
    destination, success);
end;

{ Class:     org_lamw_appftpclientdemo1_Controls
  Method:    pOnFTPClientListing
  Signature: (JLjava/lang/String;Ljava/lang/String;I)V }
procedure pOnFTPClientListing(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  url: JString; fileName: JString; fileSize: JInt); cdecl;
begin
  Java_Event_pOnFTPClientListing(PEnv, this, TObject(pasobj), url, fileName, 
    fileSize);
end;

{ Class:     org_lamw_appftpclientdemo1_Controls
  Method:    pOnFTPClientListed
  Signature: (JI)V }
procedure pOnFTPClientListed(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  count: JInt); cdecl;
begin
  Java_Event_pOnFTPClientListed(PEnv, this, TObject(pasobj), count);
end;
...
const NativeMethods: array[0..60] of JNINativeMethod = (
   ...
   (name: 'pOnFTPClientTryConnect';
    signature: '(JZ)V';
    fnPtr: @pOnFTPClientTryConnect; ),
   (name: 'pOnFTPClientDownloadFinished';
    signature: '(JLjava/lang/String;Z)V';
    fnPtr: @pOnFTPClientDownloadFinished; ),
   (name: 'pOnFTPClientUploadFinished';
    signature: '(JLjava/lang/String;Z)V';
    fnPtr: @pOnFTPClientUploadFinished; ),
   (name: 'pOnFTPClientListing';
    signature: '(JLjava/lang/String;Ljava/lang/String;I)V';
    fnPtr: @pOnFTPClientListing; ),
   (name: 'pOnFTPClientListed';
    signature: '(JI)V';
    fnPtr: @pOnFTPClientListed; ),
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appftpclientdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appftpclientdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appftpclientdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appftpclientdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appftpclientdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appftpclientdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appftpclientdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appftpclientdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appftpclientdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appftpclientdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appftpclientdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appftpclientdemo1_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_appftpclientdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appftpclientdemo1_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appftpclientdemo1_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appftpclientdemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appftpclientdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appftpclientdemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appftpclientdemo1_Controls_pOnBackPressed',
  pOnClose name 'Java_org_lamw_appftpclientdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appftpclientdemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appftpclientdemo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appftpclientdemo1_Controls'
    +'_pAppOnRequestPermissionResult',
  pOnFTPClientTryConnect name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnFTPClientTryConnect',
  pOnFTPClientDownloadFinished name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnFTPClientDownloadFinished',
  pOnFTPClientUploadFinished name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnFTPClientUploadFinished',
  pOnFTPClientListing name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnFTPClientListing',
  pOnFTPClientListed name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnFTPClientListed',
  pOnClickWidgetItem name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnClickWidgetItem',
  pOnClickImageItem name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnClickImageItem',
  pOnClickCaptionItem name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnClickCaptionItem',
  pOnClickItemTextLeft name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnClickItemTextLeft',
  pOnClickItemTextCenter name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnClickItemTextCenter',
  pOnClickItemTextRight name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnClickItemTextRight',
  pOnListViewLongClickCaptionItem name 'Java_org_lamw_appftpclientdemo1_'
    +'Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_org_lamw_appftpclientdemo1_'
    +'Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBackgroundColor name 'Java_org_lamw_appftpclientdemo1_'
    +'Controls_pOnListViewDrawItemBackgroundColor',
  pOnListViewDrawItemBitmap name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_org_lamw_appftpclientdemo1_Controls_'
    +'pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_org_lamw_appftpclientdemo1_Controls'
    +'_pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_org_lamw_appftpclientdemo1_'
    +'Controls_pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetText name 'Java_org_lamw_appftpclientdemo1_Controls'
    +'_pOnListViewDrawItemWidgetText',
  pOnListViewDrawItemWidgetImage name 'Java_org_lamw_appftpclientdemo1_'
...
begin
  ...
  gjAppName:= 'org.lamw.appftpclientdemo1';
  gjClassName:= 'org/lamw/appftpclientdemo1/Controls';
