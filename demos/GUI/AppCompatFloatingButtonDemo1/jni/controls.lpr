...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 2/11/2018 20:11:25]
...
{ Class:     org_lamw_appcompatfloatingbuttondemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appcompatfloatingbuttondemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appcompatfloatingbuttondemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appcompatfloatingbuttondemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appcompatfloatingbuttondemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appcompatfloatingbuttondemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appcompatfloatingbuttondemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appcompatfloatingbuttondemo'
    +'1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appcompatfloatingbuttondemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appcompatfloatingbuttondemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appcompatfloatingbuttondemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pOnLongClick',
  pOnChange name
    'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appcompatfloatingbuttondemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appcompatfloatingbuttondemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appcompatfloatingbuttondemo1'
    +'_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appcompatfloatingbuttondemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appcompatfloatingbuttondemo1_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appcompatfloatingbuttondemo1_Controls_'
    +'pOnLayouting';
...
begin
  ...
  gjAppName:= 'org.lamw.appcompatfloatingbuttondemo1';
  gjClassName:= 'org/lamw/appcompatfloatingbuttondemo1/Controls';
