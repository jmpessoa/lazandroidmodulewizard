...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 24.09.2021 18:05:08]
...
{ Class:     com_example_applocationforgpsdemo_applocationforgpsdemo_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/applocationforgpsdemo/'
       +'applocationforgpsdemo/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_applocationforgpsdemo_applocationforgpsdemo_'
    +'Controls_pOnDraw',
  pOnTouch name 'Java_com_example_applocationforgpsdemo_applocationforgpsdemo_'
    +'Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_com_example_applocationforgpsdemo_applocationforgpsdemo_'
    +'Controls_pOnDown',
  pOnUp name 'Java_com_example_applocationforgpsdemo_applocationforgpsdemo_'
    +'Controls_pOnUp',
  pOnClick name 'Java_com_example_applocationforgpsdemo_applocationforgpsdemo_'
    +'Controls_pOnClick',
  pOnLongClick name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnDoubleClick',
  pOnChange name 'Java_com_example_applocationforgpsdemo_applocationforgpsdemo'
    +'_Controls_pOnChange',
  pOnChanged name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_applocationforgpsdemo_applocationforgpsdemo_'
    +'Controls_pOnEnter',
  pOnBackPressed name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnBackPressed',
  pOnClose name 'Java_com_example_applocationforgpsdemo_applocationforgpsdemo_'
    +'Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnLostFocus',
  pOnFocus name 'Java_com_example_applocationforgpsdemo_applocationforgpsdemo_'
    +'Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnRunOnUiThread',
  pOnLocationChanged name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnLocationChanged',
  pOnLocationStatusChanged name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnLocationStatusChanged',
  pOnLocationProviderEnabled name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnLocationProviderEnabled',
  pOnLocationProviderDisabled name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnLocationProviderDisabled',
  pOnGpsStatusChanged name 'Java_com_example_applocationforgpsdemo_'
    +'applocationforgpsdemo_Controls_pOnGpsStatusChanged';
...
begin
  ...
  gjAppName:= 'com.example.applocationforgpsdemo.applocationforgpsdemo';
  gjClassName:= 'com/example/applocationforgpsdemo/applocationforgpsdemo/'
    +'Controls';
