...
keytool -genkey -v -keystore applocationforgpsdemo-release.keystore -alias applocationforgpsdemo.keyalias -keyalg RSA -keysize 2048 -validity 10000 < C:\Users\mali.aydin\Desktop\Lazarus_Jni\AppLocationForGpsDemo\keytool_input.txt
:Error
echo off
cls
echo.
