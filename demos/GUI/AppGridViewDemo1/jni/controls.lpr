...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pAppOnNewIntent',
  ...
  pAppOnBackPressed name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appgridviewdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appgridviewdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appgridviewdemo1_Controls_'
  ...
  pOnClickGeneric name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appgridviewdemo1_Controls_'
  ...
  pAppOnViewClick name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appgridviewdemo1_Controls'
    +'_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appgridviewdemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnClickGridItem name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pOnClickGridItem',
  pOnLongClickGridItem name 'Java_com_example_appgridviewdemo1_Controls_'
    +'pOnLongClickGridItem',
  pOnGridDrawItemCaptionColor name 'Java_com_example_appgridviewdemo1_Controls'
    +'_pOnGridDrawItemCaptionColor',
  pOnGridDrawItemBitmap name 'Java_com_example_appgridviewdemo1_Controls_'
