...
keytool -genkey -v -keystore apptablelayoutdemo1-release.keystore -alias apptablelayoutdemo1.keyalias -keyalg RSA -keysize 2048 -validity 10000 < C:\android\workspace\AppTableLayoutDemo1\keytool_input.txt
:Error
echo off
cls
echo.
