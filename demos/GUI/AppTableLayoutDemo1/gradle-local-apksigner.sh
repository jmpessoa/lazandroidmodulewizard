...
zipalign -v -p 4 /android/workspace/AppTableLayoutDemo1/build/outputs/apk/release/AppTableLayoutDemo1-armeabi-v7a-release-unsigned.apk /android/workspace/AppTableLayoutDemo1/build/outputs/apk/release/AppTableLayoutDemo1-armeabi-v7a-release-unsigned-aligned.apk
