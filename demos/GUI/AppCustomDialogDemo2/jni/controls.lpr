...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 5/3/2017 23:48:50]
...
{ Class:     org_lamw_appcustomdialogdemo2_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appcustomdialogdemo2/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appcustomdialogdemo2_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name
    'Java_org_lamw_appcustomdialogdemo2_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appcustomdialogdemo2_Controls_pAppOnPause',
  pAppOnRestart name
    'Java_org_lamw_appcustomdialogdemo2_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appcustomdialogdemo2_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appcustomdialogdemo2_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appcustomdialogdemo2_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appcustomdialogdemo2_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appcustomdialogdemo2_Controls'
    +'_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appcustomdialogdemo2_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appcustomdialogdemo2_Controls'
    +'_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appcustomdialogdemo2_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appcustomdialogdemo2_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_appcustomdialogdemo2_Controls_pOnClick',
  pOnChange name 'Java_org_lamw_appcustomdialogdemo2_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appcustomdialogdemo2_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appcustomdialogdemo2_Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_appcustomdialogdemo2_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appcustomdialogdemo2_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appcustomdialogdemo2_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appcustomdialogdemo2_Controls_pOnLayouting',
  pOnCustomDialogShow name 'Java_org_lamw_appcustomdialogdemo2_Controls_'
    +'pOnCustomDialogShow',
  pOnCustomDialogBackKeyPressed name 'Java_org_lamw_appcustomdialogdemo2_'
...
begin
  ...
  gjAppName:= 'org.lamw.appcustomdialogdemo2';
  gjClassName:= 'org/lamw/appcustomdialogdemo2/Controls';
