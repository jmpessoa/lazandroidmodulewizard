...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 8/7/2021 16:32:29]
...
{ Class:     org_lamw_appbatterymanagerdemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appbatterymanagerdemo1_Controls
  Method:    pOnBatteryCharging
  Signature: (JII)V }
procedure pOnBatteryCharging(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  batteryAtPercentLevel: JInt; pluggedBy: JInt); cdecl;
begin
  Java_Event_pOnBatteryCharging(PEnv, this, TObject(pasobj), 
    batteryAtPercentLevel, pluggedBy);
end;

{ Class:     org_lamw_appbatterymanagerdemo1_Controls
  Method:    pOnBatteryDisCharging
  Signature: (JI)V }
procedure pOnBatteryDisCharging(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  batteryAtPercentLevel: JInt); cdecl;
begin
  Java_Event_pOnBatteryDisCharging(PEnv, this, TObject(pasobj), 
    batteryAtPercentLevel);
end;

{ Class:     org_lamw_appbatterymanagerdemo1_Controls
  Method:    pOnBatteryFull
  Signature: (JI)V }
procedure pOnBatteryFull(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  batteryAtPercentLevel: JInt); cdecl;
begin
  Java_Event_pOnBatteryFull(PEnv, this, TObject(pasobj), batteryAtPercentLevel);
end;

{ Class:     org_lamw_appbatterymanagerdemo1_Controls
  Method:    pOnBatteryUnknown
  Signature: (JI)V }
procedure pOnBatteryUnknown(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  batteryAtPercentLevel: JInt); cdecl;
begin
  Java_Event_pOnBatteryUnknown(PEnv, this, TObject(pasobj), 
    batteryAtPercentLevel);
end;

{ Class:     org_lamw_appbatterymanagerdemo1_Controls
  Method:    pOnBatteryNotCharging
  Signature: (JI)V }
procedure pOnBatteryNotCharging(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  batteryAtPercentLevel: JInt); cdecl;
begin
  Java_Event_pOnBatteryNotCharging(PEnv, this, TObject(pasobj), 
    batteryAtPercentLevel);
end;
...
const NativeMethods: array[0..49] of JNINativeMethod = (
   ...
   (name: 'pOnBatteryCharging';
    signature: '(JII)V';
    fnPtr: @pOnBatteryCharging; ),
   (name: 'pOnBatteryDisCharging';
    signature: '(JI)V';
    fnPtr: @pOnBatteryDisCharging; ),
   (name: 'pOnBatteryFull';
    signature: '(JI)V';
    fnPtr: @pOnBatteryFull; ),
   (name: 'pOnBatteryUnknown';
    signature: '(JI)V';
    fnPtr: @pOnBatteryUnknown; ),
   (name: 'pOnBatteryNotCharging';
    signature: '(JI)V';
    fnPtr: @pOnBatteryNotCharging; )
);
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appbatterymanagerdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 
    'Java_org_lamw_appbatterymanagerdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appbatterymanagerdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 
    'Java_org_lamw_appbatterymanagerdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appbatterymanagerdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appbatterymanagerdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 
    'Java_org_lamw_appbatterymanagerdemo1_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_appbatterymanagerdemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appbatterymanagerdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appbatterymanagerdemo1_Controls'
    +'_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appbatterymanagerdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appbatterymanagerdemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appbatterymanagerdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appbatterymanagerdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appbatterymanagerdemo1_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_appbatterymanagerdemo1_Controls_pOnUp',
  pOnClick name 'Java_org_lamw_appbatterymanagerdemo1_Controls_pOnClick',
  pOnLongClick name 
    'Java_org_lamw_appbatterymanagerdemo1_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appbatterymanagerdemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appbatterymanagerdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appbatterymanagerdemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_org_lamw_appbatterymanagerdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appbatterymanagerdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 
    'Java_org_lamw_appbatterymanagerdemo1_Controls_pOnLostFocus',
  pOnFocus name 'Java_org_lamw_appbatterymanagerdemo1_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 
    'Java_org_lamw_appbatterymanagerdemo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appbatterymanagerdemo1_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pOnRunOnUiThread',
  pOnBatteryCharging name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pOnBatteryCharging',
  pOnBatteryDisCharging name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pOnBatteryDisCharging',
  pOnBatteryFull name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pOnBatteryFull',
  pOnBatteryUnknown name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pOnBatteryUnknown',
  pOnBatteryNotCharging name 'Java_org_lamw_appbatterymanagerdemo1_Controls_'
    +'pOnBatteryNotCharging';
...
begin
  ...
  gjAppName:= 'org.lamw.appbatterymanagerdemo1';
  gjClassName:= 'org/lamw/appbatterymanagerdemo1/Controls';
