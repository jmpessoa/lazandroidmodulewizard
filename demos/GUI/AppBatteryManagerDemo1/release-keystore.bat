...
keytool -genkey -v -keystore appbatterymanagerdemo1-release.keystore -alias appbatterymanagerdemo1.keyalias -keyalg RSA -keysize 2048 -validity 10000 < C:\android\workspace\AppBatteryManagerDemo1\keytool_input.txt
:Error
echo off
cls
echo.
