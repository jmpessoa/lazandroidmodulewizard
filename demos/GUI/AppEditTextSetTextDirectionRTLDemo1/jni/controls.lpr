...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 2/23/2017 0:16:43]
...
{ Class:     com_example_appedittextsettextdirectionrtldemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appedittextsettextdirectionrtld'
       +'emo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
    +'Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appedittextsettextdirectionrtldemo1'
    +'_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
    +'Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
    +'Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
    +'Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
    +'Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
    +'Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
    +'Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
    +'Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appedittextsettextdirectionrtldemo1'
    +'_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
    +'Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appedittextsettextdirection'
    +'rtldemo1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appedittextsettextdirectionrtldem'
    +'o1_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appedittextsettextdirectionrtl'
    +'demo1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appedittextsettextdirectionr'
    +'tldemo1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appedittextsettextdirectionrt'
    +'ldemo1_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appedittextsettextdirecti'
    +'onrtldemo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appedittextsettextdirectionrtl'
    +'demo1_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appedittextsettextdirection'
    +'rtldemo1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_appedittextsettextdirectionrtldemo1_Controls_'
    +'pOnDraw',
  pOnTouch name 'Java_com_example_appedittextsettextdirectionrtldemo1_Controls'
    +'_pOnTouch',
  pOnClickGeneric name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
    +'Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appedittextsettextdirectionrtldem'
    +'o1_Controls_pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_appedittextsettextdirectionrtldemo1_Controls'
    +'_pOnClick',
  pOnChange name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
    +'Controls_pOnChange',
  pOnChanged name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
    +'Controls_pOnChanged',
  pOnEnter name 'Java_com_example_appedittextsettextdirectionrtldemo1_Controls'
    +'_pOnEnter',
  pOnClose name 'Java_com_example_appedittextsettextdirectionrtldemo1_Controls'
    +'_pOnClose',
  pAppOnViewClick name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
    +'Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appedittextsettextdirectionrtldemo'
    +'1_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appedittextsettextdirectionrtl'
    +'demo1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appedittextsettextdirectio'
    +'nrtldemo1_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
    +'Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appedittextsettextdirectionrtlde'
    +'mo1_Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appedittextsettextdirectionrtldem'
    +'o1_Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appedittextsettextdirectionrtldemo1_'
...
begin
  ...
  gjAppName:= 'com.example.appedittextsettextdirectionrtldemo1';
  gjClassName:= 'com/example/appedittextsettextdirectionrtldemo1/Controls';
