...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 11/8/2019 21:47:43]
...
{ Class:     org_lamw_appscrollingimages_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appscrollingimages_Controls
  Method:    pOnHorScrollViewInnerItemClick
  Signature: (JI)V }
procedure pOnHorScrollViewInnerItemClick(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; itemId: JInt); cdecl;
begin
  Java_Event_pOnHorScrollViewInnerItemClick(PEnv, this, TObject(pasobj), itemId
    );
end;
...
const NativeMethods: array[0..43] of JNINativeMethod = (
   ...
   (name: 'pOnHorScrollViewInnerItemClick';
    signature: '(JI)V';
    fnPtr: @pOnHorScrollViewInnerItemClick; ),
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appscrollingimages/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appscrollingimages_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appscrollingimages_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appscrollingimages_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appscrollingimages_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appscrollingimages_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appscrollingimages_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appscrollingimages_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appscrollingimages_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appscrollingimages_Controls'
    +'_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appscrollingimages_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appscrollingimages_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appscrollingimages_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_appscrollingimages_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appscrollingimages_Controls_pOnLongClick',
  pOnDoubleClick name 
    'Java_org_lamw_appscrollingimages_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appscrollingimages_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appscrollingimages_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appscrollingimages_Controls_pOnEnter',
  pOnBackPressed name 
    'Java_org_lamw_appscrollingimages_Controls_pOnBackPressed',
  pOnClose name 'Java_org_lamw_appscrollingimages_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appscrollingimages_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appscrollingimages_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appscrollingimages_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnHorScrollViewChanged name 'Java_org_lamw_appscrollingimages_Controls_'
    +'pOnHorScrollViewChanged',
  pOnHorScrollViewInnerItemClick name 'Java_org_lamw_appscrollingimages_'
    +'Controls_pOnHorScrollViewInnerItemClick',
  pOnImageViewPopupItemSelected name 'Java_org_lamw_appscrollingimages_'
...
begin
  ...
  gjAppName:= 'org.lamw.appscrollingimages';
  gjClassName:= 'org/lamw/appscrollingimages/Controls';
