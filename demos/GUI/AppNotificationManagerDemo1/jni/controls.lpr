...
exports
  ...
  pAppOnCreate name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appnotificationmanagerdemo1_'
    +'Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appnotificationmanagerdemo1_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnUpdateLayout name 'Java_com_example_appnotificationmanagerdemo1_'
  ...
  pAppOnActivityResult name 'Java_com_example_appnotificationmanagerdemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appnotificationmanagerdemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appnotificationmanagerdemo1'
    +'_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appnotificationmanagerdemo1_'
  ...
  pAppOnCreateContextMenu name 'Java_com_example_appnotificationmanagerdemo1_'
  ...
  pOnTouch name
    'Java_com_example_appnotificationmanagerdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appnotificationmanagerdemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_com_example_appnotificationmanagerdemo1_Controls_pOnDown',
  pOnUp name 'Java_com_example_appnotificationmanagerdemo1_Controls_pOnUp',
  pOnClick name
    'Java_com_example_appnotificationmanagerdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pOnChanged',
  pOnEnter name
    'Java_com_example_appnotificationmanagerdemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pOnBackPressed',
  pOnDone name 'Java_com_example_appnotificationmanagerdemo1_Controls_pOnDone',
  pOnSearch name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pOnSearch',
  pOnNext name 'Java_com_example_appnotificationmanagerdemo1_Controls_pOnNext',
  pOnGo name 'Java_com_example_appnotificationmanagerdemo1_Controls_pOnGo',
  pOnClose name
    'Java_com_example_appnotificationmanagerdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appnotificationmanagerdemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appnotificationmanagerdemo1_'
  ...
  pOnLostFocus name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pOnLostFocus',
  pOnFocus name
    'Java_com_example_appnotificationmanagerdemo1_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appnotificationmanagerdemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appnotificationmanagerdemo1_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appnotificationmanagerdemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_appnotificationmanagerde'
    +'mo1_Controls_pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_com_example_appnotificationmanagerdemo1_Controls'
    +'_pOnRunOnUiThread';
...
(*last [smart] upgrade: 7/4/2016 0:55:53*)
