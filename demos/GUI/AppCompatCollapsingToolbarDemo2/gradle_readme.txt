...
(1) Look for the highest "...\sdk\build-tools" version
        ...
        Note 5. Java Jdk 1.8, Android SDK "platform" 25,  "build-tools" 25.0.3, "support libraries" and "Gradle 3.3" are "must have" to support AppCompat material design in LAMW.
...
Congratulation!
    ...
    :: Where is my Apk? here: "C:\Users\jmpessoa\workspace\AppCompatCollapsingToolbarDemo1\build\outputs\apk"!
