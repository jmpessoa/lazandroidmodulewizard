...
keytool -genkey -v -keystore applinearlayoutdemo1-release.keystore -alias applinearlayoutdemo1.keyalias -keyalg RSA -keysize 2048 -validity 10000 < C:\android\workspace\AppLinearLayoutDemo1\keytool_input.txt
:Error
echo off
cls
echo.
