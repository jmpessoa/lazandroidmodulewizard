...
zipalign -v -p 4 C:\android\workspace\AppLinearLayoutDemo1\build\outputs\apk\release\AppLinearLayoutDemo1-universal-release-unsigned.apk C:\android\workspace\AppLinearLayoutDemo1\build\outputs\apk\release\AppLinearLayoutDemo1-universal-release-unsigned-aligned.apk
