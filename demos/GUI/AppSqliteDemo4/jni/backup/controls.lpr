...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pAppOnNewIntent',
  ...
  pAppOnBackPressed name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appsqlitedemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appsqlitedemo1_Controls_'
  ...
  pOnClickGeneric name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_com_example_appsqlitedemo1_Controls_pOnDown',
  pOnClick name 'Java_com_example_appsqlitedemo1_Controls_pOnClick',
  pOnLongClick name 'Java_com_example_appsqlitedemo1_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_com_example_appsqlitedemo1_Controls_pOnDoubleClick',
  ...
  pOnBackPressed name 'Java_com_example_appsqlitedemo1_Controls_pOnBackPressed',
  pOnClose name 'Java_com_example_appsqlitedemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appsqlitedemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appsqlitedemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appsqlitedemo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_appsqlitedemo1_Controls'
    +'_pAppOnRequestPermissionResult',
  pOnImageViewPopupItemSelected name 'Java_com_example_appsqlitedemo1_Controls'
    +'_pOnImageViewPopupItemSelected',
  pOnSqliteDataAccessAsyncPostExecute name 'Java_com_example_appsqlitedemo1_'
...
(*last [smart] upgrade: 7/4/2016 1:27:04*)
