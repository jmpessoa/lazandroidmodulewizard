...
3. If AVD/Emulator is NOT running:
   ...
   3.3 look for the App "AppSqliteDemo1" in the Emulator and click it!
...
6. To find your app Look for the "AppSqliteDemo1-debug.apk" in \bin folder!
 
7. Android Asset Packaging Tool: to know which files were packed in "AppSqliteDemo1-debug.apk"
