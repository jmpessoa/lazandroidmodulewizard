...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 03.10.2017 7:27:36]
...
{ Class:     org_lamw_colorpicker_Controls
  Method:    pAppOnCreate
...
begin
  Java_Event_pAppOnCreate(PEnv, this, context, layout, intent);
    AndroidModule_ColorPick.Init(gApp);
end;
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/colorpicker/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_colorpicker_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_colorpicker_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_colorpicker_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_colorpicker_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_colorpicker_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_colorpicker_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_colorpicker_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_colorpicker_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_colorpicker_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_colorpicker_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_colorpicker_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_colorpicker_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_colorpicker_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_colorpicker_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_colorpicker_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_colorpicker_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_colorpicker_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_colorpicker_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_colorpicker_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_colorpicker_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_colorpicker_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_colorpicker_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_colorpicker_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_colorpicker_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_colorpicker_Controls_pOnLongClick',
  pOnChange name 'Java_org_lamw_colorpicker_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_colorpicker_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_colorpicker_Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_colorpicker_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_colorpicker_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_colorpicker_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_colorpicker_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_colorpicker_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_colorpicker_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_colorpicker_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_colorpicker_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_colorpicker_Controls_pOnLayouting',
  pOnDrawingViewTouch name 'Java_org_lamw_colorpicker_Controls_'
    +'pOnDrawingViewTouch',
  pOnDrawingViewDraw name 'Java_org_lamw_colorpicker_Controls_'
    +'pOnDrawingViewDraw';
...
begin
  ...
  gjAppName:= 'org.lamw.colorpicker';
  gjClassName:= 'org/lamw/colorpicker/Controls';
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TAndroidModule_ColorPick, AndroidModule_ColorPick);
end.
