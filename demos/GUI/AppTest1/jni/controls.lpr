...
exports
  ...
  pAppOnConfigurationChanged name 'Java_com_example_apptest1_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apptest1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apptest1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apptest1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_apptest1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_apptest1_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_apptest1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_apptest1_Controls_'
  ...
  pOnClickGeneric name 'Java_com_example_apptest1_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_apptest1_Controls_'
  ...
  pAppOnListItemClick name 'Java_com_example_apptest1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_apptest1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_apptest1_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_apptest1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_apptest1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_apptest1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_apptest1_Controls_pOnLayouting',
  pOnClickWidgetItem name 'Java_com_example_apptest1_Controls_'
    +'pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_com_example_apptest1_Controls_'
    +'pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_com_example_apptest1_Controls_'
    +'pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_com_example_apptest1_Controls_'
    +'pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_com_example_apptest1_Controls_'
    +'pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_com_example_apptest1_Controls_'
