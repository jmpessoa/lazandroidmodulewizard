...
zipalign -v -p 4 fpcupdeluxe/ccr/lamw/demos/GUI/AppColorPickerDemo1/build/outputs/apk/release/AppColorPickerDemo1-arm64-v8a-release-unsigned.apk fpcupdeluxe/ccr/lamw/demos/GUI/AppColorPickerDemo1/build/outputs/apk/release/AppColorPickerDemo1-arm64-v8a-release-unsigned-aligned.apk
