...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 11/3/2020 4:24:51]
...
{ Class:     org_lamw_appjcentertoytimerservicedemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appjcentertoytimerservicedemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appjcentertoytimerservicedemo1_'
    +'Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appjcentertoytimerservicedemo1_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_appjcentertoytimerservicedemo1_'
    +'Controls_pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_appjcentertoytimerservicedemo'
    +'1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appjcentertoytimerservicedemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appjcentertoytimerservicedemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appjcentertoytimerservicedemo1'
    +'_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appjcentertoytimerservicedemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appjcentertoytimerservicedem'
    +'o1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appjcentertoytimerservicedemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appjcentertoytimerservicedemo'
    +'1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_pOnDraw',
  pOnTouch name 
    'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appjcentertoytimerservicedemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_pOnUp',
  pOnClick name 
    'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 
    'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pOnBackPressed',
  pOnClose name 
    'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appjcentertoytimerservicedemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appjcentertoytimerservicedemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appjcentertoytimerservicedemo'
    +'1_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pOnLostFocus',
  pOnFocus name 
    'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appjcentertoytimerservicedemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appjcentertoytimerservicedemo1_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appjcentertoytimerservicedemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appjcentertoytimerservicede'
    +'mo1_Controls_pAppOnRequestPermissionResult',
  pOnToyTimerServicePullElapsedTime name 'Java_org_lamw_appjcentertoytimerservi'
    +'cedemo1_Controls_pOnToyTimerServicePullElapsedTime';
...
begin
  ...
  gjAppName:= 'org.lamw.appjcentertoytimerservicedemo1';
  gjClassName:= 'org/lamw/appjcentertoytimerservicedemo1/Controls';
