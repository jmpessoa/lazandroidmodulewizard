...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 1/7/2018 20:51:45]
...
{ Class:     org_lamw_appcompatviewpagerdemo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appcompatviewpagerdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appcompatviewpagerdemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appcompatviewpagerdemo1_Controls'
    +'_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appcompatviewpagerdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appcompatviewpagerdemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appcompatviewpagerdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appcompatviewpagerdemo1_Controls'
    +'_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appcompatviewpagerdemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pOnLongClick',
  pOnChange name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appcompatviewpagerdemo1_Controls'
    +'_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appcompatviewpagerdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pOnLayouting',
  pOnClickWidgetItem name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_org_lamw_appcompatviewpagerdemo1_'
    +'Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_org_lamw_appcompatviewpagerdemo1_'
    +'Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_org_lamw_appcompatviewpagerdemo1_'
    +'Controls_pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_org_lamw_appcompatviewpagerdemo1_Controls_'
    +'pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_org_lamw_appcompatviewpagerdemo1_'
    +'Controls_pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_org_lamw_appcompatviewpagerdemo'
    +'1_Controls_pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetImage name 'Java_org_lamw_appcompatviewpagerdemo1_'
...
begin
  ...
  gjAppName:= 'org.lamw.appcompatviewpagerdemo1';
  gjClassName:= 'org/lamw/appcompatviewpagerdemo1/Controls';
