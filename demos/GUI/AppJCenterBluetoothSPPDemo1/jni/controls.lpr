...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 11/22/2019 1:08:15]
...
{ Class:     org_lamw_appjcenterbluetoothsppdemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appjcenterbluetoothsppdemo1_Controls
  Method:    pOnBluetoothSPPDataReceived
  Signature: (J[BLjava/lang/String;)V }
procedure pOnBluetoothSPPDataReceived(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; jbyteArrayData: JByteArray; messageData: JString); cdecl;
begin
  Java_Event_pOnBluetoothSPPDataReceived(PEnv, this, TObject(pasobj), 
    jbyteArrayData, messageData);
end;

{ Class:     org_lamw_appjcenterbluetoothsppdemo1_Controls
  Method:    pOnBluetoothSPPDeviceConnected
  Signature: (JLjava/lang/String;Ljava/lang/String;)V }
procedure pOnBluetoothSPPDeviceConnected(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; deviceName: JString; deviceAddress: JString); cdecl;
begin
  Java_Event_pOnBluetoothSPPDeviceConnected(PEnv, this, TObject(pasobj), 
    deviceName, deviceAddress);
end;

{ Class:     org_lamw_appjcenterbluetoothsppdemo1_Controls
  Method:    pOnBluetoothSPPDeviceDisconnected
  Signature: (J)V }
procedure pOnBluetoothSPPDeviceDisconnected(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong); cdecl;
begin
  Java_Event_pOnBluetoothSPPDeviceDisconnected(PEnv, this, TObject(pasobj));
end;

{ Class:     org_lamw_appjcenterbluetoothsppdemo1_Controls
  Method:    pOnBluetoothSPPDeviceConnectionFailed
  Signature: (J)V }
procedure pOnBluetoothSPPDeviceConnectionFailed(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong); cdecl;
begin
  Java_Event_pOnBluetoothSPPDeviceConnectionFailed(PEnv, this, TObject(pasobj));
end;

{ Class:     org_lamw_appjcenterbluetoothsppdemo1_Controls
  Method:    pOnBluetoothSPPServiceStateChanged
  Signature: (JI)V }
procedure pOnBluetoothSPPServiceStateChanged(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; serviceState: JInt); cdecl;
begin
  Java_Event_pOnBluetoothSPPServiceStateChanged(PEnv, this, TObject(pasobj), 
    serviceState);
end;

{ Class:     org_lamw_appjcenterbluetoothsppdemo1_Controls
  Method:    pOnBluetoothSPPListeningNewAutoConnection
  Signature: (JLjava/lang/String;Ljava/lang/String;)V }
procedure pOnBluetoothSPPListeningNewAutoConnection(PEnv: PJNIEnv; 
  this: JObject; pasobj: JLong; deviceName: JString; deviceAddress: JString); 
  cdecl;
begin
  Java_Event_pOnBluetoothSPPListeningNewAutoConnection(PEnv, this, TObject(
    pasobj), deviceName, deviceAddress);
end;

{ Class:     org_lamw_appjcenterbluetoothsppdemo1_Controls
  Method:    pOnBluetoothSPPAutoConnectionStarted
  Signature: (J)V }
procedure pOnBluetoothSPPAutoConnectionStarted(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong); cdecl;
begin
  Java_Event_pOnBluetoothSPPAutoConnectionStarted(PEnv, this, TObject(pasobj));
end;
...
const NativeMethods: array[0..48] of JNINativeMethod = (
   ...
   (name: 'pOnBluetoothSPPDataReceived';
    signature: '(J[BLjava/lang/String;)V';
    fnPtr: @pOnBluetoothSPPDataReceived; ),
   (name: 'pOnBluetoothSPPDeviceConnected';
    signature: '(JLjava/lang/String;Ljava/lang/String;)V';
    fnPtr: @pOnBluetoothSPPDeviceConnected; ),
   (name: 'pOnBluetoothSPPDeviceDisconnected';
    signature: '(J)V';
    fnPtr: @pOnBluetoothSPPDeviceDisconnected; ),
   (name: 'pOnBluetoothSPPDeviceConnectionFailed';
    signature: '(J)V';
    fnPtr: @pOnBluetoothSPPDeviceConnectionFailed; ),
   (name: 'pOnBluetoothSPPServiceStateChanged';
    signature: '(JI)V';
    fnPtr: @pOnBluetoothSPPServiceStateChanged; ),
   (name: 'pOnBluetoothSPPListeningNewAutoConnection';
    signature: '(JLjava/lang/String;Ljava/lang/String;)V';
    fnPtr: @pOnBluetoothSPPListeningNewAutoConnection; ),
   (name: 'pOnBluetoothSPPAutoConnectionStarted';
    signature: '(J)V';
    fnPtr: @pOnBluetoothSPPAutoConnectionStarted; )
);
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appjcenterbluetoothsppdemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_appjcenterbluetoothsppdemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appjcenterbluetoothsppdemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appjcenterbluetoothsppdemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appjcenterbluetoothsppdemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appjcenterbluetoothsppdemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appjcenterbluetoothsppdemo1'
    +'_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appjcenterbluetoothsppdemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appjcenterbluetoothsppdemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appjcenterbluetoothsppdemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls'
    +'_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appjcenterbluetoothsppdemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appjcenterbluetoothsppdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appjcenterbluetoothsppdemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appjcenterbluetoothsppdemo1_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appjcenterbluetoothsppdemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appjcenterbluetoothsppdemo'
    +'1_Controls_pAppOnRequestPermissionResult',
  pOnBluetoothSPPDataReceived name 'Java_org_lamw_appjcenterbluetoothsppdemo1_'
    +'Controls_pOnBluetoothSPPDataReceived',
  pOnBluetoothSPPDeviceConnected name 'Java_org_lamw_appjcenterbluetoothsppdemo'
    +'1_Controls_pOnBluetoothSPPDeviceConnected',
  pOnBluetoothSPPDeviceDisconnected name 'Java_org_lamw_appjcenterbluetoothsppd'
    +'emo1_Controls_pOnBluetoothSPPDeviceDisconnected',
  pOnBluetoothSPPDeviceConnectionFailed name 'Java_org_lamw_appjcenterbluetooth'
    +'sppdemo1_Controls_pOnBluetoothSPPDeviceConnectionFailed',
  pOnBluetoothSPPServiceStateChanged name 'Java_org_lamw_appjcenterbluetoothspp'
    +'demo1_Controls_pOnBluetoothSPPServiceStateChanged',
  pOnBluetoothSPPListeningNewAutoConnection name 'Java_org_lamw_'
    +'appjcenterbluetoothsppdemo1_Controls_'
    +'pOnBluetoothSPPListeningNewAutoConnection',
  pOnBluetoothSPPAutoConnectionStarted name 'Java_org_lamw_appjcenterbluetooths'
    +'ppdemo1_Controls_pOnBluetoothSPPAutoConnectionStarted';
...
begin
  ...
  gjAppName:= 'org.lamw.appjcenterbluetoothsppdemo1';
  gjClassName:= 'org/lamw/appjcenterbluetoothsppdemo1/Controls';
