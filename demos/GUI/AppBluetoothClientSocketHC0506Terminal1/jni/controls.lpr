...
{ Class:     org_lamw_appbluetoothclientsockethc0506terminal1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appbluetoothclientsockethc0506'
       +'terminal1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appbluetoothclientsockethc0506terminal'
    +'1_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appbluetoothclientsockethc0506terminal'
    +'1_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appbluetoothclientsockethc050'
    +'6terminal1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appbluetoothclientsockethc0'
    +'506terminal1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appbluetoothclientsockethc050'
    +'6terminal1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_Controls'
    +'_pOnDraw',
  pOnTouch name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pOnLongClick',
  pOnChange name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appbluetoothclientsockethc05'
    +'06terminal1_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pOnLayouting',
  pOnBluetoothEnabled name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pOnBluetoothEnabled',
  pOnBluetoothDisabled name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pOnBluetoothDisabled',
  pOnBluetoothDeviceFound name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pOnBluetoothDeviceFound',
  pOnBluetoothDiscoveryStarted name 'Java_org_lamw_appbluetoothclientsockethc0'
    +'506terminal1_Controls_pOnBluetoothDiscoveryStarted',
  pOnBluetoothDiscoveryFinished name 'Java_org_lamw_appbluetoothclientsockethc'
    +'0506terminal1_Controls_pOnBluetoothDiscoveryFinished',
  pOnBluetoothDeviceBondStateChanged name 'Java_org_lamw_appbluetoothclientsock'
    +'ethc0506terminal1_Controls_pOnBluetoothDeviceBondStateChanged',
  pOnBluetoothClientSocketConnected name 'Java_org_lamw_appbluetoothclientsocke'
    +'thc0506terminal1_Controls_pOnBluetoothClientSocketConnected',
  pOnBluetoothClientSocketIncomingData name 'Java_org_lamw_appbluetoothclientso'
    +'ckethc0506terminal1_Controls_pOnBluetoothClientSocketIncomingData',
  pOnBluetoothClientSocketDisconnected name 'Java_org_lamw_appbluetoothclientso'
    +'ckethc0506terminal1_Controls_pOnBluetoothClientSocketDisconnected',
  pOnClickWidgetItem name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_org_lamw_appbluetoothclientsocketh'
    +'c0506terminal1_Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_org_lamw_appbluetoothclientsocketh'
    +'c0506terminal1_Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_org_lamw_appbluetoothclientsockethc0506'
    +'terminal1_Controls_pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_org_lamw_appbluetoothclientsockethc'
    +'0506terminal1_Controls_pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_org_lamw_appbluetoothclientsock'
    +'ethc0506terminal1_Controls_pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetImage name 'Java_org_lamw_appbluetoothclientsockethc'
    +'0506terminal1_Controls_pOnListViewDrawItemWidgetImage',
  pOnTimer name 'Java_org_lamw_appbluetoothclientsockethc0506terminal1_'
    +'Controls_pOnTimer';
...
begin
  ...
  gjAppName:= 'org.lamw.appbluetoothclientsockethc0506terminal1';{AndroidWidget.pas}
  gjClassName:= 'org/lamw/appbluetoothclientsockethc0506terminal1/Controls';{AndroidWidget.pas}
