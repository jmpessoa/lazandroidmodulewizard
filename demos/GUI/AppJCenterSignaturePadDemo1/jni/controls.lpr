...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 7/29/2019 16:41:53]
...
{ Class:     org_lamw_appjcentersignaturepaddemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appjcentersignaturepaddemo1_Controls
  Method:    pOnSignaturePadStartSigning
  Signature: (J)V }
procedure pOnSignaturePadStartSigning(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong); cdecl;
begin
  Java_Event_pOnSignaturePadStartSigning(PEnv, this, TObject(pasobj));
end;

{ Class:     org_lamw_appjcentersignaturepaddemo1_Controls
  Method:    pOnSignaturePadSigned
  Signature: (J)V }
procedure pOnSignaturePadSigned(PEnv: PJNIEnv; this: JObject; pasobj: JLong); 
  cdecl;
begin
  Java_Event_pOnSignaturePadSigned(PEnv, this, TObject(pasobj));
end;

{ Class:     org_lamw_appjcentersignaturepaddemo1_Controls
  Method:    pOnSignaturePadClear
  Signature: (J)V }
procedure pOnSignaturePadClear(PEnv: PJNIEnv; this: JObject; pasobj: JLong); 
  cdecl;
begin
  Java_Event_pOnSignaturePadClear(PEnv, this, TObject(pasobj));
end;
...
const NativeMethods: array[0..43] of JNINativeMethod = (
   ...
   (name: 'pOnSignaturePadStartSigning';
    signature: '(J)V';
    fnPtr: @pOnSignaturePadStartSigning; ),
   (name: 'pOnSignaturePadSigned';
    signature: '(J)V';
    fnPtr: @pOnSignaturePadSigned; ),
   (name: 'pOnSignaturePadClear';
    signature: '(J)V';
    fnPtr: @pOnSignaturePadClear; )
);
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appjcentersignaturepaddemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appjcentersignaturepaddemo1'
    +'_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls'
    +'_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appjcentersignaturepaddemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appjcentersignaturepaddemo'
    +'1_Controls_pAppOnRequestPermissionResult',
  pOnSignaturePadStartSigning name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pOnSignaturePadStartSigning',
  pOnSignaturePadSigned name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pOnSignaturePadSigned',
  pOnSignaturePadClear name 'Java_org_lamw_appjcentersignaturepaddemo1_'
    +'Controls_pOnSignaturePadClear';
...
begin
  ...
  gjAppName:= 'org.lamw.appjcentersignaturepaddemo1';
  gjClassName:= 'org/lamw/appjcentersignaturepaddemo1/Controls';
