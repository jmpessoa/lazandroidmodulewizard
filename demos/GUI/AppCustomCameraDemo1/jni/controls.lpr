...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 4/18/2018 16:40:38]
...
{ Class:     lamw_org_appcustomcamerademo1_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'lamw/org/appcustomcamerademo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_lamw_org_appcustomcamerademo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name
    'Java_lamw_org_appcustomcamerademo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_lamw_org_appcustomcamerademo1_Controls_pAppOnPause',
  pAppOnRestart name
    'Java_lamw_org_appcustomcamerademo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_lamw_org_appcustomcamerademo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_lamw_org_appcustomcamerademo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_lamw_org_appcustomcamerademo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_lamw_org_appcustomcamerademo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_lamw_org_appcustomcamerademo1_Controls'
    +'_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_lamw_org_appcustomcamerademo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_lamw_org_appcustomcamerademo1_Controls'
    +'_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_lamw_org_appcustomcamerademo1_Controls_pOnDraw',
  pOnTouch name 'Java_lamw_org_appcustomcamerademo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_lamw_org_appcustomcamerademo1_Controls_pOnClick',
  pOnLongClick name 'Java_lamw_org_appcustomcamerademo1_Controls_pOnLongClick',
  pOnChange name 'Java_lamw_org_appcustomcamerademo1_Controls_pOnChange',
  pOnChanged name 'Java_lamw_org_appcustomcamerademo1_Controls_pOnChanged',
  pOnEnter name 'Java_lamw_org_appcustomcamerademo1_Controls_pOnEnter',
  pOnClose name 'Java_lamw_org_appcustomcamerademo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_lamw_org_appcustomcamerademo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_lamw_org_appcustomcamerademo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_lamw_org_appcustomcamerademo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_lamw_org_appcustomcamerademo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_lamw_org_appcustomcamerademo1_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnCustomCameraSurfaceCreated name 'Java_lamw_org_appcustomcamerademo1_'
    +'Controls_pOnCustomCameraSurfaceCreated',
  pOnCustomCameraSurfaceChanged name 'Java_lamw_org_appcustomcamerademo1_'
    +'Controls_pOnCustomCameraSurfaceChanged',
  pOnCustomCameraPictureTaken name 'Java_lamw_org_appcustomcamerademo1_'
    +'Controls_pOnCustomCameraPictureTaken';
...
begin
  ...
  gjAppName:= 'lamw.org.appcustomcamerademo1';
  gjClassName:= 'lamw/org/appcustomcamerademo1/Controls';
