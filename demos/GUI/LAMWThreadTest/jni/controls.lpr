...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 11/27/2021 11:17:51]
...
uses
  ...
  Laz_And_Controls_Events,unit1,uThreadTest;
  
{%region /fold 'LAMW generated code'}

{ Class:     org_lamw_lamwthreadtest_Controls
  Method:    pAppOnCreate
...
begin
  Java_Event_pAppOnCreate(PEnv,this,context,layout,intent);AndroidModule1.ReInit
    (gApp);
end;
...
procedure pAppOnClickOptionMenuItem(PEnv: PJNIEnv; this: JObject; 
  ...
  cdecl;
begin
  Java_Event_pAppOnClickOptionMenuItem(PEnv,this,menuItem,itemID,itemCaption,
    checked);
end;
...
procedure pAppOnClickContextMenuItem(PEnv: PJNIEnv; this: JObject; 
  ...
  cdecl;
begin
  Java_Event_pAppOnClickContextMenuItem(PEnv,this,menuItem,itemID,itemCaption,
    checked);
end;
...
begin
  Java_Event_pOnPinchZoomGestureDetected(PEnv,this,TObject(pasobj),scaleFactor,
    state);
end;
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/lamwthreadtest/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_lamwthreadtest_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_lamwthreadtest_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_lamwthreadtest_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_lamwthreadtest_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_lamwthreadtest_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_lamwthreadtest_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_lamwthreadtest_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_lamwthreadtest_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_lamwthreadtest_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_lamwthreadtest_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_lamwthreadtest_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_lamwthreadtest_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_lamwthreadtest_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_lamwthreadtest_Controls_pOnUp',
  pOnClick name 'Java_org_lamw_lamwthreadtest_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_lamwthreadtest_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_lamwthreadtest_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_lamwthreadtest_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_lamwthreadtest_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_lamwthreadtest_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_lamwthreadtest_Controls_pOnBackPressed',
  pOnClose name 'Java_org_lamw_lamwthreadtest_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_lamwthreadtest_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_lamwthreadtest_Controls_pOnLostFocus',
  pOnFocus name 'Java_org_lamw_lamwthreadtest_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_lamwthreadtest_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_lamwthreadtest_Controls_'
    +'pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 
    'Java_org_lamw_lamwthreadtest_Controls_pOnRunOnUiThread',
  invoke0 name 'Java_org_lamw_lamwthreadtest_NativeInvocationHandler_invoke0';
...
begin
  ...
  gjAppName:= 'org.lamw.lamwthreadtest';
  gjClassName:= 'org/lamw/lamwthreadtest/Controls';
