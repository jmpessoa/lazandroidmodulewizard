...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_appcamerademo_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name
    'Java_com_example_appcamerademo_Controls_pAppOnNewIntent',
  ...
  pAppOnBackPressed name 'Java_com_example_appcamerademo_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appcamerademo_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appcamerademo_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appcamerademo_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appcamerademo_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appcamerademo_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appcamerademo_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appcamerademo_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appcamerademo_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appcamerademo_Controls_'
  ...
  pOnClickGeneric name
    'Java_com_example_appcamerademo_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appcamerademo_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_appcamerademo_Controls_pOnClick',
  pOnLongClick name 'Java_com_example_appcamerademo_Controls_pOnLongClick',
  ...
  pAppOnViewClick name
    'Java_com_example_appcamerademo_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appcamerademo_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appcamerademo_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appcamerademo_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_appcamerademo_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_appcamerademo_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_appcamerademo_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_appcamerademo_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_appcamerademo_Controls_'
...
(*last [smart] upgrade: 7/3/2016 22:24:09*)
