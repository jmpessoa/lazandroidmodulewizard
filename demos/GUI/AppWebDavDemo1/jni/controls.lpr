...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 06.07.2022 9:08:06]
...
{ Class:     org_lamw_appwebdavdemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appwebdavdemo1_Controls
  Method:    pOnWebDavGetResultStr
  Signature: (JLjava/lang/String;)V }
procedure pOnWebDavGetResultStr(PEnv: PJNIEnv; this: JObject; pasobj: JLong;
  inputLine: JString); cdecl;
begin
  Java_Event_pOnWebDavGetResultStr(PEnv, this, TObject(pasobj), inputLine);
end;

{ Class:     org_lamw_appwebdavdemo1_Controls
  Method:    pOnWebDavGetProgress
  Signature: (JII)V }
procedure pOnWebDavGetProgress(PEnv: PJNIEnv; this: JObject; pasobj: JLong;
  position: JInt; Size: JInt); cdecl;
begin
  Java_Event_pOnWebDavGetProgress(PEnv, this, TObject(pasobj), position, Size);
end;

const NativeMethods: array[0..73] of JNINativeMethod = (
   (name: 'pAppOnCreate';
   ...
   (name: 'pOnTimer';
    signature: '(J)V';
    fnPtr: @pOnTimer; ),
   (name: 'pOnWebDavGetResultStr';
    signature: '(JLjava/lang/String;)V';
    fnPtr: @pOnWebDavGetResultStr; ),
   (name: 'pOnWebDavGetProgress';
    signature: '(JII)V';
    fnPtr: @pOnWebDavGetProgress; )
);
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     gjClass:= (curEnv^).FindClass(curEnv, 'org/lamw/appwebdavdemo1/Controls');
     gjClass:= (curEnv^).NewGlobalRef(curEnv, gjClass);
     rc := RegisterNativeMethods(curEnv, 'org/lamw/appwebdavdemo1/Controls');
     if (rc <> JNI_OK) then result := rc;
  end;
  gjClassName:= 'org/lamw/appwebdavdemo1/Controls';
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appwebdavdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appwebdavdemo1_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appwebdavdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appwebdavdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appwebdavdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appwebdavdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appwebdavdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appwebdavdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appwebdavdemo1_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appwebdavdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appwebdavdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appwebdavdemo1_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appwebdavdemo1_Controls_pOnDown',
  pOnUp name 'Java_org_lamw_appwebdavdemo1_Controls_pOnUp',
  pOnClick name 'Java_org_lamw_appwebdavdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appwebdavdemo1_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appwebdavdemo1_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appwebdavdemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appwebdavdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appwebdavdemo1_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appwebdavdemo1_Controls_pOnBackPressed',
  pOnDone name 'Java_org_lamw_appwebdavdemo1_Controls_pOnDone',
  pOnSearch name 'Java_org_lamw_appwebdavdemo1_Controls_pOnSearch',
  pOnNext name 'Java_org_lamw_appwebdavdemo1_Controls_pOnNext',
  pOnGo name 'Java_org_lamw_appwebdavdemo1_Controls_pOnGo',
  pOnClose name 'Java_org_lamw_appwebdavdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appwebdavdemo1_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appwebdavdemo1_Controls_pOnLostFocus',
  pOnFocus name 'Java_org_lamw_appwebdavdemo1_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appwebdavdemo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pAppOnRequestPermissionResult',
  pOnRunOnUiThread name
    'Java_org_lamw_appwebdavdemo1_Controls_pOnRunOnUiThread',
  pOnCustomDialogShow name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnCustomDialogShow',
  pOnCustomDialogBackKeyPressed name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnCustomDialogBackKeyPressed',
  pEditTextOnActionIconTouchUp name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pEditTextOnActionIconTouchUp',
  pEditTextOnActionIconTouchDown name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pEditTextOnActionIconTouchDown',
  pOnImageViewPopupItemSelected name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnImageViewPopupItemSelected',
  pOnClickWidgetItem name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnClickWidgetItem',
  pOnClickImageItem name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnClickImageItem',
  pOnClickCaptionItem name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnClickCaptionItem',
  pOnClickItemTextLeft name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnClickItemTextLeft',
  pOnClickItemTextCenter name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnClickItemTextCenter',
  pOnClickItemTextRight name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnClickItemTextRight',
  pOnListViewLongClickCaptionItem name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemCustomFont name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnListViewDrawItemCustomFont',
  pOnListViewDrawItemBackgroundColor name 'Java_org_lamw_appwebdavdemo1_'
    +'Controls_pOnListViewDrawItemBackgroundColor',
  pOnListViewDrawItemBitmap name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_org_lamw_appwebdavdemo1_'
    +'Controls_pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetText name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnListViewDrawItemWidgetText',
  pOnListViewDrawItemWidgetImage name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnListViewDrawItemWidgetImage',
  pOnSpinnerItemSelected name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnSpinnerItemSelected',
  pOnTimer name 'Java_org_lamw_appwebdavdemo1_Controls_pOnTimer',
  pOnWebDavGetResultStr name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnWebDavGetResultStr',
  pOnWebDavGetProgress name 'Java_org_lamw_appwebdavdemo1_Controls_'
    +'pOnWebDavGetProgress';
...
begin
  ...
  gjAppName:= 'org.lamw.appwebdavdemo1';
  gjClassName:= 'org/lamw/appwebdavdemo1/Controls';
