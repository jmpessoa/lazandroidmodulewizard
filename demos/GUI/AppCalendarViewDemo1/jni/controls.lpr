...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 9/17/2018 0:44:02]
...
{ Class:     org_lamw_appcalendarviewdemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appcalendarviewdemo1_Controls
  Method:    pOnCalendarSelectedDayChange
  Signature: (JIII)V }
procedure pOnCalendarSelectedDayChange(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; year: JInt; monthOfYear: JInt; dayOfMonth: JInt); cdecl;
begin
  Java_Event_pOnCalendarSelectedDayChange(PEnv, this, TObject(pasobj), year, 
...
const NativeMethods: array[0..38] of JNINativeMethod = (
   ...
   (name: 'pOnCalendarSelectedDayChange';
    signature: '(JIII)V';
    fnPtr: @pOnCalendarSelectedDayChange; )
);
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appcalendarviewdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appcalendarviewdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 
    'Java_org_lamw_appcalendarviewdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appcalendarviewdemo1_Controls_pAppOnPause',
  pAppOnRestart name 
    'Java_org_lamw_appcalendarviewdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appcalendarviewdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appcalendarviewdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appcalendarviewdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appcalendarviewdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appcalendarviewdemo1_Controls'
    +'_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appcalendarviewdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appcalendarviewdemo1_Controls'
    +'_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appcalendarviewdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appcalendarviewdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_appcalendarviewdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appcalendarviewdemo1_Controls_pOnLongClick',
  pOnChange name 'Java_org_lamw_appcalendarviewdemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appcalendarviewdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appcalendarviewdemo1_Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_appcalendarviewdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appcalendarviewdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appcalendarviewdemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appcalendarviewdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appcalendarviewdemo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appcalendarviewdemo1_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnCalendarSelectedDayChange name 'Java_org_lamw_appcalendarviewdemo1_'
    +'Controls_pOnCalendarSelectedDayChange';
...
begin
  ...
  gjAppName:= 'org.lamw.appcalendarviewdemo1';
  gjClassName:= 'org/lamw/appcalendarviewdemo1/Controls';
