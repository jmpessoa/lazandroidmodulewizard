...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 9/23/2019 19:04:55]
...
{ Class:     org_lamw_appsftpclientdemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appsftpclientdemo1_Controls
  Method:    pOnSFTPClientTryConnect
  Signature: (JZ)V }
procedure pOnSFTPClientTryConnect(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  success: JBoolean); cdecl;
begin
  Java_Event_pOnSFTPClientTryConnect(PEnv, this, TObject(pasobj), success);
end;

{ Class:     org_lamw_appsftpclientdemo1_Controls
  Method:    pOnSFTPClientDownloadFinished
  Signature: (JLjava/lang/String;Z)V }
procedure pOnSFTPClientDownloadFinished(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; destination: JString; success: JBoolean); cdecl;
begin
  Java_Event_pOnSFTPClientDownloadFinished(PEnv, this, TObject(pasobj), 
    destination, success);
end;

{ Class:     org_lamw_appsftpclientdemo1_Controls
  Method:    pOnSFTPClientUploadFinished
  Signature: (JLjava/lang/String;Z)V }
procedure pOnSFTPClientUploadFinished(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; destination: JString; success: JBoolean); cdecl;
begin
  Java_Event_pOnSFTPClientUploadFinished(PEnv, this, TObject(pasobj), 
    destination, success);
end;

{ Class:     org_lamw_appsftpclientdemo1_Controls
  Method:    pOnSFTPClientListing
  Signature: (JLjava/lang/String;Ljava/lang/String;I)V }
procedure pOnSFTPClientListing(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  url: JString; fileName: JString; fileSize: JInt); cdecl;
begin
  Java_Event_pOnSFTPClientListing(PEnv, this, TObject(pasobj), url, fileName, 
    fileSize);
end;

{ Class:     org_lamw_appsftpclientdemo1_Controls
  Method:    pOnSFTPClientListed
  Signature: (JI)V }
procedure pOnSFTPClientListed(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  count: JInt); cdecl;
begin
  Java_Event_pOnSFTPClientListed(PEnv, this, TObject(pasobj), count);
end;
...
const NativeMethods: array[0..60] of JNINativeMethod = (
   ...
   (name: 'pOnSFTPClientTryConnect';
    signature: '(JZ)V';
    fnPtr: @pOnSFTPClientTryConnect; ),
   (name: 'pOnSFTPClientDownloadFinished';
    signature: '(JLjava/lang/String;Z)V';
    fnPtr: @pOnSFTPClientDownloadFinished; ),
   (name: 'pOnSFTPClientUploadFinished';
    signature: '(JLjava/lang/String;Z)V';
    fnPtr: @pOnSFTPClientUploadFinished; ),
   (name: 'pOnSFTPClientListing';
    signature: '(JLjava/lang/String;Ljava/lang/String;I)V';
    fnPtr: @pOnSFTPClientListing; ),
   (name: 'pOnSFTPClientListed';
    signature: '(JI)V';
    fnPtr: @pOnSFTPClientListed; )
);
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appsftpclientdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appsftpclientdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appsftpclientdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appsftpclientdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appsftpclientdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appsftpclientdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appsftpclientdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appsftpclientdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appsftpclientdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appsftpclientdemo1_Controls'
    +'_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appsftpclientdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appsftpclientdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appsftpclientdemo1_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_appsftpclientdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appsftpclientdemo1_Controls_pOnLongClick',
  pOnDoubleClick name 
    'Java_org_lamw_appsftpclientdemo1_Controls_pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appsftpclientdemo1_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appsftpclientdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appsftpclientdemo1_Controls_pOnEnter',
  pOnBackPressed name 
    'Java_org_lamw_appsftpclientdemo1_Controls_pOnBackPressed',
  pOnClose name 'Java_org_lamw_appsftpclientdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appsftpclientdemo1_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appsftpclientdemo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appsftpclientdemo1_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnClickWidgetItem name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnClickWidgetItem',
  pOnClickImageItem name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnClickImageItem',
  pOnClickCaptionItem name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnClickCaptionItem',
  pOnClickItemTextLeft name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnClickItemTextLeft',
  pOnClickItemTextCenter name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnClickItemTextCenter',
  pOnClickItemTextRight name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnClickItemTextRight',
  pOnListViewLongClickCaptionItem name 'Java_org_lamw_appsftpclientdemo1_'
    +'Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_org_lamw_appsftpclientdemo1_'
    +'Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBackgroundColor name 'Java_org_lamw_appsftpclientdemo1_'
    +'Controls_pOnListViewDrawItemBackgroundColor',
  pOnListViewDrawItemBitmap name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_org_lamw_appsftpclientdemo1_'
    +'Controls_pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_org_lamw_appsftpclientdemo1_'
    +'Controls_pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetText name 'Java_org_lamw_appsftpclientdemo1_'
    +'Controls_pOnListViewDrawItemWidgetText',
  pOnListViewDrawItemWidgetImage name 'Java_org_lamw_appsftpclientdemo1_'
    +'Controls_pOnListViewDrawItemWidgetImage',
  pOnSFTPClientTryConnect name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnSFTPClientTryConnect',
  pOnSFTPClientDownloadFinished name 'Java_org_lamw_appsftpclientdemo1_'
    +'Controls_pOnSFTPClientDownloadFinished',
  pOnSFTPClientUploadFinished name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnSFTPClientUploadFinished',
  pOnSFTPClientListing name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnSFTPClientListing',
  pOnSFTPClientListed name 'Java_org_lamw_appsftpclientdemo1_Controls_'
    +'pOnSFTPClientListed';
...
begin
  ...
  gjAppName:= 'org.lamw.appsftpclientdemo1';
  gjClassName:= 'org/lamw/appsftpclientdemo1/Controls';
