...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 6/18/2016 17:05:13]
...
{ Class:     com_example_appchronometerdemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     com_example_appchronometerdemo1_Controls
  Method:    pOnChronometerTick
  Signature: (JJ)V }
procedure pOnChronometerTick(PEnv: PJNIEnv; this: JObject; pasobj: JLong; elapsedTimeMillis: JLong); cdecl;
begin
  Java_Event_pOnChronometerTick(PEnv,this,TObject(pasobj),elapsedTimeMillis);
end;
...
const NativeMethods:array[0..32] of JNINativeMethod = (
   ...
   (name:'pOnChronometerTick';
    signature:'(JJ)V';
    fnPtr:@pOnChronometerTick;)
);
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'com/example/appchronometerdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_com_example_appchronometerdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_com_example_appchronometerdemo1_Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_appchronometerdemo1_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_com_example_appchronometerdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_appchronometerdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_com_example_appchronometerdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_com_example_appchronometerdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_com_example_appchronometerdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_com_example_appchronometerdemo1_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_com_example_appchronometerdemo1_Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_appchronometerdemo1_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_com_example_appchronometerdemo1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_appchronometerdemo1_Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_appchronometerdemo1_Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_appchronometerdemo1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_appchronometerdemo1_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_appchronometerdemo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_appchronometerdemo1_Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_appchronometerdemo1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_com_example_appchronometerdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_com_example_appchronometerdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_com_example_appchronometerdemo1_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_appchronometerdemo1_Controls_pAppOnSpecialKeyDown',
  pOnClick name 'Java_com_example_appchronometerdemo1_Controls_pOnClick',
  pOnChange name 'Java_com_example_appchronometerdemo1_Controls_pOnChange',
  pOnChanged name 'Java_com_example_appchronometerdemo1_Controls_pOnChanged',
  pOnEnter name 'Java_com_example_appchronometerdemo1_Controls_pOnEnter',
  pOnClose name 'Java_com_example_appchronometerdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_appchronometerdemo1_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_appchronometerdemo1_Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_appchronometerdemo1_Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_appchronometerdemo1_Controls_pOnPinchZoomGestureDetected',
  pOnChronometerTick name 'Java_com_example_appchronometerdemo1_Controls_pOnChronometerTick';

begin
  gApp:= jApp.Create(nil);{AndroidWidget.pas}
  gApp.Title:= 'My Android Bridges Library';
  gjAppName:= 'com.example.appchronometerdemo1';{AndroidWidget.pas}
  gjClassName:= 'com/example/appchronometerdemo1/Controls';{AndroidWidget.pas}
  gApp.AppName:=gjAppName;
  gApp.ClassName:=gjClassName;
  gApp.Initialize;
  gApp.CreateForm(TAndroidModule1, AndroidModule1);
end.
(*last [smart] upgrade: 7/3/2016 22:26:12*)
