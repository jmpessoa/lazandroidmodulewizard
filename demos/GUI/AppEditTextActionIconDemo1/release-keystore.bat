...
keytool -genkey -v -keystore appedittextactionicondemo1-release.keystore -alias appedittextactionicondemo1.keyalias -keyalg RSA -keysize 2048 -validity 10000 < C:\android\workspace\AppEditTextActionIconDemo1\keytool_input.txt
:Error
echo off
cls
echo.
