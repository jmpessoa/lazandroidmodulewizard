...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 5/30/2017 19:07:10]
...
{ Class:     org_lamw_applistviewdemo3_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/applistviewdemo3/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_applistviewdemo3_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name
    'Java_org_lamw_applistviewdemo3_Controls_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_applistviewdemo3_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_applistviewdemo3_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_applistviewdemo3_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_applistviewdemo3_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_applistviewdemo3_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_applistviewdemo3_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_applistviewdemo3_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_applistviewdemo3_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_applistviewdemo3_Controls_pOnTouch',
  pOnClickGeneric name
    'Java_org_lamw_applistviewdemo3_Controls_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_applistviewdemo3_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_applistviewdemo3_Controls_pOnLongClick',
  pOnChange name 'Java_org_lamw_applistviewdemo3_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_applistviewdemo3_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_applistviewdemo3_Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_applistviewdemo3_Controls_pOnClose',
  pAppOnViewClick name
    'Java_org_lamw_applistviewdemo3_Controls_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_applistviewdemo3_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_applistviewdemo3_Controls_pOnLayouting',
  pOnClickWidgetItem name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_org_lamw_applistviewdemo3_'
    +'Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_org_lamw_applistviewdemo3_'
    +'Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_org_lamw_applistviewdemo3_Controls_'
    +'pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_org_lamw_applistviewdemo3_Controls_'
...
begin
  ...
  gjAppName:= 'org.lamw.applistviewdemo3';
  gjClassName:= 'org/lamw/applistviewdemo3/Controls';
