...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 2/28/2017 2:42:34]
...
{ Class:     org_lamw_appintentdemolaunchapp_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appintentdemolaunchapp/Controls');
  end;
...
exports
  ...
  pAppOnCreate name
    'Java_org_lamw_appintentdemolaunchapp_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appintentdemolaunchapp_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pAppOnRestart',
  pAppOnResume name
    'Java_org_lamw_appintentdemolaunchapp_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appintentdemolaunchapp_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appintentdemolaunchapp_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name
    'Java_org_lamw_appintentdemolaunchapp_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appintentdemolaunchapp_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appintentdemolaunchapp_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appintentdemolaunchapp_Controls'
    +'_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appintentdemolaunchapp_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appintentdemolaunchapp_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appintentdemolaunchapp_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appintentdemolaunchapp_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_appintentdemolaunchapp_Controls_pOnClick',
  pOnChange name 'Java_org_lamw_appintentdemolaunchapp_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appintentdemolaunchapp_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_appintentdemolaunchapp_Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_appintentdemolaunchapp_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appintentdemolaunchapp_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name
    'Java_org_lamw_appintentdemolaunchapp_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appintentdemolaunchapp_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name
    'Java_org_lamw_appintentdemolaunchapp_Controls_pOnLayouting';
...
begin
  ...
  gjAppName:= 'org.lamw.appintentdemolaunchapp';
  gjClassName:= 'org/lamw/appintentdemolaunchapp/Controls';
