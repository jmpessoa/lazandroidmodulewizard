...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 4/21/2019 13:22:40]
...
{ Class:     org_lamw_appjcentermikrotikrouterosdemo1_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appjcentermikrotikrouterosdemo1_Controls
  Method:    pOnMikrotikAsyncReceive
  Signature: (JLjava/lang/String;Ljava/lang/String;)V }
procedure pOnMikrotikAsyncReceive(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  delimitedContent: JString; delimiter: JString); cdecl;
begin
  Java_Event_pOnMikrotikAsyncReceive(PEnv, this, TObject(pasobj), 
    delimitedContent, delimiter);
end;

{ Class:     org_lamw_appjcentermikrotikrouterosdemo1_Controls
  Method:    pOnClickComboDropDownItem
  Signature: (JILjava/lang/String;)V }
procedure pOnClickComboDropDownItem(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; itemIndex: JInt; itemCaption: JString); cdecl;
begin
  Java_Event_pOnClickComboDropDownItem(PEnv, this, TObject(pasobj), itemIndex, 
    itemCaption);
end;
...
const NativeMethods: array[0..51] of JNINativeMethod = (
   ...
   (name: 'pOnMikrotikAsyncReceive';
    signature: '(JLjava/lang/String;Ljava/lang/String;)V';
    fnPtr: @pOnMikrotikAsyncReceive; ),
   (name: 'pOnClickComboDropDownItem';
    signature: '(JILjava/lang/String;)V';
    fnPtr: @pOnClickComboDropDownItem; ),
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appjcentermikrotikrouterosdemo1/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_'
    +'Controls_pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls'
    +'_pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_'
    +'Controls_pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appjcentermikrotikrouterosdemo'
    +'1_Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appjcentermikrotikrouterosdemo'
    +'1_Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appjcentermikrotikrouterosdemo1'
    +'_Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appjcentermikrotikrouterosde'
    +'mo1_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appjcentermikrotikrouterosdemo'
    +'1_Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls'
    +'_pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pOnClick',
  pOnLongClick name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pOnDoubleClick',
  pOnChange name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pOnChange',
  pOnChanged name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pOnEnter',
  pOnClose name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls'
    +'_pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appjcentermikrotikrouterosdem'
    +'o1_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appjcentermikrotikrouterosd'
    +'emo1_Controls_pAppOnRequestPermissionResult',
  pOnMikrotikAsyncReceive name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_'
    +'Controls_pOnMikrotikAsyncReceive',
  pOnClickComboDropDownItem name 'Java_org_lamw_appjcentermikrotikrouterosdemo'
    +'1_Controls_pOnClickComboDropDownItem',
  pOnClickWidgetItem name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_'
    +'Controls_pOnClickWidgetItem',
  pOnClickCaptionItem name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_'
    +'Controls_pOnClickCaptionItem',
  pOnListViewLongClickCaptionItem name 'Java_org_lamw_appjcentermikrotikroutero'
    +'sdemo1_Controls_pOnListViewLongClickCaptionItem',
  pOnListViewDrawItemCaptionColor name 'Java_org_lamw_appjcentermikrotikroutero'
    +'sdemo1_Controls_pOnListViewDrawItemCaptionColor',
  pOnListViewDrawItemBitmap name 'Java_org_lamw_appjcentermikrotikrouterosdemo'
    +'1_Controls_pOnListViewDrawItemBitmap',
  pOnWidgeItemLostFocus name 'Java_org_lamw_appjcentermikrotikrouterosdemo1_'
    +'Controls_pOnWidgeItemLostFocus',
  pOnListViewScrollStateChanged name 'Java_org_lamw_appjcentermikrotikrouterosd'
    +'emo1_Controls_pOnListViewScrollStateChanged',
  pOnListViewDrawItemWidgetTextColor name 'Java_org_lamw_appjcentermikrotikrout'
    +'erosdemo1_Controls_pOnListViewDrawItemWidgetTextColor',
  pOnListViewDrawItemWidgetText name 'Java_org_lamw_appjcentermikrotikrouterosd'
    +'emo1_Controls_pOnListViewDrawItemWidgetText',
  pOnListViewDrawItemWidgetImage name 'Java_org_lamw_appjcentermikrotikrouteros'
    +'demo1_Controls_pOnListViewDrawItemWidgetImage';
...
begin
  ...
  gjAppName:= 'org.lamw.appjcentermikrotikrouterosdemo1';
  gjClassName:= 'org/lamw/appjcentermikrotikrouterosdemo1/Controls';
