...
keytool -genkey -v -keystore appwebviewdemo1-release.keystore -alias appwebviewdemo1.keyalias -keyalg RSA -keysize 2048 -validity 10000 < C:\android\workspace\AppWebViewDemo1\keytool_input.txt
:Error
echo off
cls
echo.
