...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 3/24/2017 17:01:42]
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appcustomfontdemo1/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appcustomfontdemo1_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appcustomfontdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appcustomfontdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appcustomfontdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appcustomfontdemo1_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appcustomfontdemo1_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appcustomfontdemo1_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appcustomfontdemo1_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appcustomfontdemo1_Controls_pAppOnStop',
  ...
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appcustomfontdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appcustomfontdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appcustomfontdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appcustomfontdemo1_Controls'
    +'_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appcustomfontdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appcustomfontdemo1_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appcustomfontdemo1_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appcustomfontdemo1_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appcustomfontdemo1_Controls_'
    +'pOnClickGeneric',
  ...
  pAppOnViewClick name 'Java_org_lamw_appcustomfontdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appcustomfontdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appcustomfontdemo1_Controls_'
...
begin
  ...
  gjAppName:= 'org.lamw.appcustomfontdemo1';
  gjClassName:= 'org/lamw/appcustomfontdemo1/Controls';
