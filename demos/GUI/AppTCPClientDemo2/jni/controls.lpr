{hint: save all files to location: C:\adt32\eclipse\workspace\AppTCPClientDemo2\jni}
...
exports
  ...
  pAppOnScreenStyle name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name
    'Java_com_example_apptcpclientdemo1_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_com_example_apptcpclientdemo1_Controls_pAppOnPause',
  pAppOnRestart name
    'Java_com_example_apptcpclientdemo1_Controls_pAppOnRestart',
  ...
  pAppOnBackPressed name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_com_example_apptcpclientdemo1_Controls_pAppOnRotate',
  pAppOnUpdateLayout name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pAppOnUpdateLayout',
  pAppOnConfigurationChanged name 'Java_com_example_apptcpclientdemo1_Controls'
    +'_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_com_example_apptcpclientdemo1_'
    +'Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_com_example_apptcpclientdemo1_Controls'
  ...
  pOnClickGeneric name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnDown name 'Java_com_example_apptcpclientdemo1_Controls_pOnDown',
  pOnUp name 'Java_com_example_apptcpclientdemo1_Controls_pOnUp',
  pOnClick name 'Java_com_example_apptcpclientdemo1_Controls_pOnClick',
  pOnLongClick name 'Java_com_example_apptcpclientdemo1_Controls_pOnLongClick',
  pOnDoubleClick name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pOnDoubleClick',
  ...
  pOnBackPressed name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_com_example_apptcpclientdemo1_Controls_pOnClose',
  pAppOnViewClick name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_com_example_apptcpclientdemo1_'
    +'Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_com_example_apptcpclientdemo1_Controls_pOnLostFocus',
  pOnFocus name 'Java_com_example_apptcpclientdemo1_Controls_pOnFocus',
  pOnBeforeDispatchDraw name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_com_example_apptcpclientdemo1_Controls_pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_com_example_apptcpclientdemo1_'
    +'Controls_pAppOnRequestPermissionResult',
  pOnRunOnUiThread name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pOnRunOnUiThread',
  pOnFileSelected name 'Java_com_example_apptcpclientdemo1_Controls_'
    +'pOnFileSelected',
  pOnTCPSocketClientMessageReceived name 'Java_com_example_apptcpclientdemo1_'
    +'Controls_pOnTCPSocketClientMessageReceived',
  pOnTCPSocketClientBytesReceived name 'Java_com_example_apptcpclientdemo1_'
    +'Controls_pOnTCPSocketClientBytesReceived',
  pOnTCPSocketClientConnected name 'Java_com_example_apptcpclientdemo1_'
    +'Controls_pOnTCPSocketClientConnected',
  pOnTCPSocketClientFileSendProgress name 'Java_com_example_apptcpclientdemo1_'
    +'Controls_pOnTCPSocketClientFileSendProgress',
  pOnTCPSocketClientFileSendFinished name 'Java_com_example_apptcpclientdemo1_'
    +'Controls_pOnTCPSocketClientFileSendFinished',
  pOnTCPSocketClientFileGetProgress name 'Java_com_example_apptcpclientdemo1_'
    +'Controls_pOnTCPSocketClientFileGetProgress',
  pOnTCPSocketClientFileGetFinished name 'Java_com_example_apptcpclientdemo1_'
    +'Controls_pOnTCPSocketClientFileGetFinished',
  pOnTCPSocketClientDisConnected name 'Java_com_example_apptcpclientdemo1_'
    +'Controls_pOnTCPSocketClientDisConnected';
...
(*last [smart] upgrade: 7/4/2016 1:33:17*)
