...
library controls;  //[by LAMW: Lazarus Android Module Wizard: 6/8/2019 18:54:06]
...
{ Class:     org_lamw_appjcenteropenstreetmapdemo2_Controls
  Method:    pAppOnCreate
...
{ Class:     org_lamw_appjcenteropenstreetmapdemo2_Controls
  Method:    pOnOpenMapViewRoadDraw
  Signature: (JIIDD)[I }
function pOnOpenMapViewRoadDraw(PEnv: PJNIEnv; this: JObject; pasobj: JLong; 
  roadCode: JInt; roadStatus: JInt; roadDuration: JDouble; roadDistance: JDouble
  ): JIntArray; cdecl;
begin
  Result:=Java_Event_pOnOpenMapViewRoadDraw(PEnv, this, TObject(pasobj), 
...
{ Class:     org_lamw_appjcenteropenstreetmapdemo2_Controls
  Method:    pOnOpenMapViewMarkerClick
  Signature: (JLjava/lang/String;DD)V }
procedure pOnOpenMapViewMarkerClick(PEnv: PJNIEnv; this: JObject; 
  pasobj: JLong; title: JString; latitude: JDouble; longitude: JDouble); cdecl;
begin
  Java_Event_pOnOpenMapViewMarkerClick(PEnv, this, TObject(pasobj), title, 
    latitude, longitude);
end;
...
const NativeMethods: array[0..44] of JNINativeMethod = (
   ...
   (name: 'pOnOpenMapViewMarkerClick';
    signature: '(JLjava/lang/String;DD)V';
    fnPtr: @pOnOpenMapViewMarkerClick; )
);
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/appjcenteropenstreetmapdemo2/'
       +'Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pAppOnResume',
  pAppOnStart name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pAppOnStart',
  pAppOnStop name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_appjcenteropenstreetmapdemo'
    +'2_Controls_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pAppOnSpecialKeyDown',
  pOnDown name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_pOnDown',
  pOnClick name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pOnLongClick',
  pOnDoubleClick name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pOnDoubleClick',
  pOnChange name 
    'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pOnChanged',
  pOnEnter name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_pOnEnter',
  pOnBackPressed name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pOnBackPressed',
  pOnClose name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_appjcenteropenstreetmapdemo2'
    +'_Controls_pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_appjcenteropenstreetmapdemo2_Controls_'
    +'pOnLayouting',
  pAppOnRequestPermissionResult name 'Java_org_lamw_appjcenteropenstreetmapdemo'
    +'2_Controls_pAppOnRequestPermissionResult',
  pOnOpenMapViewRoadDraw name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pOnOpenMapViewRoadDraw',
  pOnOpenMapViewClick name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pOnOpenMapViewClick',
  pOnOpenMapViewLongClick name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pOnOpenMapViewLongClick',
  pOnOpenMapViewMarkerClick name 'Java_org_lamw_appjcenteropenstreetmapdemo2_'
    +'Controls_pOnOpenMapViewMarkerClick';
...
begin
  ...
  gjAppName:= 'org.lamw.appjcenteropenstreetmapdemo2';
  gjClassName:= 'org/lamw/appjcenteropenstreetmapdemo2/Controls';
