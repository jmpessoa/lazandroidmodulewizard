...
begin
   ...
   begin
     ...
     strList.Add('   private ViewGroup.MarginLayoutParams lparams = null;              // layout XYWH');
     strList.Add('   ');
     ...
     strList.Add('   ');
     strList.Add('   //private int lparamH = android.view.ViewGroup.LayoutParams.WRAP_CONTENT;');
     strList.Add('   //private int lparamW = android.view.ViewGroup.LayoutParams.MATCH_PARENT;');
     strList.Add('   private int lparamH = 100;');
     strList.Add('   private int lparamW = 100;');
     strList.Add('   private int marginLeft = 5;');
     strList.Add('   private int marginTop = 5;');
     strList.Add('   private int marginRight = 5;');
     strList.Add('   private int marginBottom = 5;');
     strList.Add('   private int lgravity = Gravity.TOP | Gravity.START;');
     strList.Add('   private float lweight = 0;');
     strList.Add('   ');
     ...
     strList.Add('      controls  = _ctrls;');
     strList.Add('   ');
     strList.Add('      lparams = new ViewGroup.MarginLayoutParams(lparamW, lparamH);     // W,H');
     strList.Add('      lparams.setMargins(marginLeft,marginTop,marginRight,marginBottom); // L,T,R,B');
     strList.Add('   ');
     ...
     strList.Add('   }');
     strList.Add('   ');
     strList.Add('   private static MarginLayoutParams newLayoutParams(ViewGroup _aparent, ViewGroup.MarginLayoutParams _baseparams) {');
     strList.Add('   	if (_aparent instanceof FrameLayout) {');
     strList.Add('   		return new FrameLayout.LayoutParams(_baseparams);');
     strList.Add('   	} else if (_aparent instanceof RelativeLayout) {');
     strList.Add('   		return new RelativeLayout.LayoutParams(_baseparams);');
     strList.Add('   	} else if (_aparent instanceof LinearLayout) {');
     strList.Add('   		return new LinearLayout.LayoutParams(_baseparams);');
     strList.Add('   	} else if (_aparent == null) {');
     strList.Add('   		throw new NullPointerException("Parent is null");');
     strList.Add('   	} else {');
     strList.Add('   		throw new IllegalArgumentException("Parent is neither FrameLayout or RelativeLayout or LinearLayout: "');
     strList.Add('   				+ _aparent.getClass().getName());');
     strList.Add('   	}');
     strList.Add('   }');
     strList.Add('   ');
     strList.Add('   ');
     ...
     strList.Add('      ');
     strList.Add('      parent.addView(this,newLayoutParams(parent,(ViewGroup.MarginLayoutParams)lparams));');
     strList.Add('      lparams = null;');
     strList.Add('      lparams = (ViewGroup.MarginLayoutParams)this.getLayoutParams();');
     strList.Add('      ');
     ...
     strList.Add('   	lgravity = _g;');
     strList.Add('   }');
     strList.Add('   ');
     strList.Add('   public void setLWeight(float _w) {');
     strList.Add('   	lweight = _w;');
     strList.Add('   }');
     strList.Add('   ');
     ...
     strList.Add('      ');
     strList.Add('      if (lparams instanceof RelativeLayout.LayoutParams) {');
     strList.Add('         if (_idAnchor > 0) {');
     strList.Add('	          for (int i=0; i < countAnchorRule; i++) {');
     strList.Add('		         ((RelativeLayout.LayoutParams)lparams).addRule(lparamsAnchorRule[i], _idAnchor);');
     strList.Add('	          }');
     strList.Add('	       }');
     strList.Add('         for (int j=0; j < countParentRule; j++) {');
     strList.Add('            ((RelativeLayout.LayoutParams)lparams).addRule(lparamsParentRule[j]);');
     strList.Add('         }');
     strList.Add('	    }');
     strList.Add('      if (lparams instanceof FrameLayout.LayoutParams) {');
     strList.Add('      	((FrameLayout.LayoutParams)lparams).gravity = lgravity;');
     strList.Add('      }');
     strList.Add('      if (lparams instanceof LinearLayout.LayoutParams) {');
     strList.Add('      	((LinearLayout.LayoutParams)lparams).weight = lweight;');
     strList.Add('      }');
     ...
     strList.Add('      if (lparams instanceof RelativeLayout.LayoutParams) {');
     strList.Add('         for (int i=0; i < countAnchorRule; i++) {');
     strList.Add('             ((RelativeLayout.LayoutParams)lparams).removeRule(lparamsAnchorRule[i]);');
     strList.Add('         }');
     strList.Add('         for (int j=0; j < countParentRule; j++) {');
     strList.Add('             ((RelativeLayout.LayoutParams)lparams).removeRule(lparamsParentRule[j]);');
     strList.Add('         }');
     strList.Add('      }');
